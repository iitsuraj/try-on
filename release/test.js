...
$jscomp.defineProperty = $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function (bb, Db, Fb) {
	if (bb == Array.prototype || bb == Object.prototype) return bb;
	bb[Db] = Fb.value;
	return bb
};
$jscomp.getGlobal = function (bb) {
	bb = ["object" == typeof globalThis && globalThis, bb, "object" == typeof window && window, "object" == typeof self && self, "object" == typeof global && global];
...
$jscomp.polyfill = function (bb, Db, Fb, Eb) {
	Db && ($jscomp.ISOLATE_POLYFILLS ? $jscomp.polyfillIsolated(bb, Db, Fb, Eb) : $jscomp.polyfillUnisolated(bb, Db, Fb, Eb))
};
$jscomp.polyfillUnisolated = function (bb, Db, Fb, Eb) {
	...
	Eb = Fb[bb];
	Db = Db(Eb);
	Db != Eb && null != Db && $jscomp.defineProperty(Fb, bb, {
		configurable: !0,
		writable: !0,
		value: Db
	})
...
$jscomp.polyfillIsolated = function (bb, Db, Fb, Eb) {
	...
	Db = Db(Fb);
	null != Db && (bb ? $jscomp.defineProperty($jscomp.polyfills, Xb, {
		configurable: !0,
		writable: !0,
		value: Db
	}) : Db !== Fb && ($jscomp.propertyToPolyfillSymbol[Xb] = $jscomp.IS_SYMBOL_NATIVE ? $jscomp.global.Symbol(Xb) :
		$jscomp.POLYFILL_PREFIX + Xb, Xb = $jscomp.propertyToPolyfillSymbol[Xb], $jscomp.defineProperty(Eb, Xb, {
			configurable: !0,
			writable: !0,
			value: Db
		})))
...
$jscomp.polyfill("Symbol", function (bb) {
	if (bb) return bb;
	...
	var Fb = 0,
		Eb = function (Xb) {
			if (this instanceof Eb) throw new TypeError("Symbol is not a constructor");
			return new Db("jscomp_symbol_" + (Xb || "") + "_" + Fb++, Xb)
		};
	return Eb
}, "es6", "es3");
$jscomp.initSymbolIterator = function () {};
$jscomp.polyfill("Symbol.iterator", function (bb) {
		if (bb) return bb;
		bb = Symbol("Symbol.iterator");
		for (var Db = "Array Int8Array Uint8Array Uint8ClampedArray Int16Array Uint16Array Int32Array Uint32Array Float32Array Float64Array".split(" "), Fb = 0; Fb < Db.length; Fb++) {
			var Eb = $jscomp.global[Db[Fb]];
			"function" === typeof Eb && "function" != typeof Eb.prototype[bb] && $jscomp.defineProperty(Eb.prototype, bb, {
				configurable: !0,
				writable: !0,
				value: function () {
...
var JeeWidget = function () {
	...
	function Db() {
		...
		if (Yc.disableFallback) Eb("FALLBACK_UNAVAILABLE");
		else if (Ia.uploadNotice = document.getElementById("JeeWidgetUploadNotice"), kc.toggle_loading(!1), Ia.uploadNotice) {
			...
			la && La ? ($(La).click(function (hb) {
					$(la.click())
				}), $(la).change(function (hb) {
					kc.toggle_loading(!0);
					Od.read(la, function (Sa) {
	...
	function ed() {
		...
		Ia.adjust && (Ia.adjustNotice = document.getElementById("JeeWidgetAdjustNotice"),
			Ia.adjustExit = document.getElementById("JeeWidgetAdjustExit"), Ia.changeModelContainer = document.getElementById("JeeWidgetChangeModelContainer"), Ia.buttonResizeCanvas = document.getElementById("buttonResizeCanvas"), $(Ia.adjust).click(function () {
				$(Ia.adjust).hide();
				...
				Ia.changeModelContainer && (Ia.changeModelContainer.style.display = "block");
			...
			}), $(Ia.adjust).show(), $(Ia.changeModelContainer).show(),
	...
	function nd() {
		...
		Ia.inputFile && Ia.inputFileButton && ($(Ia.inputFileButton).click(function (la) {
			$(Ia.inputFile.click())
		}), $(Ia.inputFile).change(function (la) {
			kc.toggle_loading(!0);
			Od.read(Ia.inputFile, function (La) {
				pb.isRT ? Vd(La, function () {
					pb.sku && kc.load_fallback(pb.sku, !1)
				}) : Fd(La, function () {
					pb.sku && kc.load_fallback(pb.sku, !1)
				})
	...
	function Vd(la, La) {
		if (!pb.isRT) return !1;
		Yc.disableFallback ? Eb("FALLBACK_UNAVAILABLE") : JeefitFallback.switch_toFallbackMode(function () {
			console.log("INFO in JeeWidget - switch_toFallbackMode(): success callback launched");
			pb.isRT = !1;
			JeefitFallback.set_serverURL(Yc.fallbackURL);
			Fd(la,
	...
	function Wd() {
		Ia.backToRTButton = document.getElementById("JeeWidgetBackToRealtimeButton");
	...
	function Qd(la, La, hb) {
		Tb.load_model(La.mod + ".json", La.mats, function () {
			pb.mode = vc.realtime;
			hb && hb();
			kc.toggle_loading(!1);
			Pd(la)
	...
	var Tb = function () {
		function la(b, f) {
			...
			n.onreadystatechange = function () {
				4 !== n.readyState || 200 !== n.status && 0 !== n.status || f(n.responseText)
			};
			n.send()
		}

		function La(b) {
			return .5 > b ? 4 * b * b * b : (b - 1) * (2 * b - 2) * (2 * b - 2) + 1
		}
		...
		function ib(b) {
			b = "undefined" === typeof btoa ? Buffer.from(b.data, "base64").toString("latin1") : atob(b.data);
			for (var f = b.length,
					n = new Uint8Array(f), l = 0; l < f; ++l) n[l] = b.charCodeAt(l);
			return n
		}
		...
		function Gb(b) {
			...
			var n = f.n;
			f = ib(f);
			for (var l = new Uint32Array(n), t = 0; t < n; ++t) l[t] = qb(f, t * b, b);
			return l
		}
		...
		function Ta(b) {
			...
			var n = f.nf,
				l = f.n;
			f = ib(f);
			for (var t = new Float32Array(l), w = new Float32Array(n), G = b + n + 1, B = 0; B < l; ++B) {
				var x = G * B,
					E = 0 === Sa(f, x) ? 1 : -1,
					O = qb(f, x + 1, b);
				x = x + 1 + b;
				for (var C = w.length, P = 0, z = x; z < x + C; ++z) w[P] = Sa(f, z), ++P;
				for (C = x = 0; C < n; ++C) x += w[C] * Math.pow(2, -C - 1);
				t[B] = 0 === x && 0 === O ? 0 : E * (1 +
					x) * Math.pow(2, 1 + O - Math.pow(2, b - 1))
			}
			return t
		}
		...
		function xc() {
			...
			return -1 !== b.indexOf("safari") &&
				-1 === b.indexOf("chrome") ? !0 : !1
		}
		...
		function Cc(b) {
			...
			if (b.video) {
				...
				"undefined" !== typeof b.video.facingMode && (f.facingMode = b.video.facingMode)
			}
			f = {
				audio: b.audio,
				video: f
			};
			"undefined" !== typeof b.deviceId &&
				(f.deviceId = b.deviceId);
			return f
		}
		...
		function ec(b) {
			function f(C) {
				return [480, 576, 640, 648, 720, 768, 800, 960, 1080, 1152, 1280, 1366, 1920].sort(function (P, z) {
			...
			if (b.video.width && b.video.height) {
				if (b.video.width.ideal && b.video.height.ideal) {
					var t = f(b.video.width.ideal).slice(0, 3),
						...
						G = {},
						B = 0;
					for (G.Wa = void 0; B < t.length; G = {
							Wa: G.Wa
						}, ++B) {
						G.Wa = t[B];
						var x = {},
							E = 0;
						for (x.Va = void 0; E < w.length; x = {
								Va: x.Va
							}, ++E)
							if (x.Va = w[E], G.Wa !== b.video.width.ideal || x.Va !== b.video.height.ideal) {
								var O = Math.max(G.Wa, x.Va) / Math.min(G.Wa, x.Va);
								O < 4 / 3 - .1 || O > 16 / 9 + .1 || n(function (C, P) {
									return function (z) {
			...
			b.video.width && b.video.height && (b.video.width.ideal && b.video.height.ideal && n(function (C) {
			...
			b.video.facingMode && (n(function (C) {
				delete C.video.facingMode;
				return C
			}), b.video.width && b.video.height && n(function (C) {
				zc(C);
				delete C.video.facingMode;
				return C
			}));
		...
		function Zb(b) {
			...
			if (f && b && b.video) {
				...
				f &&
					n && f.ideal && n.ideal && f.ideal > n.ideal && (b.video.height = f, b.video.width = n)
			}
		}
		...
		function na(b, f, n, l) {
			...
			var w = !1;
			navigator.mediaDevices.getUserMedia(l).then(function (G) {
				function B() {
					setTimeout(function () {
						if (b.currentTime) {
							var x =
							...
							if (0 === x || 0 === E) t("VIDEO_NULLSIZE");
								...
								try {
									...
									O && (x.Sk = O, x.Xi = O.getCapabilities(), x.$e = O.getSettings())
								} catch (C) {}
								xc() || ob() ? b.parentNode && null !== b.parentNode ? (w || f(b, G, x), setTimeout(function () {
									b.play()
								}, 100)) : (document.body.appendChild(b), da(b), w || f(b, G, x), setTimeout(function () {
				...
				"undefined" !== typeof b.srcObject ? b.srcObject = G : (b.src = window.URL.createObjectURL(G), b.videoStream = G);
				da(b);
				b.addEventListener("loadeddata", function () {
					var x = b.play();
					da(b);
					"undefined" === typeof x ? B() : x.then(function () {
						B()
					}).catch(function () {
		...
		function ua(b, f, n) {
			var l = navigator.mediaDevices && navigator.mediaDevices.getUserMedia ?
			...
			if (l)
				if (navigator.mediaDevices && navigator.mediaDevices.getUserMedia) {
					if (n && n.video) {
						...
						n.video.width && n.video.width.ideal && (l.style.width = n.video.width.ideal + "px");
						n.video.height && n.video.height.ideal && (l.style.height = n.video.height.ideal + "px")
					}
					yb(l, "autoplay");
					yb(l, "playsinline");
		...
		function Ma(b) {
			navigator.mediaDevices && navigator.mediaDevices.enumerateDevices ? navigator.mediaDevices.enumerateDevices().then(function (f) {
				(f = f.filter(function (n) {
					return n.kind && -1 !== n.kind.toLowerCase().indexOf("video") && n.label && n.deviceId
				})) && f.length && 0 < f.length ? b(f, !1) : b(!1, "NODEVICESFOUND")
			}).catch(function () {
				b(!1, "PROMISEREJECTED")
			}) : b(!1, "NOTSUPPORTED")
		}
		...
		function Oa() {
			...
			function f() {
				++Qa;
				3 === Qa && (ab.ef(), K.Db && (Za.reset(), fb.ib.Qi($c), fb.ib.Pi()), K.Cj || Wa.mj(), ma.ready = !0, ba = 0, l(), Qa = 0)
			}
			...
			function t(ea) {
				J ? d.Fb = ca : va.isEnabled ? d.Fb = va.Xg : a ? (B(), d.Fb = h === e.Y ? d.Wc : 1) : (d.Fb = K.qc, B());
				Za.fa();
				for (var ta = 0; ta < d.Fb; ++ta) Ea.set("s50"), R.N(), aa.b(0), ya.raw.b(1), pa.g(!1, !1), R.b(0), M.ta(!1, R);
				if (J) T(), J = !1, g.flush(), A = window.requestAnimationFrame(t);
					...
					if (a) {
						...
						d.Gb > K.rb[1] ? (++d.Wc, d.Gb = (K.rb[0] + K.rb[1]) / 2) : d.Gb < K.rb[0] && (d.Wc = Math.max(d.Wc - 1, K.qc), d.Gb = (K.rb[0] + K.rb[1]) / 2);
						d.$b = K.Ii / Math.max(d.Xc, .001);
						c = Math.min(Math.max(d.$b, K.Af[0]), K.Af[1]);
						K.Db && h === e.Y && (sa = K.Lg + (K.Mg - K.Lg) * d.$b, wa = K.Kg + (K.Hk - K.Kg) * d.$b, wa = Math.min(wa, .5))
					}
					ba = ea;
			...
			function B() {
				...
				1E3 * ea < K.tm || ($c.refresh(), zb += ea, Ea.set("s49"), Za.fa(), aa.N(), $c.b(0), pa.g(!1, !0))
			}
			var x, E, O = null,
				C = null,
				P = -1,
			...
			var ia = [0, 0, 0],
				...
				ab = {
					zg: function () {
						...
						rb = K.width > K.height ? [K.width / K.height, 1] : [1, K.height / K.width];
						X = !0
					},
					h: function () {
						function ea(cb) {
							...
							g.viewport(1, 0, 1, 1);
							pa.g(!1, !1);
							1 !== ++F.n % 2 && (F.scale += O.cm, F.scale > z && (F.x += O.dm, F.scale = P, F.x > O.Qk && (F.x = O.Tk, F.y += O.em, F.y > O.Rk && (F.y = O.Uk))));
							ya.Vd.N();
							Ea.set("s53");
							Ea.A("u47", K.Cd * c);
							ya.raw.b(0);
							...
							ya.oc.i();
							pa.g(!1, !1);
							ba - Q > sa && K.Db && h === e.Y && (Q = ba, za.i(), Ea.set("s58"), cb.b(0), pa.g(!1, !1), fb.ib.Xh($c, za, wa))
						}
						Ea.yf([{
							id: "s49",
							name: "_",
							j: "attribute vec2 a0;uniform mat2 u32;varying vec2 vv0;void main(){gl_Position=vec4(a0,0.,1.),vv0=vec2(.5,.5)+u32*a0;}",
							D: ["a0"],
							K: [2],
							...
							name: "_",
							a: "uniform sampler2D u1;varying vec2 vv0;void main(){gl_FragColor=texture2D(u1,vv0);}",
							j: "attribute vec2 a0;uniform sampler2D u33;uniform vec2 u34;uniform float u35;const vec2 f=vec2(.25,.5),g=vec2(.75,.5),e=vec2(.5,.5);varying vec2 vv0;void main(){vec4 a=texture2D(u33,f);vec2 d=a.gb,b=a.a*u34;vec4 c=texture2D(u33,g);float l=c.a,i=c.y;vec2 j=vec2(mix(1.,1./cos(i),u35),1.);b*=j;vec2 k=a0*.5+e;vv0=d+(k-e)*b,gl_Position=vec4(a0,0.,1.);}",
							D: ["a0"],
							K: [2],
							c: ["u1", "u33", "u34", "u35"],
							precision: "lowp"
							...
							id: "s53",
							name: "_",
							a: "uniform sampler2D u33,u46;uniform float u47,u48,u49,u50;const vec4 f=vec4(1.,1.,1.,1.),g=vec4(1.,0.,0.,0.),h=vec4(0.,0.,0.,1.);varying vec2 vv0;void main(){vec4 c=texture2D(u33,vv0),d=texture2D(u46,vv0),i=texture2D(u33,vec2(.75,.5));float j=pow(i.a,u50),k=(1.-j)*(u48-u47)+u47,a=step(.5,vv0.x);vec4 l=mix(g,h,a),b=max(k*f,l);b*=mix(f,u49*vec4(1.,1.,1.,0.)+vec4(0.,0.,0.,1.),a);vec4 m=c-d;gl_FragColor=m*b;}",
							c: "u33 u46 u47 u48 u49 u50".split(" "),
							precision: "highp"
						}, {
							id: "s54",
							name: "_",
							a: "uniform sampler2D u46,u51,u45;const vec4 g=vec4(1.,1.,1.,1.);varying vec2 vv0;void main(){vec4 c=texture2D(u46,vv0),d=texture2D(u51,vv0),a=c+d;float f=step(.5,vv0.x),b=a.a;b*=texture2D(u45,vec2(.25,.5)).a,b*=texture2D(u45,vec2(.75,.5)).a,a.a=mix(a.a,b,f),gl_FragColor=a;}",
							c: ["u46", "u51", "u45"],
							precision: "highp"
						}, {
							id: "s55",
							name: "_",
							a: "uniform sampler2D u33;uniform float u52;const vec4 f=vec4(1.,1.,1.,1.);varying vec2 vv0;void main(){vec4 a=texture2D(u33,vv0);float b=step(.5,vv0.x),c=texture2D(u33,vec2(.75,.5)).g;a.a+=(1.-b)*u52*abs(sin(c)),gl_FragColor=a;}",
							c: ["u33", "u52"],
							precision: "highp"
						}, {
							id: "s56",
							name: "_",
							a: "uniform sampler2D u33,u45,u36;uniform vec3 u42,u43;uniform float u53,u54;const vec3 g=vec3(.02,.02,.02),h=vec3(.3,.3,.3);const vec4 e=vec4(.25,.25,.25,.25);varying vec2 vv0;void main(){float a=step(.5,vv0.x);vec4 c=texture2D(u45,vv0);float d=texture2D(u33,vec2(.75,.5)).a;vec2 i=mix(vec2(.75,.75),vec2(0.,.75),a),j=mix(vec2(0.,.5),vec2(.25,.75),a),k=mix(vec2(.25,.5),vec2(.5,.75),a);float l=dot(e,texture2D(u36,i)),m=dot(e,texture2D(u36,j)),n=dot(e,texture2D(u36,k));vec3 o=mix(vec3(1.,1.,.2),u42,a),b=o*vec3(l,m,n);if(a>.5){vec3 p=texture2D(u33,vec2(.75,.5)).rgb;b=u43+b-p;}b*=d/u54;vec3 q=min(g*u53,h);vec4 r=mix(c,vec4(b,0.),vec4(q,0.));gl_FragColor=r;}",
							c: "u33 u45 u36 u53 u54 u42 u43".split(" "),
							precision: "highp"
						}, {
							id: "s57",
							name: "_",
							a: "uniform sampler2D u45;const vec4 h=vec4(.25,.25,.25,.25);varying vec2 vv0;void main(){float a=step(.5,vv0.x),c=mix(.02,5e-4,a),d=mix(.05,1e-3,a);vec3 b=texture2D(u45,vv0).rgb;float f=length(b),g=1.-smoothstep(c,d,f);gl_FragColor=vec4(b,g);}",
							c: ["u45"],
							precision: "highp"
						}, {
							id: "s58",
							name: "_",
							j: "attribute vec2 a0;void main(){gl_Position=vec4(a0,0.,1.);}",
							a: "uniform sampler2D u36;const vec4 g=vec4(1.,1.,1.,1.),h=vec4(0.,0.,0.,0.),e=vec4(.25,.25,.25,.25);const float f=3.1415;void main(){float a=dot(texture2D(u36,vec2(.25,.25)),e),b=dot(texture2D(u36,vec2(.5,.25)),e),c=f/2.*dot(texture2D(u36,vec2(.75,.25)),e),d=4.18*dot(texture2D(u36,vec2(0.,.25)),e);gl_FragColor=vec4(d,a,b,c);}",
							c: ["u36"]
						}]);
						ab.Ag();
						qa = ha.instance({
						...
						var ta = {
								...
								isFloat: !0,
								isPot: !1,
								array: new Float32Array([0, K.borderWidth, K.borderHeight, 0, 0, 0, 0, 0])
							},
							Ga = {
								width: 2,
								height: 1,
								isFloat: !0,
								isPot: !1,
								array: new Float32Array([0, 0, 0, 0, 0, 0, 0,
									0
								])
							};
						...
						ma.resize = function (cb, wb) {
							function jb() {
								...
								if (!r)
									...
									Ca.resize(Zc, Tc);
									ab.ef();
									Ob.Ze(mc.videoWidth ? mc.videoWidth : mc.width, mc.videoHeight ? mc.videoHeight : mc.height);
									Ob.ff();
									Ob.Oh();
									l();
					...
					ql: function (ea) {
						var ta =
							...
							Ga = 0;
						ta = function () {
							2 === ++Ga && (va.isEnabled = !1, Na.Ib = ra, Na.Ha = wc, Na.na = Ba, Na.Ca = vb, Na.sa = $a, ab.mf(), Wa.ja(Ua), l(), ea && ea())
						};
					...
					Yi: function () {
						var ea = Jb.wd,
							...
							Ga = 1 / Math.tan(od / 2),
							cb = Ub.U() / Ub.I();
						wd = [Ga, 0, 0, 0, 0, Ga / cb, 0, 0, 0, 0, -(ta + ea) / (ta - ea), -1, 0, 0, -2 * ea * ta / (ta - ea), 0];
					...
					Ze: function (ea, ta) {
						...
						od = 2 * Math.atan(2 * V[0] * Math.tan((1 < ea ? Jb.di : Jb.FOVdesktop) * Math.PI / 180 / 2));
						ab.Yi()
					},
					ff: function () {
						Ea.f("s49", [{
					...
					te: function (ea, ta) {
						...
						ab.nk(ea, ta);
						ab.h();
						if (!ab.kk()) return ma.Ya && ma.Ya("GL_INCOMPATIBLE", "Cannot init JEEFITAPI"), !1;
						ab.xg();
						return !0
					},
					nk: function (ea, ta) {
						...
						ma.capture_background = function (Ga, cb) {
							...
							} else Ab = ea, wb = ea / wb, Hb = Math.round((ta - wb) / 2);
							ma.Xb.save();
					...
					xg: function () {
						window.CanvasListeners && ($b.init({
							ma: Ub.bb()
						}), ma.init_listeners = ab.xg, ma.add_listener = $b.add_listener, ma.remove_listener = $b.remove_listener, ma.animate_swipe = $b.animate_swipe, ma.switch_modeInteractor = $b.switch_mode, ma.get_modeInteractor = $b.get_mode, $b.add_listener("move", function (ea, ta) {
							h === e.Y && (K.Lk && (sb.offsetX -= ta[0] * K.Pg, sb.offsetX = Math.min(Math.max(sb.offsetX, -K.Tc), K.Tc)), sb.offsetY -= ta[1] * K.Pg, sb.offsetY = Math.min(Math.max(sb.offsetY, -K.Tc), K.Tc), ab.pd())
						}, !0).add_listener("pinch", function (ea, ta) {
							h === e.Y && (sb.scale += ta * K.Mk, sb.scale = Math.min(Math.max(sb.scale, K.Qg[0]), K.Qg[1]), ab.qd())
						}, !0))
					},
					kk: function () {
						return Ca.h({
					...
					xl: function () {
						ma.load_model = function (ea, ta, Ga) {
							...
							ma.isBusy = !0;
							if (fa.model) ma.set_model(ea, function () {
						...
						ma.switch_viewer3D = function (ea, ta) {
							if (h === e.Sb || h === e.Tb || h === e.Y && !ea || h === e.Aa && ea || J) return !1;
							if (h === e.ua) return q !== e.Aa || ea ? q === e.Y && ea ? (q = e.Aa, Wa.ja(E), Wa.Qa(1), ta && ta(), !0) : !1 : (q = e.Y, Wa.ja(x), Wa.Qa(0), ta && ta(), !0);
							var Ga = 0,
								cb = -1,
								wb = 0;
							h === e.Y ? (h = e.Sb, cb = K.Cm) : h === e.Aa && (h = e.Tb, cb = K.Fm);
							var jb = Date.now();
							m = setInterval(function () {
								var Hb =
									Date.now();
								Ga += (Hb - jb) / cb;
								1 <= Ga && (Ga = 1, h === e.Sb ? (h = e.Aa, Wa.ja(E)) : (h = e.Y, Wa.ja(x)), ta && ta(), clearInterval(m), m = !1);
								var Ab = h === e.Tb || h === e.Y ? 1 - K.zm(Ga) : K.ym(Ga);
								Wa.Qa(Ab);
								h !== e.Tb && h !== e.Sb || 0 !== wb++ % 2 || (Wa.ja(ka), ka.Ql(Ab));
								jb = Hb
							}, .016);
							return !0
						};
						...
						ma.process_offlineRendering = function (ea, ta, Ga, cb, wb) {
							function jb() {
								if (2 === ++Hb) {
									...
									ea.ng() && (va.Oa.Ch(ea.ng()), K.en ? Wa.ja(E) : Wa.ja(va.Oa));
									va.Td.set();
									l();
									va.Td = !1;
									ab.ql(cb ? function () {
							...
							ab.rl();
							cb && (ma.gi.drawImage(Ub.bb(), 0, 0), Ub.bb().parentNode.insertBefore(ma.jb,
								Ub.bb()), ma.jb.setAttribute("class", "jeefitMask"));
							va.Td = ea;
							var Hb = 0;
						...
						ma.switch_sleep = function (ea) {
							if (!r && !I) {
								...
								m && (clearInterval(m), m = !1);
								h === e.Tb ? (h = e.Y, Wa.ja(x), Wa.Qa(0)) : h === e.Sb && (h = e.Aa, Wa.ja(E), Wa.Qa(1));
								G();
						...
						ma.set_model = function (ea, ta, Ga) {
							Nb && Nb.replace("http" === ea.substring(0, 4).toLowerCase() ? ea : K.X + K.qa + K.Ie + "/" + ea, function () {
								ta && ta(Nb.Zi())
							}, Ga)
						};
						ma.set_tweaker = function (ea, ta) {
							...
							"string" === typeof ea ? la(K.X + K.qa + K.hm + "/" + ea, Ga) : Ga(ea)
						};
						ma.wf = function (ea) {
							ea && (ea.preOffset && (Na.Ha = ea.preOffset),
								ea.preScale && (Na.Ib = ea.preScale), ea.rx && (Na.ad = ea.rx), ea.beginBendZ && (Na.Ca = ea.beginBendZ), ea.bendStrength && (Na.sa = ea.bendStrength), ea.maskBranchStartEnd && (Na.na = ea.maskBranchStartEnd), ma.ready && ab.mf())
						};
						ma.set_materials = function (ea, ta) {
							if (Nb) {
								...
								ea = ea.map(function (cb) {
									var wb = cb;
									"string" === typeof cb && (wb = Ga + cb, wb = wb.replace(/([^:])\/\//, "$1/"));
									return wb
								});
								Nb.We(ea, ta)
							}
					...
					af: function () {
						Mb || (Mb = !0, Ca.lf(lb.Ej), ab.mf(), Wa.am(), ma.tc.forEach(function (ea) {
								ea()
							}), ma.tc.splice(0),
							f())
					},
		...
		function Va(b, f) {
			function n(B) {
				void 0 !== B && 1 > parseFloat(B) && console.warn("JETHREE.Color: Alpha component of " + f + " will be ignored.")
			}
			var l;
			if (l = /^((?:rgb|hsl)a?)\(\s*([^\)]*)\)/.exec(f)) {
				...
				switch (l[1]) {
					case "rgb":
					case "rgba":
						if (l = /^(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*(,\s*([0-9]*\.?[0-9]+)\s*)?$/.exec(t)) {
					...
					case "hsla":
						if (l =
							/^([0-9]*\.?[0-9]+)\s*,\s*(\d+)%\s*,\s*(\d+)%\s*(,\s*([0-9]*\.?[0-9]+)\s*)?$/.exec(t)) {
			...
			f && 0 < f.length && (l = Ad[f], void 0 !== l ? Ha(b, l) : console.warn("JETHREE.Color: Unknown color " + f))
		}
		...
		function Kb(b) {
			return (new Xa).uc(b.min, b.max).xa(.5)
		}
		...
		function Oc(b, f) {
			for (var n = Array(b.length), l = 0, t = b.length; l < t; ++l) n[l] = new Xa;
			l =
				new Xa;
			t = new Xa;
			...
			b = 0;
			for (l = f.length; b < l; ++b) t = f[b], w = t.rd, 3 === w.length ? (w[0].B(n[t.va]), w[1].B(n[t.F]), w[2].B(n[t.wa])) : (w[0] = n[t.va].clone(), w[1] = n[t.F].clone(), w[2] = n[t.wa].clone());
			return n
		}
		...
		function oc(b, f, n, l) {
			...
			for (var w = b.length, G = new Float32Array(4 * w), B = Array(w), x = Array(w), E = 0; E < w; E++) B[E] = new Xa, x[E] = new Xa;
			var O = new Xa,
				C = new Xa,
				P = new Xa,
				z = new Cb,
			...
			l.forEach(function (M) {
				...
				var ia = C.x - O.x,
					...
					ba = H.y - z.y,
					A = 1 / (ya * ba - Ka * Aa);
				r.set((ba * ia - Aa * S) * A, (ba * Z - Aa * aa) * A, (ba * R - Aa * qa) * A);
				X.set((ya * S - Ka * ia) * A, (ya * aa - Ka * Z) * A, (ya * qa - Ka * R) * A);
				B[V].add(r);
				B[Y].add(r);
				B[M].add(r);
				x[V].add(X);
		...
		var fa = {
			...
			Ea = function () {
				...
				function n(y, M) {
					void 0 === M.j && (M.j = "precision lowp float;attribute vec2 a0;varying vec2 vv0;void main(){gl_Position=vec4(a0,0.,1.),vv0=a0*.5+vec2(.5,.5);}");
					void 0 === M.D && (M.D = ["a0"]);
					void 0 === M.K && (M.K = [2]);
					if (void 0 === M.precision || "highp" === M.precision) M.precision = C;
					M.id = E++;
					void 0 !== M.ul && M.ul.forEach(function (Y, ia) {
					...
					M.c.forEach(function (Y) {
						M.u[Y] = y.getUniformLocation(M.ha,
							Y)
					});
					M.attributes = {};
					M.ra = [];
				...
				function l(y) {
					ac.Fh(v);
					B !== y.id && (v.G(), B = y.id, x = y, g.useProgram(y.ha), y.ra.forEach(function (M) {
				...
				var G = [],
					...
					D = {
						...
						s8: {
							a: "uniform sampler2D u0;uniform float u4;varying vec2 vv0;const vec4 f=vec4(.25,.25,.25,.25),g=vec4(1.,1.,1.,1.);void main(){vec4 a=texture2D(u0,vv0);float b=dot(a*u4,f);gl_FragColor=b*g;}",
							c: ["u0", "u4"],
							s: H
						},
						s9: {
						...
						s15: {
							a: "uniform sampler2D u0;varying vec2 vv0;const vec4 f=vec4(1.,1.,1.,1.);void main(){vec4 a=texture2D(u0,vv0);gl_FragColor=mix(exp(-abs(a))-f,a,step(0.,a));}",
							c: z,
							s: H
						},
						s16: {
						...
						s20: {
							a: "uniform sampler2D u0,u10;uniform float u11;const vec2 e=vec2(.5,.5);const float f=1e-5;const vec4 g=vec4(1.,1.,1.,1.),i=vec4(0.,0.,0.,0.);varying vec2 vv0;void main(){vec4 a=texture2D(u10,e);float b=u11*u11;vec4 c=max(b*a,f*g);gl_FragColor=texture2D(u0,vv0)/c;}",
							c: ["u0", "u10", "u11"],
							s: {
								u0: 0,
								u10: 1
						...
						s22: {
							a: "uniform sampler2D u13,u14,u15;varying vec2 vv0;void main(){vec4 a=texture2D(u15,vv0);vec2 b=a.rg,c=a.ba;vec4 d=texture2D(u13,b),f=texture2D(u14,c);gl_FragColor=d*f;}",
							c: ["u13", "u14", "u15"],
							s: {
								u14: 0,
								u13: 1,
						...
						s23: {
							a: "uniform float u16;uniform sampler2D u13,u14;varying vec2 vv0;void main(){vec2 a=fract(vv0*u16);vec4 b=texture2D(u13,vv0),c=texture2D(u14,a);gl_FragColor=b*c;}",
							c: ["u14", "u13", "u16"],
							s: {
								u14: 0,
								u13: 1
						...
						s29: {
							a: "varying vec2 vv0;uniform sampler2D u1;uniform float u26;const vec3 f=vec3(.299,.587,.114);void main(){vec3 a=texture2D(u1,vv0).rgb,b=texture2D(u1,vv0+vec2(0.,u26)).rgb,c=texture2D(u1,vv0+vec2(u26,u26)).rgb,d=texture2D(u1,vv0+vec2(u26,0.)).rgb;gl_FragColor=vec4(dot(a,f),dot(b,f),dot(c,f),dot(d,f));}",
							c: ["u1", "u26"],
							s: F,
							precision: "lowp"
						},
						...
						s32: {
							a: "varying vec2 vv0;uniform sampler2D u1,u2;uniform float u27;const vec4 j=vec4(1.,1.,1.,1.);const vec2 k=vec2(1.,1.);void main(){float h=0.;vec2 l=k*u27,a,b;float c,d,i=0.;for(float e=-4.;e<=4.;e+=1.)for(float f=-4.;f<=4.;f+=1.)a=vec2(e,f),c=length(a)/2.,d=exp(-c*c),b=vv0+l*a,h+=d*texture2D(u1,b).r,i+=d;vec4 m=texture2D(u2,vv0);gl_FragColor=m.a*(texture2D(u1,b).r-h/i)*j;}",
							c: ["u1", "u2", "u27"],
							s: r
						},
						s33: {
						...
						s34: {
							a: "uniform sampler2D u3;uniform vec2 u7;varying vec2 vv0;const vec2 k=vec2(1.,0.),l=vec2(0.,1.),m=vec2(2.,0.),n=vec2(0.,2.);vec4 e(vec4 a,vec4 b){vec4 c=step(a,b);return mix(a,b,c);}vec4 f(vec2 a){vec4 b=texture2D(u3,a),c=texture2D(u3,a+u7*k),d=texture2D(u3,a+u7*l),g=texture2D(u3,a+u7),h=e(b,c),i=e(d,g);return e(h,i);}void main(){vec2 a=vv0+u7*vec2(-.55,-1.05);vec4 b=f(a),c=f(a+u7*m),d=f(a+u7*2.),g=f(a+u7*n),h=e(b,c),i=e(d,g);gl_FragColor=e(h,i);}",
							c: ["u3", "u7"],
							s: X
						},
						s35: {
						...
						s36: {
							a: "uniform sampler2D u1;uniform vec2 u7;varying vec2 vv0;const float e=15444.;void main(){vec4 a=1001./e*texture2D(u1,vv0-3.*u7)+2002./e*texture2D(u1,vv0-2.*u7)+3003./e*texture2D(u1,vv0-u7)+3432./e*texture2D(u1,vv0)+3003./e*texture2D(u1,vv0+u7)+2002./e*texture2D(u1,vv0+2.*u7)+1001./e*texture2D(u1,vv0+3.*u7);gl_FragColor=a;}",
							c: ["u7", "u1"],
							s: F,
							precision: "lowp"
						},
					...
					v = {
						...
						yg: function (y, M, V) {
							...
							D[M].uk = !0;
							p[y].za && p[y].za.forEach(function (Y, ia) {
						...
						G: function () {
							-1 !== B && (B = -1, x.ra.forEach(function (y) {
			...
			Ub = function () {
				...
				var l = null,
					...
					O = {
						...
						nn: function () {
							Za.W();
							t || (t = document.createElement("canvas"), w = t.getContext("2d"));
							t.width = l.width;
							t.height = l.height;
							for (var C = O.Mj(), P = w.createImageData(t.width, t.height), z = t.width, F = t.height, H = P.data, r = 0; r < F; ++r)
						...
						lg: function (C) {
							!t && C && (t = document.createElement("canvas"), w = t.getContext("2d"));
						...
						h: function (C) {
							C.Of && !C.ma ? l = document.getElementById(C.Of) :
								C.ma && (l = C.ma);
							...
							if (!g) {
								...
								g ? B = !0 : ((g = l.getContext("webgl", P)) || (g = l.getContext("experimental-webgl", P)), B = !1)
							}
							if (!g) return b("WebGL1 and 2 are not enabled");
							(G = g.getExtension("WEBGL_lose_context")) && C.$g && (E = C.$g, l.addEventListener("webglcontextlost", E, !1));
						...
						J: function () {
							g && eb.J();
							G && E && (l.removeEventListener("webglcontextlost",
								E, !1), E = null);
							x = w = t = l = null
						}
					};
			...
			ac = function () {
				function b() {
					null === f && ("undefined" !== typeof Ea ? f = Ea : "undefined" !== typeof L && (f = L))
				}
				var f = null;
				b();
				return {
			...
			ha = function () {
				...
				function f(S) {
					...
					S.forEach(function (aa, R) {
						...
						aa = qa >> 12 & 2047;
						var Ka = qa >> 23 & 255;
						qa = 103 > Ka ? ya : 142 < Ka ? ya | 31744 | ((255 == Ka ? 0 : 1) && qa & 8388607) : 113 > Ka ? (aa |= 2048, ya | (aa >> 114 - Ka) + (aa >> 113 - Ka & 1)) : (ya | Ka - 112 << 10 | aa >> 1) + (aa & 1);
						Z[R] = qa
					});
					return Z
				}
				...
				var t = 0,
					...
					ia = {
						h: function () {
							z || (C = [g.RGB, null, g.RGB, g.RGBA], P = [g.RGB, null, g.RGB, g.RGBA], w = [g.TEXTURE0, g.TEXTURE1, g.TEXTURE2, g.TEXTURE3, g.TEXTURE4, g.TEXTURE5, g.TEXTURE6, g.TEXTURE7], v = "undefined" !== typeof Ca, y = "undefined" !== typeof eb, B = [-1, -1, -1, -1, -1, -1, -1, -1],
								O = [g.UNSIGNED_BYTE, g.FLOAT, g.FLOAT], z = !0)
						},
						lk: function () {
							if (!x) {
								for (var S = new Float32Array(16384), Z = 0; 16384 > Z; ++Z) S[Z] = 2 * Math.random() - 1;
								x = {
									random: ia.instance({
										isFloat: !0,
										isPot: !0,
						...
						Fn: function (S, Z) {
							...
							pa.g(!1, !1);
							g.readPixels(0,
								0, aa, R, g.RGBA, g.UNSIGNED_BYTE, Z)
						},
						fg: function (S, Z, aa, R, qa, ya, Ka) {
							...
							0 !== Math.log2(qa.length) % 1 && (S.texParameteri(S.TEXTURE_2D, S.TEXTURE_WRAP_S, S.CLAMP_TO_EDGE), S.texParameteri(S.TEXTURE_2D, S.TEXTURE_WRAP_T, S.CLAMP_TO_EDGE));
							...
							S.pixelStorei(S.UNPACK_FLIP_Y_WEBGL,
								ya);
							S.texImage2D(S.TEXTURE_2D, 0, S.RGBA, aa, R, 0, S.RGBA, S.FLOAT, qa);
							S.bindTexture(S.TEXTURE_2D, null);
							S.pixelStorei(S.UNPACK_FLIP_Y_WEBGL, !1);
							Ka && (Za.fa(), Ea.set("s0"));
							S.viewport(0, 0, aa, R);
							S.framebufferTexture2D(S.FRAMEBUFFER, S.COLOR_ATTACHMENT0, S.TEXTURE_2D, Z, 0);
							S.bindTexture(S.TEXTURE_2D, Aa);
							Ka ? pa.g(!0, !0) : pa.wb(S);
							S.deleteTexture(Aa);
							z && (B[0] = -1, E = null, t = 0)
						...
						instance: function (S) {
							function Z(ra) {
								...
								Ba = g.getError();
								Ba !== g.NO_ERROR && I !== g.RGBA && (I = g.RGBA, g.texImage2D(g.TEXTURE_2D, 0, q, I, J, ra));
								return !0
							}
							...
							function aa() {
								if (!a) {
									...
									R.isPot ? (g.texParameteri(g.TEXTURE_2D, g.TEXTURE_WRAP_S, R.isMirrorX ? g.MIRRORED_REPEAT : g.REPEAT), g.texParameteri(g.TEXTURE_2D, g.TEXTURE_WRAP_T, R.isMirrorY ? g.MIRRORED_REPEAT : g.REPEAT)) : (g.texParameteri(g.TEXTURE_2D, g.TEXTURE_WRAP_S, g.CLAMP_TO_EDGE), g.texParameteri(g.TEXTURE_2D, g.TEXTURE_WRAP_T, g.CLAMP_TO_EDGE));
									R.isAnisotropicFiltering && "undefined" !==
										typeof fa && g.texParameterf(g.TEXTURE_2D, Ca.Nj().TEXTURE_MAX_ANISOTROPY_EXT, fa.li);
									g.texParameteri(g.TEXTURE_2D, g.TEXTURE_MAG_FILTER, R.isLinear ? g.LINEAR : g.NEAREST);
									R.isLinear ? g.texParameteri(g.TEXTURE_2D, g.TEXTURE_MIN_FILTER, R.isMipmap && !va ? g.NEAREST_MIPMAP_LINEAR : g.LINEAR) : g.texParameteri(g.TEXTURE_2D, g.TEXTURE_MIN_FILTER, R.isMipmap && !va ? g.NEAREST_MIPMAP_NEAREST : g.NEAREST);
									I = C[R.v - 1];
									q = P[R.v - 1];
									J = O[ya];
									if (eb.ea()) {
										var ra = g.RGBA32F;
										I === g.RGBA && J === g.FLOAT ? R.isMipmap || R.isLinear ? q = ic.Pj(g) : eb.$() ? ra &&
											(q = ra) : q = g.RGBA16F || g.RGBA : I === g.RGB && J === g.FLOAT && ra && (q = ra, I = g.RGBA)
									}
									if (R.L && !R.isFloat || R.isFloat && R.isMipmap && ic.zk())(ra = g.RGBA16F) && (q = ra), J = eb.he(g);
									R.He && (rb = R.He);
									...
									if (R.ga_) Z(R.ga_);
										...
										ra = wa;
										try {
											"FUCKING_BIG_ERROR" !== g.getError() && (g.texImage2D(g.TEXTURE_2D, 0, q, za, Qa, 0, I, J, ra), g.getError() !== g.NO_ERROR && (g.texImage2D(g.TEXTURE_2D, 0, q, za, Qa, 0, I, J, null), g.getError() !== g.NO_ERROR && g.texImage2D(g.TEXTURE_2D, 0, g.RGBA, za, Qa, 0, g.RGBA, g.UNSIGNED_BYTE,
												null)))
										} catch (Yb) {
											g.texImage2D(g.TEXTURE_2D, 0, q, za, Qa, 0, I, J, null)
										}
										R.isKeepArray || (wa = null)
									} else ra = g.getError(), "FUCKING_BIG_ERROR" !== ra && (g.texImage2D(g.TEXTURE_2D, 0, q, za, Qa, 0, I, J, null), ra = g.getError(), ra !== g.NO_ERROR && (I = g.RGBA, R.L && J !== g.FLOAT && (J = g.FLOAT, g.texImage2D(g.TEXTURE_2D, 0, q, za, Qa, 0, I, J, null))));
									if (R.isMipmap)
										if (!va && Pa) Pa.Ic(), Ua = !0;
										else if (va) {
							...
							R.data && (R.array = "string" === typeof R.data ? Ta(R.data) : R.isFloat ? new Float32Array(R.data) : new Uint8Array(R.data), R.isFlipY = !1);
							var ya = 0,
								Ka = R.ga_ ? !0 : !1,
								Aa = null,
								ba = null,
							...
							R.isFloat && (ya = 2);
							R.isAnisotropicFiltering && v && !Ca.yk() && (R.isAnisotropicFiltering = !1);
							...
							var Pa = {
								...
								Ni: function (ra, Ba) {
									va ? (ra || (ra = Pa.pg()), Pa.Bd(Ba), b(Ra[ra]), B[Ba] = -1) : Pa.b(Ba)
								},
								pg: function () {
								...
								Fj: function (ra) {
									if (va) {
										...
										Ea.set("s11");
										Pa.Bd(0);
										for (var Ba = za, vb = Qa, $a = 1; $a <= ra; ++$a) Ba /= 2, vb /= 2, Ea.P("u7", .25 / Ba, .25 / vb), g.viewport(0,
											0, Ba, vb), b(Ra[$a - 1]), g.framebufferTexture2D(Za.Mc(), g.COLOR_ATTACHMENT0, g.TEXTURE_2D, Ra[$a], 0), pa.g(!1, 1 === $a);
										B[0] = -1
									} else Pa.Ic()
								},
								Bd: function (ra) {
								...
								i: function () {
									E = Pa;
									g.framebufferTexture2D(Za.Mc(), g.COLOR_ATTACHMENT0, g.TEXTURE_2D, Q, 0)
								},
								N: function () {
									E = Pa;
									g.viewport(0, 0, za, Qa);
									g.framebufferTexture2D(Za.Mc(), g.COLOR_ATTACHMENT0,
										g.TEXTURE_2D, Q, 0)
								},
								od: ia.od,
								...
								refresh: function () {
									...
									Ka ? g.texImage2D(g.TEXTURE_2D,
										0, q, I, g.UNSIGNED_BYTE, R.ga_) : g.texImage2D(g.TEXTURE_2D, 0, q, za, Qa, 0, I, J, wa);
									ca && g.pixelStorei(g.UNPACK_FLIP_Y_WEBGL, !1)
								},
								Mf: function () {
									var ra = za * Qa * 4;
									e = [new Uint8Array(ra), new Uint8Array(ra), new Uint8Array(ra), new Uint8Array(ra)];
									d = [new Float32Array(e[0].buffer), new Float32Array(e[1].buffer), new Float32Array(e[2].buffer), new Float32Array(e[3].buffer)];
								...
								mh: function () {
									...
									for (var ra = za *
											Qa, Ba = 2 * ra, vb = 3 * ra, $a = 0; $a < ra; ++$a) d[0][$a] = m[$a], d[1][$a] = m[$a + ra], d[2][$a] = m[$a + Ba], d[3][$a] = m[$a + vb];
									return d
								},
								jl: function () {
									ub.Fg || (ub.Df = new Uint8Array(za * Qa * 4), ub.gg = new Float32Array(ub.buffer), ub.Fg = !0);
								...
								Wf: function (ra) {
									...
									Ea.set("s12");
									Pa.b(0);
									if (ra) g.viewport(0, 0, za, Qa), Ea.oa("u8", .25, .25, .25, .25), pa.g(!1, !0);
									else
										for (ra = 0; 4 > ra; ++ra) g.viewport(0, Qa * ra, za, Qa), Ea.oa("u8", p[ra]), pa.g(!1, 0 === ra)
								},
								bo: function (ra) {
									var Ba;
									if (Ba =
										J === O[0]) null !== Y.se ? Ba = Y.se : (Ba = l(new Uint8Array([255, 255, 255, 255])), Ba = null === Ba ? !0 : Y.se = Ba), Ba = !Ba;
									b(Q);
									ca && g.pixelStorei(g.UNPACK_FLIP_Y_WEBGL, !0);
									Ba ? (A || (Aa = document.createElement("canvas"), Aa.width = za, Aa.height = Qa, ba = Aa.getContext("2d"), ka = ba.createImageData(za, Qa), A = !0), ka.data.set(ra), ba.putImageData(ka, 0, 0), g.texImage2D(g.TEXTURE_2D, 0, q, I, J, Aa)) : g.texImage2D(g.TEXTURE_2D, 0, q, za, Qa, 0, I, J, ra);
									B[t] = qa;
									ca && g.pixelStorei(g.UNPACK_FLIP_Y_WEBGL, !1)
								},
								co: function (ra, Ba) {
								...
								jc: function (ra, Ba) {
									...
									c || ("RGBA" === ra || "RGBE" === ra || "RGBAARRAY" === ra ? (e = new Uint8Array($a), c = !0) : "JSON" !== ra || Ba || Pa.Mf());
									Za.W();
									Ea.set(Na);
									Pa.b(0);
									$a = null;
									if ("RGBA" === ra || "RGBE" === ra || "RGBAARRAY" === ra) {
										...
										if ("RGBAARRAY" === ra) return {
											data: e
										};
										r || (X = document.createElement("canvas"), D = X.getContext("2d"), r = !0);
										X.width = za;
										X.height = Qa;
										...
										if (Ba) $a = new Float32Array(vb), g.viewport(0, 0, za, Qa), pa.g(!0, !0), g.readPixels(0, 0, za, Qa, g.RGBA, g.FLOAT, $a);
										else {
											for ($a = 0; 4 > $a; ++$a) g.viewport(0, Qa * $a, za, Qa), Ea.oa("u8", p[$a]), pa.g(!$a, !$a);
											Pa.mh();
											$a = Array(vb);
											for (Ba = 0; Ba < vb; ++Ba) $a[4 * Ba] = d[0][Ba], $a[4 * Ba + 1] = d[1][Ba], $a[4 * Ba + 2] = d[2][Ba], $a[4 * Ba + 3] = d[3][Ba]
										}
									return {
										format: ra,
										data: $a,
							...
							if (R.url) b(Q), g.texImage2D(g.TEXTURE_2D, 0, g.RGBA, 1, 1, 0, g.RGBA, g.UNSIGNED_BYTE, null), sa = new Image, sa.an = "Anonymous", sa.crossOrigin = "Anonymous", sa.src = R.url, sa.onload = function () {
								za = sa.width;
								Qa = sa.height;
								aa()
							};
								...
								var wc = function () {
									za =
										void 0 !== R.ga_.videoWidth ? R.ga_.videoWidth : R.ga_.width;
									Qa = void 0 !== R.ga_.videoHeight ? R.ga_.videoHeight : R.ga_.height;
									za ? aa() : setTimeout(wc, 1)
								};
								wc()
							} else R.array ? (R.L && !R.isFloat ? R.array instanceof Uint16Array ? (wa = R.array, aa()) : n() ? (wa = f(R.array), aa()) : (aa(), ia.fg(g, Q, Pa.I(), Pa.U(), R.array, ca, !0)) : (wa = R.isFloat ? R.array instanceof Float32Array ? R.array : new Float32Array(R.array) : R.array instanceof Uint8Array ? R.array : new Uint8Array(R.array), aa()), R.isKeepArray || (wa && wa !== R.array && (wa = null), delete R.array)) :
								aa();
							Pa.tn = Pa.I;
						...
						od: function () {
							E = null;
							g.framebufferTexture2D(Za.Mc(), g.COLOR_ATTACHMENT0, g.TEXTURE_2D, null, 0)
						},
						reset: function () {
						...
						pc: function (S, Z) {
							...
							} else "JSON" === S.format ? Z(ia.instance({
									isFloat: !0,
									isFlipY: S.isFlipY,
									width: S.width,
									height: S.height,
			...
			pa = function () {
				function b(x) {
					...
					x.bufferData(x.ARRAY_BUFFER, new Float32Array([-1, -1, 3, -1, -1, 3]), x.STATIC_DRAW);
					E.O = x.createBuffer();
					x.bindBuffer(x.ELEMENT_ARRAY_BUFFER, E.O);
					x.bufferData(x.ELEMENT_ARRAY_BUFFER, new Uint16Array([0, 1, 2]), x.STATIC_DRAW);
					return E
				}
				var f = null,
					n = 0,
					...
					B = {
						...
						instance: function (x) {
							...
							g.bufferData(g.ARRAY_BUFFER, x.ba instanceof Float32Array ? x.ba : new Float32Array(x.ba), C);
							w = E;
							var z = null,
								F = null,
								H = null;
							if (x.O) {
								...
								var r = null;
								65536 > x.O.length ? (r = Uint16Array, F = g.UNSIGNED_SHORT, H = 2) : (r = Uint32Array, F = g.UNSIGNED_INT, H = 4);
							...
							var X = {
								Zb: function (D) {
									w !==
										E && (g.bindBuffer(g.ARRAY_BUFFER, P), w = E);
									D && ac.hd()
								},
								Li: function () {
						...
						Fd: function () {
							-1 !== w && (g.bindBuffer(g.ARRAY_BUFFER, f.ba), w = -1); - 1 !== G && (g.bindBuffer(g.ELEMENT_ARRAY_BUFFER, f.O), G = -1)
						},
						g: function (x, E) {
							x && pa.Fd();
							E && ac.mc();
							g.drawElements(g.TRIANGLES,
								3, g.UNSIGNED_SHORT, 0)
						},
						wb: function (x) {
							x = x || g;
							var E = b(x);
					...
					G = {
						...
						h: function () {
							if (!l) {
								...
								var B = eb.ea();
								f = B && g.DRAW_FRAMEBUFFER ? g.DRAW_FRAMEBUFFER : g.FRAMEBUFFER;
								n = B && g.READ_FRAMEBUFFER ? g.READ_FRAMEBUFFER : g.FRAMEBUFFER;
								l = !0
							}
						},
						Oj: function () {
						...
						instance: function (B) {
							...
							var r = {
								...
								vc: function () {
									...
									g.renderbufferStorage(g.RENDERBUFFER, g.DEPTH_COMPONENT16, E, O);
									g.framebufferRenderbuffer(f, g.DEPTH_ATTACHMENT, g.RENDERBUFFER, P);
									g.clearDepth(1)
								},
								bind: function (X, D) {
								...
								rtt: function (X) {
									x = X;
									w.da !== H && (g.bindFramebuffer(g.FRAMEBUFFER, C), w.da = H);
									X.i()
								},
								W: function () {
								...
								resize: function (X, D) {
									E = X;
									O = D;
									P && (g.bindRenderbuffer(g.RENDERBUFFER, P), g.renderbufferStorage(g.RENDERBUFFER,
										g.DEPTH_COMPONENT16, E, O))
								},
								remove: function () {
									C === b || F || (g.bindFramebuffer(f, C), g.framebufferTexture2D(f, g.COLOR_ATTACHMENT0, g.TEXTURE_2D, null, 0), P && g.framebufferRenderbuffer(f, g.DEPTH_ATTACHMENT, g.RENDERBUFFER, null), g.bindFramebuffer(f, null), g.deleteFramebuffer(C), P && g.deleteRenderbuffer(P));
									F = !0
								}
							};
							B.cc && r.vc();
				...
				var n = null,
					...
					H = {
						h: function () {
							...
							if (!t) {
								w = H.bg(r);
								if ((F.GL_EXT_FLOAT = w) || H.ea()) G = H.cg(r), F.GL_EXT_FLOATLINEAR = G;
								t = !0
							}
							if (!O) {
						...
						$f: f.bind(null, ["EXT_color_buffer_float", "WEBGL_color_buffer_float", "OES_color_buffer_float"]),
						ag: f.bind(null, ["EXT_color_buffer_half_float", "WEBGL_color_buffer_half_float", "OES_color_buffer_half_float"]),
						bg: f.bind(null, ["OES_texture_float", "MOZ_OES_texture_float", "WEBKIT_OES_texture_float"]),
						cg: f.bind(null, ["OES_texture_float_linear", "MOZ_OES_texture_float_linear", "WEBKIT_OES_texture_float_linear"]),
						Hc: f.bind(null, ["OES_texture_half_float", "MOZ_OES_texture_half_float", "WEBKIT_OES_texture_half_float"]),
						dg: f.bind(null, ["OES_texture_half_float_linear", "MOZ_OES_texture_half_float_linear", "WEBKIT_OES_texture_half_float_linear"]),
						he: function (r) {
							var X = H.Hc(r);
							return X && X.HALF_FLOAT_OES ? X.HALF_FLOAT_OES : r.HALF_FLOAT || r.FLOAT
						},
						Jj: function () {
							return z
						},
						...
						nd: function (r, X, D) {
							...
							r.framebufferTexture2D(r.FRAMEBUFFER, r.COLOR_ATTACHMENT0, r.TEXTURE_2D, V, 0);
							if (r.checkFramebufferStatus(r.READ_FRAMEBUFFER || r.FRAMEBUFFER) !== r.FRAMEBUFFER_COMPLETE) return p(), !1;
							ac.ed(r);
						...
						lj: function () {
							...
							X.i();
							g.flush();
							g.checkFramebufferStatus(Za.mg()) !== g.FRAMEBUFFER_COMPLETE ? (ha.Ml(), z.be = !1) : z.be = !0;
							r.remove();
							X.remove()
						},
						jj: function () {
			...
			ic = function () {
				function b(D,
					p, v, y) {
					z.texParameteri(z.TEXTURE_2D, z.TEXTURE_MIN_FILTER, y ? z.NEAREST_MIPMAP_NEAREST : z.LINEAR);
					var M = null;
					if (null !== v) try {
						M = z.getError();
					...
					M = z.getError();
					M === z.INVALID_OPERATION && "undefined" !==
						typeof z.PIXEL_PACK_BUFFER && (z.bindBuffer(z.PIXEL_PACK_BUFFER, null), z.readPixels(0, 0, 1, 1, z.RGBA, z.UNSIGNED_BYTE, O), M = z.getError());
					if (M !== z.NO_ERROR) return !1;
				...
				function f(D, p) {
					return F.Ma && b(D, z.FLOAT, new Float32Array(P), p) ? (B = G.vf, !0) : !1
				}

				function n(D, p, v) {
					if (!F.Na) return !1;
					var y = eb.Hc(z);
					if (y && y.HALF_FLOAT_OES && b(D, y.HALF_FLOAT_OES, new Uint16Array(P), p) || z.HALF_FLOAT && b(D, z.HALF_FLOAT, new Uint16Array(P), p) || b(D, z.FLOAT, new Float32Array(P), p)) return B = G.Wb, !0;
					z.bindTexture(z.TEXTURE_2D,
						v);
					z.texImage2D(z.TEXTURE_2D, 0, z.RGBA, 1, 1, 0, z.RGBA, z.UNSIGNED_BYTE, null);
			...
			xa = {
				instance: function (b) {
					var f = null,
						...
						E = "undefined" === typeof b.preprocessingSize ? b.size : b.preprocessingSize;
					b.mask && (n = !0, K && void 0 !== K.X && (b.mask = K.X + b.mask), f = ha.instance({
						isFloat: !1,
						url: b.mask
					}));
					var O = !1;
					b.customInputShader && (O = "s44", Ea.ia({
						name: "_",
						id: O,
					...
					var C = ha.instance({
						...
						P = {
							...
							ta: function () {
								Za.fa();
								B && (Ea.set(B), w && Ea.A("u27", 1 / b.size), C.N(), n && f.b(1), pa.g(!1, !1), C.b(0), l && t.process(C))
							},
							J: function () {
								C.remove();
								n && f.remove()
			...
			nb = {
				instance: function (b) {
					...
					var f = {
						...
						B = !0,
						x = -1,
						E = b.isReorganize ? b.isReorganize :
						!1,
					...
					b.vk ? (b.sparsity = "undefined" !== typeof b.sparsity ? b.sparsity : b.$c.ie(), B = !1) : "full" === b.connectivityUp && (b.sparsity = b.$c.ie());
					var F = {
							elu: "s15",
							elu01: "s16",
							relu: "s14",
					...
					var S = {
						...
						Nl: function () {
							switch (b.connectivityUp) {
								...
								case "full":
									...
									break;
								case "conv":
									x = b.kernelsNumber, ia = k.instance(b.connectivity), E && (f.Yc = ha.instance({
										width: X,
										isFloat: !0,
										isFlipY: !1,
										isPot: !1
						...
						ta: function (Z) {
							n =
								Z;
							ia.Rb ? (f.input.N(), O && f.wc.b(2), ia.ta(z), f.input.b(0), f.input.Fj(Y), f.ue.N(), O ? Ea.set("s0") : (Ea.set("s27"), Ea.A("u25", H), f.wc.b(1)), f.input.Ni(Y, 0), pa.g(!1, !1), Ea.set(F), p ? y.i() : f.Ga.i(), f.ue.b(0), P && C.tj(), pa.g(!1, !1)) : (f.Ga.N(), f.wc.b(1), ia.ta());
							p && (Ea.set(v), M.i(), y.b(0), pa.g(!1, !1), Ea.set("s46"), Ea.A("u6", 1), f.Ga.i(), M.b(1), pa.g(!1, !1));
							if (B) return r ? (f.Ke.N(), f.Ga.b(0), Ea.set(D), Ea.P("u7", 1 / b.size, 1 / b.size), pa.g(!1, !1), Z = f.Ke) : Z = f.Ga, Z.b(0), E && (f.Yc.i(), Ea.set("s21"), Ea.P("u12", x, X / x), pa.g(!1, !1), Z = f.Yc, f.Yc.b(0)), Z;
							Z = f.Ga;
							b.disableNormalize || (Ea.set("gpuRawAvg" === w ? "s8" : "s7"), Ea.A("u4", 1 / b.size), f.Le.N(), f.Ga.b(0), pa.g(!1, !1), Z = f.Le);
							switch (w) {
								case "cpuRGBA2Float":
									Z.Wf(!1);
									Z = S.il(Z);
						...
						$i: function (Z) {
							...
							Z = "undefined" !== typeof b.classesCount && b.classesCount ? b.classesCount :
								b.size * b.size;
							for (var aa = 0, R = 0, qa = 0; aa < Z; ++aa) l.push(R + (b.size - 1 - qa) * b.size), t.push([-1, -1, -1, -1]), ++R, R === b.size && (R = 0, ++qa);
							b.disableNormalize || (f.Le = ha.instance({
								isFloat: !0,
								isPot: !0,
								width: b.size
							}))
					...
					return {
						...
						ta: function (l) {
							if (l.isEnabled) {
								Ea.set("s24");
								l.Ok.b(3);
								var t, w = Math.min(l.Qc.length, l.depth);
			...
			Ya = {
				instance: function (b) {
					for (var f = b.fromLayerSize, n = b.toLayerSize, l = b.toSparsity, t = l * n, w = t / f, G = f / n, B = 0, x = 0, E = 0, O = Array(l * n * l * n * 4), C = Array(l * n * l * n * 4), P = Array(f * f), z = 0; z < P.length; ++z) P[z] = 0;
					z = Math.floor(l / 2);
					for (var F = .5 / n, H = .5 / f, r = .5 / t, X = 0; X < n; ++X)
			...
			Fc = {
				instance: function (b,
					...
					delete b.weights.data;
					var O = "s47" + [n.toString(), l.toString(), t.toString(), w.toString(), f].join("_");
					Ea.Dj(O) || (b = hb(f), l = [{
						type: "1f",
						name: "u16",
						value: l
						...
						name: "u24",
						value: n
					}), n = [(B ? G : t).toFixed(1), b], B && n.push(x.toFixed(1)), Ea.yg(B ? "s39" : "s38", O, n), Ea.f(O, l.concat([{
							type: "1i",
							name: "u14",
							value: 0
						}, {
				...
				instance: function (b) {
					...
					return {
						process: function (C) {
							...
							pa.g(t, !1);
							Ea.set("s36");
							for (var P = 0; P < f; ++P) w.i(),
								Ea.P("u7", O, 0), pa.g(t, !1), B.i(), x.b(0), pa.g(t, !1), G.i(), w.b(0), Ea.P("u7", 0, O), pa.g(t, !1), x.i(), B.b(0), pa.g(t, !1), P !== f - 1 && G.b(0);
							Ea.set("s37");
							E.i();
							C.b(0);
							G.b(1);
			...
			$b = function () {
					...
					if (-1 !== V) switch (M) {
						...
						case y.movePinch:
							if (2 === V || 3 === V) {
								...
								m = ia[0] - Y[0];
								var q = ia[1] - Y[1];
								2 === V ? (wa += Math.sqrt(m * m + q * q), 10 > wa ? (Y[0] = ia[0], Y[1] = ia[1]) : (Mb || (Mb = !0, H("moveStart", null, null, null)), za[0] = m, za[1] = q, Z[0] = m - S[0], Z[1] = q - S[1], H("move", za, Z, null), S[0] = za[0], S[1] = za[1])) : 3 === V && (h = E(h) / Qa, H("pinch", h, h - a, null), a = h)
							}
					}
				}
				...
				function n(h) {
					if (-1 !== V) switch (M) {
						case y.swipe:
							...
							h = ia[0] - Y[0];
							var m = 0 > h;
							(h = 20 < 100 * Math.abs(h) / D.offsetWidth) && m ? H("swipeLeft", aa, null, null) : h && !m && H("swipeRight",
								aa, null, null);
							var q = function () {
								setTimeout(function () {
									B();
							...
							h ? (h = function () {
								...
								q()
							}, Ka ? h() : ba = h) : (aa.style.transitionDuration = (200).toString() + "ms", aa.style.opacity = "0", aa.style.left = Aa[0].toString() + "px", aa.style.top = Aa[1].toString() + "px", aa.style.transform =
								"", q());
							V = -1;
							break;
						case y.movePinch:
							if (2 === V || 3 === V) V === V.move ? H("moveEnd", null, null, null) : 3 === V && H("pinchEnd", null, null, null), V = 0
					}
				}
				...
				function l(h) {
					...
					if (-1 !== V) switch (M) {
						case y.swipe:
							...
							break;
						case y.movePinch:
							0 !== V ? 2 !== V || Mb || void 0 === h.changedTouches && void 0 === h.touches || (Qa = E(h), 20 < Qa && (V = 3, a = 1, H("pinchStart",
								null, null, null))) : 3 !== V && (Mb = !1, O(h, Y), S[0] = 0, S[1] = 0, V = 2, wa = 0)
					}
				}
				...
				function t(h) {
					...
					aa.style.transform = "rotate( " + ((m ? 1 : -1) * h / D.width).toString() + "rad )"
				}
				...
				function O(h, m) {
					void 0 !== h.changedTouches || void 0 !== h.touches ? C(h, m, 0) : (m[0] = h.pageX, m[1] = h.pageY)
				}

				function C(h, m, q) {
					h.touches.length > q ? (m[0] = h.touches[q].pageX, m[1] = h.touches[q].pageY) : (m[0] = h.changedTouches[q].pageX, m[1] = h.changedTouches[q].pageY)
				}
				...
				var Ka = !1,
					...
					e = {
						init: function (h) {
							...
							else return D = h.ma, F("mousedown", l), F("mouseup", n), F("mouseout", n), F("mousemove", f), F("mousemove", f), F("wheel", b), F("touchstart", l), F("touchend", n), F("touchmove", f), X = !0, e
						},
						switch_canvas: function (h) {
							if (!X) e.init({
								...
								z(m);
								for (var q in p)
									for (h = p[q], m = h.length - 1; 0 <= m; --m) h[m].ll && h.splice(m, 1)
							}
						},
						get_mode: function () {
							for (var h in y)
						...
						switch_mode: function (h) {
							X && "undefined" !== typeof y[h] && (h = y[h], M !== h && (x(), M = h, V = 0))
						},
						...
						animate_swipe: function (h, m) {
							...
							w();
							var q = D.width / (m / 1E3) * ("left" ===
									h ? -1 : 1),
								I = 0,
								J, ca = Date.now();
							sa = setInterval(function () {
								sa && (J = Date.now(), I += (J - ca) / 1E3 * q, t(I), ca = J, Math.abs(I) > .75 * D.width && sa && (clearInterval(sa), sa = null, B()))
							}, 16)
						}
					};
				return e
		...
		ma.set_settings = function (b, f, n) {
			...
			f && Object.keys(f).forEach(function (l) {
				Jb[l] = f[l]
			});
		...
		ma.init = function (b, f, n, l) {
			...
			if (!Ub.h({
				...
				ma.Ya("GL_INCOMPATIBLE", "Cannot init Context"), !1;
			ma.zd && ma.zd();
			(b = {
				width: {
					min: Jb.minWidth,
			...
			}, -1 !== rd) ? b.deviceId = rd: b.facingMode = {
				ideal: "user"
			};
			ua(function (t) {
				ma.Ad && ma.Ad(t);
					...
					G = {
						h: function (B) {
							...
							Ea.yf([{
								id: "s59",
								name: "_",
								a: "uniform sampler2D u33;void main(){vec4 a=texture2D(u33,vec2(.25,.5));float b=step(1.99,a.r);gl_FragColor=vec4(b,0.,0.,1.);}",
								c: ["u33"],
								precision: "lowp"
							}]);
							Ea.f("s59", [{
		...
		Da.prototype = {
			...
			F: 1,
			set: function (b) {
				b instanceof Da ? this.B(b) : "number" === typeof b ? Ha(this, b) : "string" === typeof b && Va(this, b);
				return this
			},
			wl: function () {
				function b(f, n, l) {
					0 > l && (l += 1);
					1 < l && --l;
					return l < 1 / 6 ? f + 6 * (n - f) * l : .5 > l ? n : l < 2 / 3 ? f + 6 * (n - f) * (2 / 3 - l) : f
				}
				return function (f, n, l) {
					f = kd.Math.hn(f, 1);
					n = kd.Math.Ld(n, 0, 1);
					l = kd.Math.Ld(l, 0, 1);
					0 === n ? this.r = this.S = this.F = l : (n = .5 >= l ? l * (1 + n) :
						l + n - l * n, l = 2 * l - n, this.r = b(l, n, f + 1 / 3), this.S = b(l, n, f), this.F = b(l, n, f - 1 / 3));
					return this
				}
			}(),
			clone: function () {
		...
		xb.prototype = {
			...
			Dc: function (b) {
				return this.l *
					b.l + this.m * b.m + this.o * b.o + this.C * b.C
			},
			ve: function () {
				return this.l * this.l + this.m * this.m + this.o * this.o + this.C * this.C
			},
			length: function () {
				return Math.sqrt(this.l * this.l + this.m * this.m + this.o * this.o + this.C * this.C)
			},
			normalize: function () {
				var b = this.length();
				0 === b ? (this.o = this.m = this.l = 0, this.C = 1) : (b = 1 / b, this.l *= b, this.m *= b, this.o *= b, this.C *= b);
				return this
			},
			multiply: function (b, f) {
				return void 0 !== f ? (console.warn("JETHREE.Quaternion: .multiply() now only accepts one argument. Use .multiplyQuaternions( a, b ) instead."),
					Vb(this, b, f)) : Vb(this, this, b)
			},
			Kh: function (b, f) {
				if (0 === f) return this;
				...
				0 > G ? (this.C = -b.C, this.l = -b.l, this.m = -b.m, this.o = -b.o, G = -G) : this.B(b);
				if (1 <= G) return this.C = w, this.l = n, this.m = l, this.o = t, this;
				b = Math.acos(G);
				var B = Math.sqrt(1 - G * G);
				if (.001 > Math.abs(B)) return this.C = .5 * (w + this.C), this.l = .5 * (n + this.l), this.m = .5 * (l + this.m), this.o = .5 * (t + this.o), this;
				G = Math.sin((1 - f) * b) / B;
				f = Math.sin(f * b) / B;
				this.C = w * G + this.C * f;
				this.l =
		...
		Cb.prototype = {
			...
			add: function (b, f) {
				if (void 0 !== f) return console.warn("JETHREE.Vector2: .add() now only accepts one argument. Use .addVectors( a, b ) instead."), this.uc(b, f);
				this.x += b.x;
				this.y += b.y;
				return this
			},
			...
			sub: function (b, f) {
				if (void 0 !== f) return console.warn("JETHREE.Vector2: .sub() now only accepts one argument. Use .subVectors( a, b ) instead."), this.Ta(b, f);
				this.x -= b.x;
				this.y -= b.y;
				return this
			},
		...
		Xa.prototype = {
			...
			add: function (b, f) {
				if (void 0 !== f) return console.warn("JETHREE.Vector3: .add() now only accepts one argument. Use .addVectors( a, b ) instead."), this.uc(b, f);
				this.x += b.x;
				this.y +=
					b.y;
				this.z += b.z;
			...
			sub: function (b, f) {
				if (void 0 !== f) return console.warn("JETHREE.Vector3: .sub() now only accepts one argument. Use .subVectors( a, b ) instead."), this.Ta(b, f);
				this.x -= b.x;
				this.y -= b.y;
				this.z -= b.z;
				return this
			...
			multiply: function (b, f) {
				if (void 0 !== f) return console.warn("JETHREE.Vector3: .multiply() now only accepts one argument. Use .multiplyVectors( a, b ) instead."),
					this.x = b.x * f.x, this.y = b.y * f.y, this.z = b.z * f.z, this;
				this.x *= b.x;
				this.y *= b.y;
				this.z *= b.z;
				return this
			...
			xa: function (b) {
				isFinite(b) ? (this.x *= b, this.y *= b, this.z *= b) : this.z = this.y = this.x = 0;
				return this
			},
			Wd: function (b) {
				return this.xa(1 / b)
			...
			Ld: function (b, f) {
				this.x = Math.max(b.x, Math.min(f.x,
					this.x));
				this.y = Math.max(b.y, Math.min(f.y, this.y));
		...
		qc.prototype = {
			...
			getParameter: function (b, f) {
				return (f || new Xa).set((b.x - this.min.x) / (this.max.x - this.min.x), (b.y - this.min.y) / (this.max.y - this.min.y), (b.z - this.min.z) / (this.max.z - this.min.z))
			},
		...
		tc.prototype = {
			...
			multiply: function (b, f) {
				return void 0 !== f ? (console.warn("JETHREE.Matrix4: .multiply() now only accepts one argument. Use .multiplyMatrices( a, b ) instead."), cc(this, b, f)) : cc(this, this, b)
			},
			xa: function (b) {
				var f = this.elements;
				f[0] *= b;
		...
		Ec.prototype = {
			...
			B: function (b) {
				...
				this.Eb = b.Eb;
				for (var f = 0, n = b.rd.length; f < n; f++) this.rd[f] = b.rd[f].clone();
				f = 0;
		...
		var L = function () {
				...
				function f(p, v) {
					Ca.ea() && (v.a = v.a.replace(/gl_FragData\[([0-3])\]/g,
						"gbuf$1"));
				...
				function n(p) {
					...
					p.aa || (p.a = p.a.replace(/void main/g, "out vec4 FragColor;\nvoid main"), p.a = p.a.replace(/gl_FragColor/g,
						"FragColor"));
					var v = 0,
						y = [];
					p.j = p.j.replace(/attribute ([a-z]+[0-4]*) ([_a-zA-Z,0-9\s]+);/g, function (M, V, Y) {
						var ia = "";
				...
				function l(p, v) {
					...
					void 0 === v.aa && (v.aa = !1);
					v.aa && (v.de = D.Hj(), v.rc = y ? 3 : 2, v.En = y ? "none" : "highp");
					v.id = X++;
					void 0 === v.rc && (v.rc = 2);
					void 0 === v.de && (v.de = "");
					void 0 === v.Yh && (v.Yh = "");
					void 0 ===
						v.precision && (v.precision = "highp");
					"none" !== v.precision && (v.a = "precision " + v.precision + " float;\n" + v.a);
					v.a = v.de + v.a;
					void 0 === v.j && (v.j = "precision lowp float;attribute vec2 a0;varying vec2 vv0;void main(){gl_Position=vec4(a0,0.,1.),vv0=a0*.5+vec2(.5,.5);}");
					v.j = v.Yh + v.j;
					y && 3 <= v.rc && n(v);
					v.za && v.za.forEach(function (M) {
					...
					v.D.forEach(function (M, V) {
						var Y = y && 3 <= v.rc ? v.hi.indexOf(M) : p.getAttribLocation(v.ha, M);
						v.attributes[M] = Y;
						v.ra.push(Y);
						v.pf += 4 * v.K[V]
					});
					v.set = function () {
						H !== v.id && (-1 !== H && r.G(), H = v.id, r = v, p.useProgram(v.ha), v.ra.forEach(function (M) {
				...
				function B() {
					...
					F.s96 = {
						name: "_",
						a: "uniform vec4 u91;uniform float u127;void main(){float b=u127;vec4 a=u91;float c=floor(15.99*b),d=floor(15.99*a.b);a.b=(c+16.*d)/255.,gl_FragColor=a;}",
						j: "attribute vec3 a0;uniform sampler2D u33;uniform vec3 u122;uniform vec2 u34,u130;uniform float u123,u124,u125,u131;const vec2 e=vec2(1.,1.);const vec3 j=vec3(1.,1.,1.);const vec2 u=vec2(-1.,1.);uniform mat4 u58;uniform vec3 u60,u64,u65,u66;uniform float u59,u67,u68,u61,u62,u63,u69;mat3 k(vec3 c){vec3 b=cos(c),a=sin(c);return mat3(b.y*b.z,a.z,a.y*b.z,b.y*a.z*b.x-a.x*a.y,-b.z*b.x,a.y*a.z*b.x+b.y*a.x,b.y*a.z*a.x+a.y*b.x,-a.x*b.z,a.y*a.z*a.x-b.y*b.x);}void main(){vec4 b=texture2D(u33,vec2(.25,.5));vec2 c=u67*e;vec3 a=u67*j;vec2 l=mix(b.a*u34,e,c),d=(2.*b.gb-e)*(1.-c);d.x*=-1.;vec3 f=mix(texture2D(u33,vec2(.75,.5)).rgb+vec3(u61,0.,0.),u64,a);mat3 m=k(f);vec3 n=mix(u122,u65,a);float o=mix(u123,u68,u67);vec3 p=mix(u60,u66,a);float q=mix(u63,1.,u67);vec2 g=u62/l;vec3 h=a0;float r=max(0.,-a0.z-u124)*u125;h.x+=r*sign(a0.x)*(1.-u67);vec3 i=m*(h+n)*o+p;i.x+=u59*sin(f.y);vec2 s=g*q;vec3 t=vec3(d*s,-g)+i*vec3(1.,-1.,-1.);gl_Position=u58*(vec4(u69*e,e)*vec4(t,1.));}",
						c: ["u91", "u127"].concat(p),
						precision: "lowp"
					};
					...
					F.s98 = {
						name: "_",
						a: "varying vec3 vv0;varying float vv1;void main(){gl_FragColor=vec4(vv0,vv1);}",
						j: "attribute vec3 a0;uniform mat4 u115,u103,u116;varying vec3 vv0;varying float vv1;void main(){vec4 a=u116*vec4(a0,1.);gl_Position=u115*u103*a,vv0=a.xyz,vv1=1.;}",
						c: p,
						precision: "highp"
					};
					F.s99 = {
						name: "_",
						a: "varying vec3 vv0;void main(){gl_FragColor=vec4(normalize(vv0),1.);}",
						j: "attribute vec3 a0,a2;uniform mat4 u115,u103,u116;varying vec3 vv0;varying float vv1;void main(){vec4 a=u116*vec4(a2,0.);gl_Position=u115*u103*u116*vec4(a0,1.),vv0=a.xyz,vv1=a0.y;}",
						c: p,
						D: ["a0", "a2"],
						precision: "highp"
					};
					F.s89 = {
						name: "_",
						a: "uniform sampler2D u132;uniform vec3 u133;varying vec4 vv0;varying vec3 vv1,vv2;varying vec2 vv3;const vec3 i=vec3(1.,1.,1.);void main(){vec3 j=normalize(vv1+u133),c=normalize(vv2),b=texture2D(u132,vv3).xyz;b=normalize(b*255./127.-1.007874*i);vec3 d=vv0.xyz,k=cross(c,d)*vv0.w;mat3 l=mat3(d,k,c);vec3 a=l*b;a=dot(a,j)>0.?vv2:a,gl_FragColor=vec4(a,1.);}",
						j: "attribute vec4 a3;attribute vec3 a0,a2;attribute vec2 a1;uniform mat4 u115,u103,u116;varying vec4 vv0;varying vec3 vv1,vv2;varying vec2 vv3;void main(){vec4 b=u116*vec4(a2,0.),a=u116*vec4(a0,1.);gl_Position=u115*u103*a,vv0=a3,vv2=b.xyz,vv3=a1,vv1=a.xyz;}",
					...
					F.s88 = {
						name: "_",
						a: "uniform sampler2D u1;uniform vec3 u126;uniform float u55;varying vec2 vv0;void main(){vec4 a=texture2D(u1,vv0);vec3 b=mix(u126,a.rgb,a.a);vec4 c=vec4(mix(a.rgb*u126,b,u55),a.a);gl_FragColor=c;}",
						j: "attribute vec3 a0;attribute vec2 a1;uniform mat4 u115,u103,u116;varying vec2 vv0;const vec4 f=vec4(0.,0.,5e-4,0.);void main(){gl_Position=u115*u103*u116*vec4(a0,1.)+f,vv0=a1;}",
						c: ["u126"].concat(O, p),
						D: ["a0", "a1"],
						za: [{
							search: "0.0005",
					...
					F.s100 = {
						name: "_",
						a: "uniform vec4 u91;uniform float u127;void main(){float b=u127;vec4 a=u91;float c=floor(15.99*b),d=floor(15.99*a.b);a.b=(c+16.*d)/255.,gl_FragColor=a;}",
						j: "attribute vec3 a0;uniform mat4 u115,u103,u116;void main(){gl_Position=u115*u103*u116*vec4(a0,1.);}",
						c: ["u91"].concat(p),
						precision: "highp"
					};
					F.s90 = {
						name: "_",
						a: "uniform sampler2D u56;uniform vec4 u91,u57;uniform float u127;varying vec2 vv0;vec2 i(float d,float e){float f=floor(d*255.+.01),a=pow(2.,e),g=256./a,b=f/a,c=floor(b),h=(b-c)*a;return vec2(c/(g-1.),h/(a-1.));}void main(){float c=u127;vec4 a=u91,d=texture2D(u56,vv0);vec2 b=i(d.b,4.);float f=1.-b.x,g=b.y;b=i(d.a,1.);float h=b.x,e=b.y;vec4 k=vec4(d.rg,g,h);float l=f;a=mix(a,k,u57*e),c=mix(c,l,u57.b*e);float m=floor(15.99*c),n=floor(15.99*a.b);a.b=(m+16.*n)/255.,gl_FragColor=a;}",
						j: "attribute vec3 a0;attribute vec2 a1;uniform mat4 u115,u103,u116;varying vec2 vv0;void main(){gl_Position=u115*u103*u116*vec4(a0,1.),vv0=a1;}",
						c: ["u91"].concat(C, p),
						D: ["a0", "a1"],
						K: [3, 2],
						precision: "highp"
				...
				var E = !1,
					...
					D = {
						...
						h: function () {
							...
							F.s60 = {
								name: "_",
								a: "uniform sampler2D u1,u5;uniform float u6;varying vec2 vv0;const vec3 f=vec3(1.,1.,1.);void main(){gl_FragColor=vec4(mix(texture2D(u5,vv0).rgb,texture2D(u1,vv0).rgb,u6*f),1.);}",
								c: ["u1",
									"u5", "u6"
								],
								precision: "highp"
							...
							F.s61 = {
								name: "_",
								a: "uniform sampler2D u1,u5;uniform float u6;varying vec2 vv0;const vec4 f=vec4(1.,1.,1.,1.);void main(){gl_FragColor=mix(texture2D(u5,vv0),texture2D(u1,vv0),u6*f);}",
								c: ["u1", "u5", "u6"],
								precision: "highp"
							};
							F.s11 = {
								name: "_",
								a: "uniform sampler2D u1,u28;uniform vec2 u70;uniform float u71,u72;varying vec2 vv0;const vec4 f=vec4(1.,1.,1.,1.);void main(){vec4 b=texture2D(u28,vv0*u70),c=texture2D(u1,vv0*u70);float a=smoothstep(u71,0.,vv0.y);a+=smoothstep(1.-u71,1.,vv0.y),gl_FragColor=pow(mix(c,b,a*f),u72*f);}",
								c: ["u1", "u70", "u28", "u71", "u72"]
							};
							F.s62 = {
								name: "_",
								a: "uniform sampler2D u1,u28;uniform vec2 u70;uniform float u71,u72;varying vec2 vv0;const vec3 h=vec3(1.,1.,1.);vec4 i(vec3 d){vec3 b=d/65536.,a=clamp(ceil(log2(b)),-128.,127.);float c=max(max(a.r,a.g),a.b),f=exp2(c);vec3 g=clamp(b/f,0.,1.);return vec4(g,(c+128.)/256.);}void main(){vec2 a=vv0*u70;float c=floor(a.x),d=mod(c,2.);a.x=mod(a.x,1.),a.x=mix(a.x,1.-a.x,d);vec3 f=texture2D(u28,a).rgb,g=texture2D(u1,a).rgb;float b=smoothstep(u71,0.,vv0.y);b+=smoothstep(1.-u71,1.,vv0.y);vec3 j=mix(g,f,b*h);vec4 k=i(pow(j,u72*h));gl_FragColor=k;}",
								c: ["u1", "u70", "u28", "u71", "u72"],
								precision: "highp"
							};
							F.s63 = {
								name: "_",
								a: "uniform sampler2D u1;varying vec2 vv0;void main(){vec4 a=texture2D(u1,vv0);if(a.a<.5)discard;gl_FragColor=a;}",
								c: ["u1"],
								precision: "lowp"
							};
							F.s64 = {
								name: "_",
								a: "uniform sampler2D u1,u73;uniform vec2 u7;varying vec2 vv0;const vec2 f=vec2(-.9,.4),g=vec2(.4,.9),h=vec2(-.4,-.9),i=vec2(.9,-.4);void main(){vec2 a=vv0;vec3 b=texture2D(u1,a).rgb+texture2D(u1,a+u7*f).rgb+texture2D(u1,a+u7*g).rgb+texture2D(u1,a+u7*h).rgb+texture2D(u1,a+u7*i).rgb;gl_FragColor=vec4(b/5.,1.);}",
								c: ["u1", "u7"],
								precision: "lowp"
							};
							F.s65 = {
								name: "_",
								a: "uniform sampler2D u1,u73,u33;uniform vec2 u7,u74;varying vec2 vv0;const vec3 k=vec3(1.,1.,1.);const vec2 f=vec2(-.9,.4),g=vec2(.4,.9),h=vec2(-.4,-.9),i=vec2(.9,-.4);void main(){vec2 a=vv0;vec3 b=texture2D(u1,a).rgb+texture2D(u1,a+u7*f).rgb+texture2D(u1,a+u7*g).rgb+texture2D(u1,a+u7*h).rgb+texture2D(u1,a+u7*i).rgb;float c=texture2D(u33,vec2(.75,.5)).a,d=u74.x+pow(c,2.)*(u74.y-u74.x);vec3 j=mix(b/5.,texture2D(u73,a).rgb,d);gl_FragColor=vec4(j,1.);}",
								c: ["u1", "u73", "u7", "u33", "u74"],
								precision: "lowp"
							};
							F.s66 = {
								name: "_",
								a: "uniform sampler2D u1;uniform vec2 u7;varying vec2 vv0;const vec3 f=vec3(.299,.587,.114);const float m=.007813,n=.125,h=8.;void main(){vec2 x=vv0;vec3 o=texture2D(u1,vv0+vec2(-1.,-1.)*u7).xyz,p=texture2D(u1,vv0+vec2(1.,-1.)*u7).xyz,q=texture2D(u1,vv0+vec2(-1.,1.)*u7).xyz,r=texture2D(u1,vv0+vec2(1.,1.)*u7).xyz,s=texture2D(u1,vv0).xyz;float b=dot(o,f),c=dot(p,f),e=dot(q,f),g=dot(r,f),i=dot(s,f),t=min(i,min(min(b,c),min(e,g))),u=max(i,max(max(b,c),max(e,g)));vec2 a;a.x=-(b+c-(e+g)),a.y=b+e-(c+g);float v=max((b+c+e+g)*(.25*n),m),w=1./(min(abs(a.x),abs(a.y))+v);a=min(vec2(h,h),max(vec2(-h,-h),a*w))*u7;vec3 j=.5*(texture2D(u1,vv0+a*-.166667).rgb+texture2D(u1,vv0+a*.166667).rgb),k=j*.5+.25*(texture2D(u1,vv0+a*-.5).rgb+texture2D(u1,vv0+a*.5).rgb);float l=dot(k,f);gl_FragColor=l<t||l>u?vec4(j,1.):vec4(k,1.);}",
								c: ["u1", "u7"],
								precision: "lowp"
							};
							F.s42 = {
								name: "_",
								a: "uniform sampler2D u1;varying vec2 vv0;const vec3 f=vec3(0.,0.,0.);vec4 g(vec3 d){vec3 b=d/65536.,a=clamp(ceil(log2(b)),-128.,127.);float c=max(max(a.r,a.g),a.b),h=exp2(c);vec3 i=clamp(b/h,0.,1.);return vec4(i,(c+128.)/256.);}void main(){vec3 a=texture2D(u1,vv0).rgb;gl_FragColor=g(max(a,f));}",
								c: ["u1"],
								precision: "highp"
							};
							F.s67 = {
								name: "_",
								a: "uniform sampler2D u75,u76;uniform float u77,u78;varying vec2 vv0;void main(){vec3 a=texture2D(u76,vv0).rgb,b=texture2D(u75,vv0).rgb;gl_FragColor=vec4(b*u78+u77*a,1.);}",
								c: ["u75", "u76", "u77", "u78"],
								precision: "highp"
							};
							F.s68 = {
								name: "_",
								a: "uniform sampler2D u79,u80;uniform float u72;varying vec2 vv0;const int j=8888;const float e=3.141592;const vec2 k=vec2(0.,0.);const vec3 n=vec3(1.,1.,1.),o=vec3(0.,0.,0.);void main(){float p=e*(vv0.x*2.-1.),q=e/2.*(vv0.y*2.-1.),b,c,r,l,m;vec4 d;vec3 f=o;vec2 g=k,a=k;for(int h=0;h<j;h+=1)a.x=float(h),a.y=floor(a.x/64.),d=texture2D(u80,a/64.),b=e*d.r,c=2.*asin(sqrt(.25+d.g*.25)),l=p+c*cos(b),m=q+c*sin(b),g.x=.5+.5*l/e,g.y=.5+m/e,f+=pow(texture2D(u79,g).rgb,u72*n);f/=float(j),gl_FragColor=vec4(f,1.);}",
								c: ["u79", "u80", "u72"],
								precision: "lowp",
								za: [{
									search: "8888",
							...
							F.s69 = {
								name: "_",
								a: "uniform sampler2D u1;uniform vec2 u7;varying vec2 vv0;void main(){vec4 a=texture2D(u1,vv0);float b=.031496*texture2D(u1,vv0-3.*u7).a+.110236*texture2D(u1,vv0-2.*u7).a+.220472*texture2D(u1,vv0-u7).a+.275591*a.a+.220472*texture2D(u1,vv0+u7).a+.110236*texture2D(u1,vv0+2.*u7).a+.031496*texture2D(u1,vv0+3.*u7).a;gl_FragColor=vec4(a.rgb,4.*b);}",
								c: ["u1", "u7"],
								precision: "lowp"
							};
							F.s70 = {
								name: "_",
								a: "uniform sampler2D u1;varying vec2 vv0;const vec3 f=vec3(1.,1.,1.);void main(){vec4 a=texture2D(u1,vv0);float b=.3*pow(a.a,2.);gl_FragColor=vec4(a.rgb+b*f,1.);}",
								c: ["u1"],
								precision: "lowp"
							};
							F.s71 = {
								name: "_",
								a: "uniform sampler2D u1;uniform vec2 u7;varying vec2 vv0;void main(){vec4 a=.031496*texture2D(u1,vv0-3.*u7)+.110236*texture2D(u1,vv0-2.*u7)+.220472*texture2D(u1,vv0-u7)+.275591*texture2D(u1,vv0)+.220472*texture2D(u1,vv0+u7)+.110236*texture2D(u1,vv0+2.*u7)+.031496*texture2D(u1,vv0+3.*u7);gl_FragColor=a;}",
								c: ["u1", "u7"],
								precision: "lowp"
							};
							F.s72 = {
								name: "_",
								a: "uniform sampler2D u1;uniform vec2 u7;varying vec2 vv0;void main(){vec4 a=texture2D(u1,vv0-3.*u7)+texture2D(u1,vv0-2.*u7)+texture2D(u1,vv0-u7)+texture2D(u1,vv0)+texture2D(u1,vv0+u7)+texture2D(u1,vv0+2.*u7)+texture2D(u1,vv0+3.*u7);gl_FragColor=a/7.;}",
								c: ["u1", "u7"],
								precision: "lowp"
							};
							F.s73 = {
								name: "_",
								a: "uniform sampler2D u1;varying vec2 vv0;const vec4 g=vec4(0.,0.,0.,0.);const float e=256.;void main(){vec4 b=g;float c=0.;vec2 d;for(float a=0.;a<e;a+=1.)d=vec2((a+.5)/e,vv0.y),b+=texture2D(u1,d),c+=1.;gl_FragColor=b/c;}",
								c: ["u1"],
								precision: "highp"
							};
							F.s74 = {
								name: "_",
								a: "uniform sampler2D u1,u28;varying vec2 vv0;const vec4 h=vec4(1.,1.,1.,1.);const float f=0.,g=.3;void main(){vec4 b=texture2D(u28,vv0),c=texture2D(u1,vv0);float a=smoothstep(g,f,vv0.y);a+=smoothstep(1.-g,1.-f,vv0.y),gl_FragColor=mix(c,b,a*h);}",
								c: ["u1", "u28"],
								precision: "highp"
							};
							F.s75 = {
								name: "_",
								a: "uniform sampler2D u1,u28;varying vec2 vv0;const vec3 h=vec3(1.,1.,1.);const float f=0.,g=.3;vec4 i(vec3 d){vec3 b=d/65536.,a=clamp(ceil(log2(b)),-128.,127.);float c=max(max(a.r,a.g),a.b),j=exp2(c);vec3 k=clamp(b/j,0.,1.);return vec4(k,(c+128.)/256.);}void main(){vec3 b=texture2D(u28,vv0).rgb,c=texture2D(u1,vv0).rgb;float a=smoothstep(g,f,vv0.y);a+=smoothstep(1.-g,1.-f,vv0.y),gl_FragColor=i(mix(c,b,a*h));}",
								c: ["u1", "u28"],
								precision: "highp"
							};
							F.s76 = {
								name: "_",
								a: "uniform sampler2D u1,u81,u2,u82;uniform vec4 u83;uniform vec2 u84;uniform float u85,u86,u87;varying vec2 vv0;const vec2 g=vec2(1.,1.),h=vec2(.5,.5);const float e=3.141592;void main(){vec4 d=texture2D(u1,vv0),i=texture2D(u81,vec2(1.-vv0.x,vv0.y));float j=step(texture2D(u82,vec2(.25,.5)).r,1.);vec2 a=vv0*2.-g;float k=texture2D(u2,a*u84*.5+h).r,l=atan(a.x,a.y),m=-(mod(u85,2.*e)-e),b=mod(l-m+e,2.*e)-e,c=1.-smoothstep(0.,u86,b);c*=(sign(b)+1.)/2.;vec4 n=i+c*u83*k;gl_FragColor=mix(d,n,j*u87);}",
							...
							fa.Z && (F.s79 = {
								...
								name: "_",
								a: "uniform sampler2D u1;uniform vec2 u7;varying vec2 vv0;const vec2 f=vec2(-.9,.4),g=vec2(.4,.9),h=vec2(-.4,-.9),i=vec2(.9,-.4),j=vec2(-1.9,.9),k=vec2(.9,1.9),l=vec2(-.9,-1.9),m=vec2(1.9,-.9);void main(){vec2 a=vv0;vec4 b=texture2D(u1,a)+texture2D(u1,a+u7*f)+texture2D(u1,a+u7*g)+texture2D(u1,a+u7*h)+texture2D(u1,a+u7*i);b+=texture2D(u1,a+u7*j)+texture2D(u1,a+u7*k)+texture2D(u1,a+u7*l)+texture2D(u1,a+u7*m),gl_FragColor=b/9.;}",
								c: ["u1", "u7"],
								precision: "lowp"
							});
							F.s81 = {
							...
							F.s83 = {
								name: "_",
								a: "uniform sampler2D u1;uniform vec2 u7;varying vec2 vv0;void main(){vec4 a=.285714*texture2D(u1,vv0-u7)+.428571*texture2D(u1,vv0)+.285714*texture2D(u1,vv0+u7);gl_FragColor=a;}",
								c: ["u1", "u7"],
								precision: "lowp"
							};
							F.s84 = {
								name: "_",
								a: "uniform sampler2D u1,u121;varying vec2 vv0;void main(){gl_FragColor=texture2D(u1,vv0);}",
								j: "attribute vec3 a0;attribute vec2 a1;uniform mat4 u115,u103;varying vec2 vv0;void main(){vec4 a=u115*u103*vec4(a0,1.);gl_Position=a,vv0=a1;}",
								c: ["u115", "u103", "u1"],
								D: ["a0", "a1"],
								precision: "lowp"
							};
							if (Ca.T()) {
								p = "u33 u122 u123 u124 u125 u34 u91 u126 u127 u6 u128 u129 u60".split(" ").concat(P, z);
								Ca.Hg() || (F.s85 = {
									name: "_",
									j: "attribute vec2 a0;void main(){gl_Position=vec4(a0,0.,1.);}",
									a: "void main(){gl_FragData[0]=vec4(0.,0.,0.,0.),gl_FragData[1]=vec4(0.,0.,0.,0.),gl_FragData[2]=vec4(0.,0.,0.,0.),gl_FragData[3]=vec4(0.,0.,0.,0.);}",
									c: [],
									precision: "lowp",
									aa: !0
								});
								...
								F.s87color = {
									name: "_",
									a: "uniform vec4 u91,u6;uniform vec3 u126;uniform float u127;varying vec3 vv0,vv1;varying float vv2,vv3;void main(){float b=u6.x+u6.y*smoothstep(-u6.w,-u6.z,vv3),c=u127;vec4 a=u91;float d=floor(15.99*c),i=floor(15.99*a.b);a.b=(d+16.*i)/255.,gl_FragData[0]=vec4(vv0,vv2),gl_FragData[1]=vec4(normalize(vv1),b),gl_FragData[2]=vec4(u126,0.),gl_FragData[3]=a;}",
									j: "attribute vec3 a0,a2;uniform mat4 u115,u103,u116;varying vec3 vv0,vv1;varying float vv2,vv3;void main(){vec4 a=u116*vec4(a0,1.),b=u116*vec4(a2,0.);gl_Position=u115*u103*a,vv0=a.xyz,vv1=b.xyz,vv2=1.,vv3=a0.y;}",
									c: p,
									D: ["a0", "a2"],
									aa: !0
								};
								F.s87 = {
									name: "_",
									a: "uniform sampler2D u1;uniform vec4 u91,u6;uniform vec3 u126;uniform float u127,u55;varying vec3 vv0,vv1;varying vec2 vv2;varying float vv3,vv4;void main(){float c=u6.x+u6.y*smoothstep(-u6.w,-u6.z,vv4),d=u127;vec4 b=u91;float j=floor(15.99*d),k=floor(15.99*b.b);b.b=(j+16.*k)/255.;vec4 a=texture2D(u1,vv2);vec3 l=mix(u126,a.rgb,a.a);vec4 m=vec4(mix(a.rgb*u126,l,u55),a.a);gl_FragData[0]=vec4(vv0,vv3),gl_FragData[1]=vec4(normalize(vv1),c),gl_FragData[2]=m,gl_FragData[3]=b;}",
									j: "attribute vec3 a0,a2;attribute vec2 a1;uniform mat4 u115,u103,u116;varying vec3 vv0,vv1;varying vec2 vv2;varying float vv3,vv4;void main(){vec4 a=u116*vec4(a0,1.),b=u116*vec4(a2,0.);gl_Position=u115*u103*a,vv2=a1,vv0=a.xyz,vv1=b.xyz,vv3=1.,vv4=a0.y;}",
									c: p.concat(O),
									D: ["a0", "a2", "a1"],
									aa: !0
								};
								...
								F.s87NormalMap = {
									name: "_",
									a: "uniform sampler2D u1,u132;uniform vec4 u91,u6;uniform vec3 u133,u126;uniform float u127,u55;varying vec4 vv0;varying vec3 vv1,vv2;varying vec2 vv3;varying float vv4,vv5;const vec3 l=vec3(1.,1.,1.);void main(){float m=u6.x+u6.y*smoothstep(-u6.w,-u6.z,vv5);vec3 v=vec3(0.,0.,-1.),d=normalize(vv2),b=texture2D(u132,vv3).xyz;b=normalize(b*255./127.-1.007874*l);vec3 g=vv0.xyz,n=cross(d,g)*vv0.w;mat3 o=mat3(g,n,d);vec3 p=o*b;float q=u127;vec4 c=u91;float r=floor(15.99*q),s=floor(15.99*c.b);c.b=(r+16.*s)/255.;vec4 a=texture2D(u1,vv3);vec3 t=mix(u126,a.rgb,a.a);vec4 u=vec4(mix(a.rgb*u126,t,u55),a.a);gl_FragData[0]=vec4(vv1,vv4),gl_FragData[1]=vec4(p,m),gl_FragData[2]=u,gl_FragData[3]=c;}",
									j: "attribute vec4 a3;attribute vec3 a0,a2;attribute vec2 a1;uniform mat4 u115,u103,u116;varying vec4 vv0;varying vec3 vv1,vv2;varying vec2 vv3;varying float vv4,vv5;void main(){vec4 a=u116*vec4(a0,1.),b=u116*vec4(a2,0.);gl_Position=u115*u103*a,vv0=a3,vv3=a1,vv1=a.xyz,vv2=b.xyz,vv4=1.,vv5=a0.y;}",
									c: p.concat(O, v),
									D: ["a0", "a2", "a1", "a3"],
									aa: !0
								};
							...
							Ca.T() ? (D.f("s87", p), D.f("s87NormalMap", [{
								type: "1i",
								name: "u132",
								value: 1
							}].concat(p)), D.f("s87ParamsMap", [{
								type: "1i",
								name: "u56",
								value: 1
							}].concat(p)), D.f("s87NormalParamsMap", [{
								type: "1i",
								name: "u132",
								value: 1
							}, {
						...
						Pl: function (p) {
							return t(p, {
								name: "_",
								a: "const vec4 d=vec4(.5,.5,.5,.5);void main(){gl_FragData[0]=d,gl_FragData[1]=d,gl_FragData[2]=d,gl_FragData[3]=d;}",
								c: [],
								precision: "highp",
								aa: !0
							})
						...
						zh: function () {
							g.vertexAttribPointer(r.attributes.a2,
								3, g.FLOAT, !1, 32, 12)
						},
						Ah: function () {
						...
						El: function () {
							g.vertexAttribPointer(r.attributes.a0,
								3, g.FLOAT, !1, 32, 0);
							g.vertexAttribPointer(r.attributes.a2, 3, g.FLOAT, !1, 32, 12)
						},
						Fl: function () {
					...
					ba = {
						h: function (A, ka) {
							...
							Ca.T() ? (ka = [{
								...
								name: "u132",
								value: 2
							}], L.f("s87NNGLcolor", Q.concat(sa)), L.f("s87NNGLtexture", [].concat(ka, Q, sa)), L.f("s87NNGLtextureNormalMap", [].concat(ka, wa, Q, sa)), L.f("s87NNGLtextureParamsMap", [{
								type: "1i",
								name: "u56",
								value: 2
							}].concat(ka, Q, sa)), L.f("s87NNGLtextureNormalParamsMap", [{
								type: "1i",
								name: "u56",
								value: 3
							}].concat(ka, wa, Q, sa))) : (L.f("s91",
								Q.concat(sa)), L.f("s92", [{
								type: "1i",
								name: "u1",
								value: 0
							}].concat(Q)), L.f("s93", Q), L.f("s94", Q), L.f("s95", Q.concat([{
								type: "1i",
								name: "u132",
								value: 0
							}])), L.f("s96", Q), L.f("s97", Q.concat([{
								type: "1i",
								name: "u56",
								value: 0
							}])));
						...
						mk: function (A, ka) {
							void 0 !== fb.la && A.Pb && Ca.T() && (fb.la.h(A), ka.push(function (Q) {
								fb.la.Ve(Q);
								z = P = !0
							}), void 0 !== fb.pa && A.Bc && (fb.pa.h(A), ka.push(function (Q) {
								fb.pa.Ve(Q);
								F = !0
							})), void 0 !== fb.Vb && A.Id && (fb.Vb.h(A), r = H = !0));
							void 0 !== fb.Xa && (fb.Xa.h(A), C = fb.Xa.pk({
								width: A.bc,
								height: 2 * A.bc,
								depth: 1.5 * A.bc,
								Bj: -A.qe,
						...
						Rl: function (A, ka, Q, sa) {
							A && (Ka = A, P && fb.la.Mb(A),
								F && fb.pa.Mb(A), H && fb.Vb.Mb(A), f.forEach(function (wa) {
									wa.Mb(A)
								}));
							Q && (R = Q);
							sa && (qa = sa)
						...
						gb: function (A) {
							Ca.T() ? (L.f("s87NNGLcolor", A), L.f("s87NNGLtexture", A), L.f("s87NNGLtextureNormalMap", A), L.f("s87NNGLtextureParamsMap", A), L.f("s87NNGLtextureNormalParamsMap", A)) : (L.f("s91", A), L.f("s92", A), L.f("s93", A), L.f("s94", A), L.f("s95", A), L.f("s96", A), L.f("s97", A))
						},
						Ra: function (A, ka, Q) {
						...
						Qa: function (A) {
							...
							0 >= A ? (t = 0, 0 !== l && (l = 0, Kc.pl(), O && fb.Xa.toggle(!0), V && L.f("s76", [{
								type: "1f",
								name: "u87",
								value: 1
							}]))) : 1 <= A ? (t = 1, 1 !== l && (l = 1, Kc.Nh(!0)), ka()) : (t = A, 2 !== l && (Kc.Nh(!1), l = 2, ka()));
							L.f("s78", [{
								type: "1f",
								name: "u98",
								value: 1 - A
						...
						resize: function (A, ka, Q) {
							X && (A *= Q, ka *= Q, p.resize(A, ka), v.resize(A, ka), y = 1 / A, M = 1 / ka)
						},
						Se: function (A, ka) {
							var Q = A.I(),
								sa = A.U(),
							...
							H || F ? (fb.Vb.Te(Q, sa), Z && Z.remove(), Z = ha.instance(wa)) : Z = A;
							z && fb.la.Te(Q, sa);
						...
						pj: function (A) {
							...
							r && fb.Vb.R(ka, Z);
							S.bind(!1, !r);
							F && (r ? ka.b(0) : (Z.i(), L.set("s1"), pa.g(!0, !0)), fb.pa.R());
							Z.b(0);
							R.sb(2);
							fb.la.R();
							aa.i();
			...
			Wa = function () {
				...
				function t() {
					qa ? Ib.xj(B) : B.forEach(function (Q) {
						Q.sj()
					})
				}
				...
				var B = [],
					...
					ka = {
						h: function () {
							...
							g.clearDepth(1);
							fa.aj ? (g.enable(g.CULL_FACE), g.frontFace("CCW" === fa.bj ? g.CCW : g.CW), g.cullFace(g.BACK)) : g.disable(g.CULL_FACE);
							ka.Nf();
							var Q = {
								isPot: !1,
								isLinear: !1,
						...
						Nf: function () {
							Ca.T() ?
								E = gd.instance({}) : (E.ca = Lc.instance({
									Ob: fa.Ea ? !1 : "s88",
									isFloat: !1,
									Bb: !0,
									clearColor: [0, 0, 0, 0],
						...
						xf: function (Q) {
							B.push(Q);
							0 !== O.length && (O.forEach(function (sa) {
								sa(Q)
							}), O.splice(0, O.length))
						},
						ml: function (Q) {
							Q = B.indexOf(Q); - 1 !== Q && B.splice(Q, 1)
						},
						Pm: function (Q) {
							x.push(Q)
						},
						Gn: function (Q) {
							Q = x.indexOf(Q); - 1 !== Q && x.splice(Q, 1)
						},
						md: function (Q) {
							qa && (v = Q)
						},
						animate: function (Q) {
							!fa.Ea || qa && ya ? v && (M || z > fa.Xk && V ? (ia && clearTimeout(ia), ++z, window.cancelAnimationFrame(ka.animate), ia = setTimeout(function () {
								window.requestAnimationFrame(ka.animate)
							}, 16)) : (F &&
								FPSCounter.$n(), ka.nh(Q), ++z, qa || v && window.requestAnimationFrame(ka.animate))) : setTimeout(ka.animate, 100)
						},
						Sm: function (Q) {
							C.push(Q)
						},
						nh: function (Q) {
							if ((!fa.Ea || qa && ya) && p) {
								...
								if (Ca.T()) {
									...
									E.G();
									Y && g.depthMask(!1)
								} else qa && Ib.Gd(1), E.ca.set(!0, !0, !0), f(), E.ca.G(), Y && g.depthMask(!1), E.ec.set(!1, !Y, !1), n(), E.ec.G(), E.position.set(!0, !Y, !1), yc.R(), b(),
									E.position.G(), E.eb.set(!1, !Y, !1), l(), E.eb.G();
								...
								Lc.Ki();
								H.N();
								fa.hl ? (g.enable(g.BLEND), g.clearColor(0, 0, 0, 0), g.clear(g.COLOR_BUFFER_BIT), g.blendFunc(g.ONE, g.ONE_MINUS_SRC_ALPHA)) : g.disable(g.BLEND);
								qa || yc.Zd();
								E.position.b(0);
								E.eb.b(1);
								E.ca.b(2);
								...
								r.i();
								X.b(0);
								Ka && qa ? (L.set("s65"), D.b(1), Ib.Gd(2), pa.g(!1, !1), L.set("s1"), D.N(), r.b(0), pa.g(!1, !1)) : (L.set("s64"), pa.g(!1, !1), r.b(0));
								Za.W();
						...
						am: function () {
							fa.gj || v || (v = !0, ka.animate(Date.now()), y || ld.bm(), y || Kc.Ub(!1), S && clearTimeout(S),
								fa.Z && Mc.dd(), S = setTimeout(ka.ua, fa.Fi), y || Ca.jk(), y = !0)
						},
						Xn: function () {
							v && (V = v = !1, cancelAnimationFrame(ka.animate))
						},
						ua: function () {
							V || !y || M || fa.Qf || (V = M = !0, S && clearTimeout(S), Z && clearTimeout(Z), yc.ge().oh(), S = setTimeout(function () {
								Ca.lf(fa.$k);
								fa.Z && Mc.Uh();
								z = 0;
								w()
						...
						wake: function () {
							V && y && !M && (M = !0, V = !1, z = 0, yc.ge().oh(), S && clearTimeout(S), Z && clearTimeout(Z), S = setTimeout(function () {
								Ca.lf(1);
								fa.Z && Mc.dd();
								w()
							}, 16))
				...
				var f = null,
					...
					D = {
						h: function (p) {
							...
							void 0 === p.preserveDrawingBuffer && (p.preserveDrawingBuffer = !1);
							p.Pc && (w = !0);
							f = p.ma ? p.ma : document.getElementById(p.Wi);
							p.expand && D.expand();
							try {
								window.Jm = p.zb ? p.zb.Gj() : f.getContext("webgl", {
									antialias: !1,
									alpha: p.alpha,
									depth: !0,
								...
								r = p.zb ? p.zb.ea() : !1;
								H = !r;
								8 > g.getParameter(g.MAX_TEXTURE_IMAGE_UNITS) && D.Cc("too few texture image units");
								if (!eb.h()) return D.Cc("invalid config");
								fa.om && (G = g.getExtension("EXT_texture_filter_anisotropic")) && (E = !0);
								fa.pm && g.getExtension("WEBGL_compressed_texture_s3tc");
								H && (g.getExtension("OES_element_index_uint") || g.getExtension("MOZ_OES_element_index_uint") || g.getExtension("WEBKIT_OES_element_index_uint"));
								!r && fa.qm && (B = g.getExtension("EXT_sRGB")) && (O = !0);
								H ? (x = g.getExtension("WEBGL_draw_buffers")) && !fa.Pf && (C = !0) : C = 4 <= g.getParameter(g.MAX_DRAW_BUFFERS);
								if (C) {
									var v = D.ij();
									C = C && v
								}
							...
							f.addEventListener("contextmenu", function (y) {
								y.preventDefault();
								return !1
							}, !1);
							n = f.width;
						...
						fe: function (p) {
							var v = g,
								y = "";
							r || (v = x, y = "_WEBGL");
							return [v["COLOR_ATTACHMENT0" + y], v["COLOR_ATTACHMENT1" + y], v["COLOR_ATTACHMENT2" + y], v["COLOR_ATTACHMENT3" + y]].splice(0, p)
						},
						Jc: function (p) {
							return D.fe(4)[p]
						},
						ck: function () {
							return r ? g.SRGB ? g.SRGB :
								g.RGBA : O ? B.SRGB_ALPHA_EXT : g.RGBA
						},
						yk: function () {
							return E
						},
						...
						resize: function (p, v) {
							!f || p === n && v === l || (n = p, l = v, f.width = n, f.height = l, z && (yc.resize(), b()))
						},
						kf: function () {
							var p = [{
								type: "2f",
						...
						H: function () {
							D.If() && (ha.Sh(), Wa.H(), pa.H(), Lc.H(), fa.Z && Mc.H(), sc.H(), ld.H(), L.H(), ha.H(), g.flush(), g = null)
						}
					};
				return D
			}(),
							...
							z = {
								...
								Kf: function () {
									var F =
										l.wd,
										H = l.vd,
										r = Math.tan(.5 * l.hg * Math.PI / 180);
									G = [.5 / r, 0, 0, 0, 0, .5 * Ca.Ij() / r, 0, 0, 0, 0, -(H + F) / (H - F), -1, 0, 0, -2 * H * F / (H - F), 0];
						...
						var l = ha.instance({
							...
							G = {
								set: function (B,
									...
									E && f.bind(!1, E);
									l.i();
									B && (g.clearColor(n.clearColor[0], n.clearColor[1], n.clearColor[2], n.clearColor[3]), f.Md());
									x && f.Jf();
									t && L.set(w)
								},
								Eh: function (B) {
					...
					instance: function (f) {
						...
						var z = {
							...
							set: function () {
								...
								Za.reset();
								if (w) {
									if (g.checkFramebufferStatus(C) !== g.FRAMEBUFFER_COMPLETE) return !1;
									w = !1
								}
								g.viewport(0, 0, l, t);
								g.clearColor(0, 0, 0, 0);
							...
							remove: function () {
								...
								var F = b.indexOf(z); - 1 !== F && b.splice(F, 1)
							}
						};
						b.push(z);
						return z
					...
					instance: function (n) {
						...
						function t() {
							if (B) {
								...
								ha.Oi(1);
								pa.g(!0, !0);
								for (var p = fa.qk[Ca.V()], v = 0; v < p; ++v) P.i(), L.set("s71"), L.P("u7", 1 / G, 0), C.b(0), pa.g(!1, !1), C.i(), L.P("u7", 0, 2 / G), P.b(0), pa.g(!1, !1);
								z.N();
								L.set("s73");
								C.b(0);
								pa.g(!1, !1);
								...
								h: function () {
									function p() {
										2 === ++v && (O = ha.instance({
											...
											height: w / 2,
											v: 3
										}), Za.fa(), O.N(), L.set("s67"), L.A("u77", n.qb), L.A("u78", n.ob), x.b(0), E.b(1), pa.g(!0, !0), l())
									}
									var v = 0;
									w = fa.Hi[Ca.V()];
									r = Math.log2(w) - 1;
			...
			Kc = function () {
				...
				function f(Z) {
					-1 !== B && (X = r = 0, G(), b(fa.Gm * Z.deltaY / window.innerHeight), Z.preventDefault())
				}
				...
				function l(Z) {
					...
					Z.preventDefault();
					if (2 === B) {
						var R = Ac(Z.touches[0].pageX, Z.touches[0].pageY,
							Z.touches[1].pageX, Z.touches[1].pageY);
						b(-(F - R) * fa.dl);
						F = R
					} else R = aa ? Z.touches[0].clientX : Z.clientX, Z = aa ? Z.touches[0].clientY : Z.clientY, r = 2 * (R - P) * Math.PI / Ca.I(), X = 2 * (Z - z) * Math.PI / Ca.U(), 4 === B ? (ia[0] += r * fa.dh, ia[1] -= X * fa.dh, ia[0] = Math.min(Math.max(ia[0], -fa.gh), fa.gh), ia[1] = Math.min(Math.max(ia[1], -fa.hh), fa.hh), S.Ub()) : n(), P = R, z = Z
				}

				function t() {
					0 !== B && -1 !== B && (0 === r && 0 === X || 1 !== B || !V ? Wa.ua() : (G(), H = Date.now(), M = setInterval(S.Dk, D)), B = 0)
				}
				...
				function w(Z) {
					if (2 !== B && -1 !== B) {
						...
						Wa.wake();
						var aa = void 0 !==
							Z.changedTouches && Z.touches.length;
						Z.preventDefault();
						aa && 2 === Z.touches.length ? (B = 2, F = Ac(Z.touches[0].pageX, Z.touches[0].pageY, Z.touches[1].pageX, Z.touches[1].pageY)) : (B = aa || 2 !== Z.button ? 1 : 4, P = aa ? Z.touches[0].clientX : Z.clientX, z = aa ? Z.touches[0].clientY : Z.clientY);
						return !1
					}
				}
				...
				var B = 0,
					...
					S = {
						...
						Ub: function (Z) {
							x ? (E[0] = -v, E[1] = p, O[1].value = C / fa.Jd * y, Ib.gb(O)) : (Y[0] = p, Y[1] = v, Y[2] = y, Y[3] = ia[0], Y[4] = ia[1], ld.vl(Y, Z))
						},
						Dk: function () {
							if (1E-4 > r && 1E-4 > X || -1 === B) G(), X = r = 0, 0 === B && Wa.ua();
							var Z = Date.now(),
								aa = Z - H;
							H = Z;
							Z = Math.pow(V, aa / D);
					...
					instance: function (f) {
						function n(ba) {
							if (Aa) {
								...
								"undefined" !== typeof Gb && "string" === typeof ba.faces && (ba.faces = Gb(ba.faces));
								"undefined" !== typeof Ta && ("string" === typeof ba.vertices && (ba.vertices = Ta(ba.vertices)), ba.uvs && ba.uvs.length && ba.uvs.forEach(function (h, m) {
								...
								if (4 === A) {
									A = 6 * ka + 2;
									for (var Q = 4 * ka + 1, sa = Array(ba.metadata.faces * A),
											wa = 0; wa < ba.metadata.faces; ++wa)
										for (var za = 0; za < ka; ++za) sa[wa * A + 4 * za] = ba.faces[wa * Q + 5 * za], sa[wa * A + 4 * za + 1] = ba.faces[wa * Q + 5 * za + 1], sa[wa * A + 4 * za + 2] = ba.faces[wa * Q + 5 * za + 2], 0 === za && (sa[wa * A + 3] = ba.faces[wa * Q + 4]), sa[wa * A + 4 * za + 3 * ka + 1] = ba.faces[wa * Q + 5 * za], sa[wa * A + 4 * za + 3 * ka + 2] = ba.faces[wa * Q + 5 * za + 2], sa[wa * A + 4 * za + 3 * ka + 3] = ba.faces[wa * Q + 5 * za + 3], 0 === za && (sa[wa * A + 3 * ka + 4] = ba.faces[wa * Q + 4]);
									ba.faces = sa;
									ba.metadata.faces *= 2
								}
								P = Array(ba.metadata.vertices);
								for (A = 0; A < ba.metadata.vertices; ++A) P[A] = new Xa(ba.vertices[3 * A], ba.vertices[3 *
									A + 1], ba.vertices[3 * A + 2]), nc(y, P[A]);
								z = Array(ba.metadata.faces);
								ka = 3 * ka + 1;
								for (A = 0; A < ba.metadata.faces; ++A) z[A] = new Ec(ba.faces[ka * A], ba.faces[ka * A + 1], ba.faces[ka * A + 2]), z[A].Eb = ba.faces[ka * A + 3];
								S = 3 < P.length;
								Aa && (Aa.visible = S);
								Hc(P, z);
								F = Oc(P, z);
								if (ya) {
									...
									for (Q = 0; Q < ba.metadata.faces; ++Q)
										for (sa = 0; 3 > sa; ++sa)
											if (wa = ba.faces[7 * Q + sa], za = ba.faces[7 * Q + 1 + sa + 3], "undefined" === typeof ka[wa]) ka[wa] = [
												[wa, za]
											];
										...
										Mb = -1; - 1 === Qa ? (Mb = P.length, P.push(P[wa].clone()), F.push(F[wa].clone()), ka[wa].push([Mb, za]), ka[Mb] = [
											[Mb, za]
										]) : Mb = Qa;
										ba.faces[7 * Q + sa] = Mb;
										z[Q][A[sa]] = Mb
									...
									H = Array(P.length);
									for (A = 0; A < P.length; ++A) Q = ka[A][0][1], H[A] = new Cb(ba.uvs[0][2 * Q], ba.uvs[0][2 * Q + 1])
								}
								var a = Kb(y);
								f.lb && (P.forEach(function (h) {
									h.x -= a.x;
									h.z -= a.z;
									h.y -= y.min.y
								}), y.min.x -= a.x, y.max.x -= a.x, y.min.z -= a.z, y.max.z -= a.z, y.max.y -= y.min.y, y.min.y = 0);
								if (f.mb) {
									var c = fa.Ei / Math.max(y.max.x - y.min.x, y.max.y - y.min.y, y.max.z -
										y.min.z);
								...
								for (Q = 0; Q < P.length; ++Q) A[ka * Q] = P[Q].x, A[ka * Q + 1] = P[Q].y, A[ka * Q + 2] = P[Q].z, A[ka * Q + 3] = F[Q].x, A[ka * Q + 4] = F[Q].y, A[ka * Q + 5] = F[Q].z, ya && (A[ka * Q + 6] = H[Q].x, A[ka * Q + 7] = H[Q].y);
								z.sort(function (h, m) {
									return h.Eb - m.Eb
								});
								var d = new(65536 > 3 * z.length ? Uint16Array : Uint32Array)(3 * z.length),
									e = 0;
								z.forEach(function (h, m) {
									h.Eb === e ? Y[e].n += 3 : (Y.push({
										n: 3,
										offset: 3 * m
									}), ++e);
									d[3 * m] = h.va;
						...
						function t(ba, A) {
							R[A] && (L.set(R[A].Yj()), r.bind(!1), ya ? (L.Ia(), L.zh()) : (L.Pa(), L.Ah()), R[A].dc() && (L.kc(), D.Zb(!1), L.cd(), yc.ub()), R[A].nj(), R[A].Gc(), r.Da(ba.n, ba.offset))
						}

						function w(ba, A) {
							R[A] && (L.set(R[A].Zj()), r.bind(!1), ya ? (L.Ia(), L.zh()) : (L.Pa(), L.Ah()), R[A].dc() && (L.kc(), D.Zb(!1), L.cd(), yc.ub()), Aa.ac(), R[A].Gc(), r.Da(ba.n, ba.offset))
						}
						...
						function E(ba, A) {
							R[A] && (L.set(R[A].Vj()), Aa.ac(), R[A].Yf(), r.Da(ba.n, ba.offset))
						}

						function O(ba, A) {
							R[A] && (L.set(R[A].Wj()), R[A].dc() && (D.Zb(!1), L.cd(), yc.ub()), r.bind(!1), R[A].Vf(ya), r.Da(ba.n, ba.offset))
						}
						...
						var P = null,
							...
							Aa = {
								...
								Lf: function () {
									!p && ya && (z = z.filter(function (ba) {
										return null !== ba
									}), X = oc(P, F, H, z), D = pa.instance({
										ba: X,
										O: !1
									}), H = F = z = P = X = null, p = !0)
								},
								...
								wj: function (ba) {
									Ka && S && (r.bind(!1), ya ? L.Ia() : L.Pa(), ba ? Y.forEach(x) : Y.forEach(E))
								},
								Fc: function (ba) {
									S && (ba || Aa.ac(), r.bind(!1), ba || (L.Ia(), L.kc()), Ka && Y.forEach(B))
								},
								Gc: function (ba) {
								...
								We: function (ba, A) {
									function ka(wa, za) {
										wa && (wa.M = function () {
											Aa && ++sa === Q && (Ka = !0, qa && Aa.tb(Aa.Lf, 5), Aa.Xd(), A && Aa.tb(function () {
												A(Aa)
											}, 10))
										}, wa = sd.instance(wa), R[za] && R[za].H(), R[za] = wa, qa = qa || wa.dc())
									}
									aa = ba;
									Ka = !1;
									var Q = ba.length,
									...
									ba.forEach(function (wa, za) {
										"string" === typeof wa ? fc(-1 === wa.indexOf(".json") ? wa + ".json" : wa, function (Qa) {
												Qa.name = wa;
												ka(Qa, za, wa)
											}) :
											ka(wa, za, !1)
			...
			ld = function () {
				var b = null,
					...
					B = {
						h: function () {
							b = fa.vb ? new Worker("js/worker.php") : {
						...
						vl: function (x, E) {
							if (E || f && n) l[1] = x[0], l[2] = x[1], l[3] =
								x[2], l[4] = x[3], l[5] = x[4], b.postMessage(l)
						},
						Gl: function () {
				...
				var P = !1,
					...
					F = {
						...
						Xe: function (H) {
							...
							B.set(l[0], l[1], -n);
							E.set(f, b, 0, "XYZ");
							if (!1 === E instanceof bc) throw Error("JETHREE.Quaternion: .setFromEuler() now expects a Euler rotation rather than a Vector3 and order.");
							H = Math.cos(E.l / 2);
							var r = Math.cos(E.m / 2),
								...
								v = Math.sin(E.o / 2),
								y = E.order;
							"XYZ" === y ? (w.l = D * r * X + H * p * v, w.m = H * p * X - D * r * v, w.o = H * r * v + D * p * X, w.C = H * r * X - D * p * v) : "YXZ" === y ? (w.l = D * r * X + H * p * v, w.m = H * p * X - D * r * v, w.o = H * r * v - D * p * X, w.C = H * r * X + D *
								p * v) : "ZXY" === y ? (w.l = D * r * X - H * p * v, w.m = H * p * X + D * r * v, w.o = H * r * v + D * p * X, w.C = H * r * X - D * p * v) : "ZYX" === y ? (w.l = D * r * X - H * p * v, w.m = H * p * X + D * r * v, w.o = H * r * v - D * p * X, w.C = H * r * X + D * p * v) : "YZX" === y ? (w.l = D * r * X + H * p * v, w.m = H * p * X + D * r * v, w.o = H * r * v - D * p * X, w.C = H * r * X - D * p * v) : "XZY" === y && (w.l = D * r * X - H * p * v, w.m = H * p * X - D * r * v, w.o = H * r * v + D * p * X, w.C = H * r * X + D * p * v);
							B.y -= O;
							H = t.elements;
							v = w.x;
							var M = w.y,
		...
		var sd = function () {
				function b(G) {
					return "data:" === G.substring(0, 5) ? G : ("undefined" !==
						typeof K && K.X ? K : fa).X + fa.Pk + G
				}
				...
				return {
					...
					instance: function (G) {
						function B(S) {
							...
							var aa = 1,
								R = 0;
							(E = z.normalTexture && Ca.Vi() ? !0 : !1) && !r.Fa && (++aa, r.Fa = ha.instance({
							...
							(O = z.diffuseTexture && "" !== z.diffuseTexture ? !0 : !1) && !r.ca ? (++aa, r.ca = ha.instance({
							...
							F = [z.diffuseColor[0] / 255, z.diffuseColor[1] / 255, z.diffuseColor[2] / 255];
							(X = z.paramsTexture ? !0 : !1) && !r.fb && (z.paramsTexture === z.diffuseTexture ?
								r.fb = r.ca : (++aa, r.fb = ha.instance({
						...
						function x(S) {
							"number" === typeof z.alpha ? (C[0] = z.alpha, C[1] = 0, C[2] = 0, C[3] = 0) : (C[0] = z.alpha[0], C[1] = z.alpha[1] - z.alpha[0], C[2] = z.alpha[2], C[3] = z.alpha[3]);
							...
							S = z.M ? z.M.bind(null, S) :
								null;
							B(S);
							E || X || O ? E || X ? E && !X ? (p = "s87NormalMap", v = "s87NNGLtextureNormalMap") : !E && X ? (p = "s87ParamsMap", v = "s87NNGLtextureParamsMap") : (p = "s87NormalParamsMap", v = "s87NNGLtextureNormalParamsMap") : (p = "s87", v = "s87NNGLtexture") : (p = "s87color", v = "s87NNGLcolor");
							y = E ? "s95" : "s94";
							M = E ? "s89" : "s99";
							V = X ? "s97" : "s96";
							Y = X ? "s90" : "s100"
						...
						var E, O, C = [1, 0, 0, 0],
							...
							ia = {
								...
								Vf: function (S) {
									X && !E ? r.fb.b(t) : E && (O || l.b(0),
										r.Fa.b(t), X && r.fb.b(t + 1));
									X && L.oa("u57", D.Rg);
				...
				var b = 0,
					...
					R = {
						...
						R: function () {
							...
							w = t + (1 - p) * (1 - t);
							ha.W(5);
							if (ia && Y) ha.W(6), D.resize(E, O), L.set("s0"), L.fd("u1", 6), P.bind(!1, !0), D.i(), P.Md(), C.b(6), pa.g(!0, !0), C.resize(E, O), C.i(), D.b(6), pa.g(!1, !1), L.fd("u1", 0), ia = !1;
							else {
								g.enable(g.BLEND);
								...
								for (var Ka = !0, Aa = 0; Aa < H; ++Aa) 1 === Aa && (g.blendFunc(g.SRC_ALPHA, g.ONE), L.A("u107", qa)), L.A("u106", ya + Aa / H * (Math.PI / 2)), L.P("u105", (Math.random() - .5) / r, (Math.random() - .5) / X), pa.g(Ka, Ka), Ka = !1;
								g.disable(g.BLEND);
								L.set("s80");
								L.P("u7", 1 / E, 1 / O);
								D.i();
						...
						dd: function () {
							...
							!S && aa && (JESSMP.disable(), S = !0, M = Date.now(),
								y = p)
						},
						Uh: function () {
							S && aa && (V && (clearTimeout(V), V = !1), JESSMP.enable(), S = !1, M = Date.now(), y = p)
						},
						H: function () {
							C.remove();
							D.remove();
			...
			var b = {
				...
				C = {
					...
					Xh: function (P, z, F) {
						...
						t && (L.A("u120", b.Re), g.viewport(0, 0, H / 2, H / 2), C.bf(l, 0, 0, !1, 2 * b.bd * O, 2 * b.Qe, !0, [1, 1]), g.viewport(H / 2, 0, H / 2, H / 2), C.bf(l, 2 * Math.PI, 0, !1, 2 * b.bd * O, 2 * b.Qe, !1, [1, 1]));
						g.enable(g.BLEND);
						g.blendFunc(g.ONE, g.ONE);
						z && C.ii(z);
						L.set("s0");
						g.blendColor(0, 0, 0, 1 - F);
						g.blendFunc(g.CONSTANT_ALPHA,
			...
			var b = !1,
				...
				t = {
					ic: function () {
						Ca.T() && (L.ia("s103", {
							name: "_",
							j: "attribute vec3 a0;uniform sampler2D u33;uniform vec2 u34;uniform vec3 u122;const float j=1.,k=0.,l=0.,x=1.;const vec2 e=vec2(1.,1.);const vec3 m=vec3(1.,1.,1.);const vec2 y=vec2(-1.,1.);uniform mat4 u58;uniform vec3 u60,u64,u65,u66;uniform float u59,u67,u68,u61,u62,u63,u69;mat3 n(vec3 c){vec3 b=cos(c),a=sin(c);return mat3(b.y*b.z,a.z,a.y*b.z,b.y*a.z*b.x-a.x*a.y,-b.z*b.x,a.y*a.z*b.x+b.y*a.x,b.y*a.z*a.x+a.y*b.x,-a.x*b.z,a.y*a.z*a.x-b.y*b.x);}void main(){vec4 b=texture2D(u33,vec2(.25,.5));vec2 c=u67*e;vec3 a=u67*m;vec2 o=mix(b.a*u34,e,c),d=(2.*b.gb-e)*(1.-c);d.x*=-1.;vec3 f=mix(texture2D(u33,vec2(.75,.5)).rgb+vec3(u61,0.,0.),u64,a);mat3 p=n(f);vec3 q=mix(u122,u65,a);float r=mix(j,u68,u67);vec3 s=mix(u60,u66,a);float t=mix(u63,1.,u67);vec2 g=u62/o;vec3 h=a0;float u=max(0.,-a0.z-k)*l;h.x+=u*sign(a0.x)*(1.-u67);vec3 i=p*(h+q)*r+s;i.x+=u59*sin(f.y);vec2 v=g*t;vec3 w=vec3(d*v,-g)+i*vec3(1.,-1.,-1.);gl_Position=u58*(vec4(u69*e,e)*vec4(w,1.));}",
							a: "void main(){gl_FragData[0]=vec4(0.,0.,0.,0.),gl_FragData[1]=vec4(0.,0.,1.,1.),gl_FragData[2]=vec4(1.,0.,0.,0.),gl_FragData[3]=vec4(0.,.5,1.,0.);}",
					...
					pk: function (w) {
						for (var G = w.width / 2, B = w.height / 2, x = w.depth, E = w.Bj, O = w.height / 4, C = w.cj, P = 2 * C + 4, z = [], F = [], H = -G + w.La, r = -E - w.La, X = G - w.La, D = -E - w.La, p = 0; p < P; ++p) {
							var v = 0,
								y = 0;
							0 === p ? (v = -G, y = -E - x) : 1 <= p && p <= 1 + C ? (y = (p - 1) / C * Math.PI / 2, v = H - Math.cos(y) * w.La, y = r + Math.sin(y) * w.La) : p >= 2 + C && p <= 2 + 2 * C ? (y = (p - 2 - C) / C * Math.PI / 2, v = X + Math.sin(y) * w.La, y = D + Math.cos(y) * w.La) : p === P - 1 && (v = G, y = -E - x);
							z.push(v, B + O, y, v, -B + O, y);
							0 !== p && F.push(2 * p, 2 * p - 2, 2 * p - 1, 2 * p, 2 * p - 1, 2 * p + 1)
						}
						return t.instance({
							ba: z,
							O: F
			...
			var f = !1,
				...
				V = {
					...
					ic: function () {
						L.ia("s104", {
							name: "_",
							j: "attribute vec3 a0;uniform vec3 u122;uniform vec2 u147,u148;uniform float u123,u149,u150,u151;varying float vv0,vv1;void main(){vec3 a=(a0+u122)*u123;float b=atan(a.x,a.z-u149),d=2.*(a.y-u150)/(u151-u150)-1.;vv0=a0.y;float g=1.-u147.x*u147.x/(u147.y*u147.y),c=u147.x/sqrt(1.-g*pow(cos(b),2.));vec3 h=vec3(c*sin(b),a.y,c*cos(b)+u149);vv1=smoothstep(u148.x,u148.y,length(h-a)),gl_Position=vec4(b,d,0.,1.);}",
							a: "uniform float u152;uniform vec4 u6;varying float vv0,vv1;void main(){float a=u6.x+u6.y*smoothstep(-u6.w,-u6.z,vv0),b=min(a,1.)*u152;gl_FragColor=vec4(b,vv1,1.,1.);}",
					...
					h: function (Y) {
						if (f) {
							...
							if (n) V.yh(Y);
								...
								ia = .5 - .5 / Y.Qb[1];
								S = .5 + .5 / Y.Qb[1];
								for (var Z = b.dj + 1, aa = [], R = [], qa = new Float32Array(16 * b.Ac),
										ya = new Uint16Array(6 * (b.Ac - 1)), Ka = 0, Aa = 0, ba = 0, A = 0; A < b.Ac; ++A) {
									var ka = 2 * A / (b.Ac - 1) - 1;
									...
									qa[J + 14] = d;
									qa[J + 15] = e;
									0 !== A && (d = 2 * A, e = 6 * (A - 1), ya[e] = d, ya[e + 1] = d - 1, ya[e + 2] = d - 2, ya[e + 3] = d, ya[e + 4] = d + 1, ya[e + 5] = d - 1);
									e = Math.pow(.5 * (1 + Math.cos(Math.min(Math.max(Math.PI / b.tg[0] * Mb, -Math.PI), Math.PI))), b.Zk);
									a -= b.hk * e;
									d = b.tg[1] * e;
									Mb -= Q * b.Nc[0];
									c -= sa * b.Nc[1];
									...
									q -= sa * b.Nc[1];
									Q = .001 > e ? 2 : Z;
									for (sa = 0; sa < Q; ++sa) e = sa / (Q - 1), Qa = a * (1 - e) + m * e, I = b.Zg[0], I = Math.min(Math.max((Qa - I) / (b.Zg[1] - I), 0), 1), I = I * I * (3 - 2 * I), aa.push(Mb * (1 - e) + h * e, Qa, (c + d * Math.exp(400 * -Math.abs(ka) * Math.pow(e, 4))) * (1 - I) + q * I,
										wa, 0, za, 0, 0);
									ka = 0 === A ? 0 : 2 < Q && 2 < Aa ? Q - 1 : 1;
									for (wa = 1; wa <= ka; ++wa) za = Q > Aa ? Q - 2 : 0, R.push(Ka + wa + za, Ka + wa - 1, ba + wa - 1, ba + wa - 1, ba + wa + (Q < Aa ? Aa - 2 : 0), Ka + wa + za);
									Aa = Q;
									ba = Ka;
									Ka += Q
								}
					...
					zc: function () {
						...
						B.Ic();
						pa.g(!0, !0);
						for (var ia = 0; ia < b.Vc; ++ia) L.set("s106"), 0 !== ia && g.viewport(0, 0, b.Ua, Y), E.i(), G.b(0), L.P("u7", 1 / b.Ua, 0), pa.g(!1, !1), G.i(), E.b(0), L.P("u7", 0, 1 / Y), pa.g(!1, !1), b.fj && g.colorMask(0 === ia, 1 === ia, 2 === ia, !0), L.set("s1"), x.i(), G.b(0), g.viewport(0, ia * Y, b.Ua, Y), pa.g(!1, !1), b.fj && g.colorMask(!0, !0, !0, !0);
						return l = !0
					},
					R: function () {
						v.bind(!1, !1);
					...
					Ra: function (Y,
						...
						L.f("s105", [{
							type: "3f",
							name: "u122",
							value: [S[0] + H[0], S[1] + H[1] - b.jd[0], S[2] + H[2] + b.jd[1]]
						}]);
						P = Y;
						z = ia;
						F = S;
			...
			var b = !1,
				...
				E = {
					ic: function () {
						L.ia("s107", {
							name: "_",
							j: "attribute vec3 a0;uniform vec2 u156,u157;varying vec2 vv0;void main(){vec2 a=2.*(a0.xy-u157)/u156;gl_Position=vec4(a,0.,1.),vv0=a0.xy;}",
							a: "uniform vec2 u158;uniform float u159,u160,u161;varying vec2 vv0;void main(){vec2 b=vec2(sign(vv0.x)*.5*u159,u160),a=vv0-b,c=u161*a,d=(c-a)*u158;gl_FragColor=vec4(d,0.,1.);}",
		...
		fb.Vb = function () {
			...
			return {
				ic: function () {
					L.ia("s109", {
						name: "_",
						j: "attribute vec2 a0;uniform sampler2D u33;uniform vec2 u34,u164;uniform float u4;varying vec2 vv0;const vec2 f=vec2(1.,1.);void main(){vec4 a=texture2D(u33,vec2(.25,.5));vec2 b=a.a*u34,c=2.*a.gb-f,d=u164+a0*u4;gl_Position=vec4(c+b*d,0.,1.),vv0=vec2(.5,.5)+.5*a0;}",
						a: "uniform sampler2D u165;varying vec2 vv0;void main(){gl_FragColor=texture2D(u165,vv0);}",
						c: ["u33", "u165", "u34", "u164", "u4"],
						precision: "lowp"
					});
					L.ia("s110", {
						name: "_",
						a: "uniform sampler2D u2,u166,u167;varying vec2 vv0;const vec3 f=vec3(1.,1.,1.);void main(){float a=texture2D(u2,vv0).r;vec3 b=texture2D(u167,vv0).rgb,c=texture2D(u166,vv0).rgb;gl_FragColor=vec4(mix(b,c,a*f),1.);}",
						c: ["u2", "u167", "u166"],
						precision: "lowp"
					});
					f = !0
	...
	window.JeefitFallback = function () {
		function la() {
			window.CanvasListeners &&
				(CanvasListeners.switch_canvas(Kb), Pb.add_listener = CanvasListeners.add_listener, Pb.remove_listener = CanvasListeners.remove_listener, Pb.animate_swipe = CanvasListeners.animate_swipe, Pb.switch_modeInteractor = CanvasListeners.switch_mode, Pb.get_modeInteractor = CanvasListeners.get_mode, CanvasListeners.add_listener("move", function (xa, nb) {
					tc && (Hc += nb[0] * Sa.f, Hc = Math.min(Math.max(Hc, -Sa.a), Sa.a), Oc += nb[1] * Sa.f, Oc = Math.min(Math.max(Oc, -Sa.a), Sa.a), La())
				}, !0).add_listener("pinch", function (xa, nb) {
					tc && (fc += nb * Sa.o,
						fc = Math.min(Math.max(fc, Sa.g[0]), Sa.g[1]), La())
				}, !0))
		}
		...
		function La() {
			...
			nc.scale(fc, fc);
			nc.drawImage(Za, 0, 0, Za.width, Za.height, -fa[0] + Hc + Uc, -fa[1] + Oc + pa, ac, ha);
			nc.restore();
			return !0
		}
		...
		var Sa = {
			...
			Pb = {
				switch_toFallbackMode: function (xa, nb) {
					if (Gb || yb) return !1;
					yb = Gb = !0;
					if (Xa) return Xa.switch_deepSleep(!0), Rb.style.display = "none", Kb.style.display = "block", Rb.id = bc + "_old", Kb.id = bc, la(), window.JEEFITAPI =
						Pb, ec = Ta = qb = yb = !1, Oa = {}, xa && xa(), !0;
					Xa = Tb;
					var Qb = Xa.get_size();
				...
				resize: function (xa,
					...
					function Qb() {
						...
						if (yb) ob = setTimeout(Qb, Sa.h);
							...
							hb(xa, nb);
							qb && Ta && Pb.detect(Ta, tb, function () {
				...
				load_model: function (xa, nb, Qb, pc) {
					da = Qb;
					if (pc in Oa) tc = !0, xa = Oa[pc], Za = xa.u, Ic = xa.F, Ea = xa.G, g = xa.B, Ub = xa.A, Uc = xa.l, pa = xa.m, ac = xa.j, ha = xa.i, Va = xa.w, xb = xa.v, fa = xa.s, La(), Qb && Qb();
					else Pb["try"](pc, function (Ya) {
						var k = ua / Ma;
						Ya.width / Ya.height > k ? (Ub = Ya.height, g = Ya.height * k, Ic = Math.round((Ya.width - g) / 2), Ea = 0) : (g = Ya.width, Ub = Ya.width / k, Ic = 0, Ea = Math.round((Ya.height - Ub) / 2));
						1 > Da.width / Da.height ? (ha = ac = k = Va, Uc = Math.round((ua - k) / 2), pa = Math.round((Ma - k) / 2)) : (ha = ac = k = xb, Uc = Math.round((ua -
							k) / 2), pa = Math.round((Ma - k) / 2));
						Za = Ya;
						tc = !0;
						oc.width = Kb.width;
						oc.height = Kb.height;
						...
						k = oc.width;
						for (var Fc = oc.height, Gc = Ac.getImageData(0, 0, k, Fc).data, $b = 0, ma = [0, 0], Jb = 0; Jb < k; ++Jb)
							for (var K = 0; K < Fc; ++K) {
				...
				detect: function (xa, nb, Qb, pc) {
					if (yb) setTimeout(function () {
						...
						Qb && (Rc = Qb);
						pc && (Ec = pc);
						nb ? eb = xa : (eb && ic || (eb = document.createElement("canvas"), ic = eb.getContext("2d")), eb.width = xa.width, eb.height = xa.height, ic.save(), ic.translate(xa.width, 0), ic.scale(-1, 1), ic.drawImage(xa, 0, 0), ic.restore());
						...
						var Ya = 0,
							...
							Fc = 0,
							Gc = 0;
						xa.width >= xa.height ? (k = 0, Fc = Gc = xa.height, Ya = Math.round((xa.width - xa.height) / 2)) : (Ya = 0, Fc = Gc = xa.width, k = Math.round((xa.height -
							xa.width) / 2));
						xc.drawImage(eb, Ya, k, Fc, Gc, 0, 0, dc.width, dc.height);
						Pb.c(Sa.b, {
							action: "detect",
							imageData: dc.toDataURL("image/" + Sa.H)
						}, Pb.on_detect, function () {
							yb = !1
						});
						Ya = ua / Ma;
						var $b = -1;
						xa.width / xa.height > Ya ? (Gc = xa.height, Fc = Math.round(xa.height * Ya), Ya = Math.round((xa.width - Fc) / 2), k = 0, $b = Ma / xa.height) : (Fc = xa.width, Gc = Math.round(xa.width / Ya), Ya = 0, k = Math.round((xa.height - Gc) / 2), $b = ua / xa.width);
						Va = Math.round($b * xa.width);
						xb = Math.round($b * xa.height);
						$b = Math.min($b, 1);
						Da.width = Math.round($b * xa.width);
						Da.height =
							Math.round($b * xa.height);
						Ha.drawImage(eb, 0, 0, xa.width, xa.height, 0, 0, Da.width, Da.height);
						Cb.drawImage(eb, Ya, k, Fc, Gc, 0, 0, ua, Ma)
					} else xa.onload = function () {
				...
				on_detect: function (xa) {
					yb = !1;
					xa = JSON.parse(xa);
					xa.detectionId ? (Cc = xa.detectionId, qb = !0, qc.forEach(function (nb) {
						Pb.onLoad(nb)
					}), qc.splice(0, qc.length), Rc && Rc(Cc), Zb && ec && Pb.load_model(!1, !1, da, ec)) : Ec && Ec()
				},
				"try": function (xa, nb) {
					if (yb || !qb) return !1;
					yb = !0;
				...
				c: function (xa, nb, Qb, pc) {
					...
					Ya.open("POST", xa, !0);
					Ya.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
					pc && (Ya.onerror = pc);
	...
	! function (la, La) {
		"object" == typeof module && "object" == typeof module.exports ? module.exports = la.document ? La(la, !0) : function (hb) {
			if (!hb.document) throw Error("jQuery requires a window with a document");
			return La(hb)
		} : La(la)
		...
		function Sa(a) {
			var c = !!a && "length" in a && a.length,
				d = k.type(a);
			return "function" !==
				d && !k.isWindow(a) && ("array" === d || 0 === c || "number" == typeof c && 0 < c && c - 1 in a)
		}
		...
		function ib(a, c, d) {
			return k.isFunction(c) ? k.grep(a, function (e, h) {
				return !!c.call(e, h, e) !== d
			}) : c.nodeType ? k.grep(a, function (e) {
				return e === c !== d
			}) : "string" != typeof c ? k.grep(a, function (e) {
				return -1 < ic.call(c, e) !== d
			}) : pd.test(c) ? k.filter(c, a, d) : (c = k.filter(c, a), k.grep(a, function (e) {
		...
		function Ta(a) {
			var c = {};
			return k.each(a.match(Nb) || [], function (d, e) {
				c[e] = !0
			}), c
		}
		...
		function ob(a, c, d, e) {
			var h;
			try {
				a && k.isFunction(h = a.promise) ? h.call(a).done(c).fail(d) : a && k.isFunction(h = a.then) ? h.call(a, c, d) : c.apply(void 0, [a].slice(e))
			} catch (m) {
				d.apply(void 0, [m])
			}
		}
		...
		function Cc(a,
			...
			if (void 0 === d && 1 === a.nodeType)
				if (e = "data-" + c.replace(kd, "-$&").toLowerCase(), d = a.getAttribute(e), "string" == typeof d) {
					try {
						e = d, d = "true" === e || "false" !== e && ("null" === e ? null : e === +e + "" ? +e : zd.test(e) ? JSON.parse(e) : e)
					} catch (h) {}
					Ob.set(a, c, d)
				} else d = void 0;
			return d
		...
		function zc(a, c, d, e) {
			...
			if (T && T[3] !== ca) {
				...
				d = d || [];
				T = +J || 1;
				do m = m || ".5", T /= m, k.style(a, c, T + ca); while (m !== (m = I() / J) && 1 !== m && --q)
			}
			return d && (T = +T || +J || 0, h = d[1] ? T + (d[1] + 1) * d[2] : +d[2], e && (e.unit = ca, e.start = T, e.end = h)), h
		}
			...
			for (var d, e, h = [], m = 0, q = a.length; m < q; m++)
				if (e = a[m], e.style)
					if (d = e.style.display, c) {
						if ("none" === d && (h[m] = lb.get(e, "display") || null, h[m] || (e.style.display = "")), "" === e.style.display && Wa(e)) {
							d = m;
							var I = void 0;
							var J = e.ownerDocument;
							var ca = e.nodeName;
							J = (e = Ca[ca]) ? e : (I = J.body.appendChild(J.createElement(ca)), e = k.css(I, "display"),
								I.parentNode.removeChild(I), "none" === e && (e = "block"), Ca[ca] = e, e);
							h[d] = J
						}
		...
		function Zb(a, c) {
			var d;
			return d = "undefined" != typeof a.getElementsByTagName ? a.getElementsByTagName(c || "*") : "undefined" != typeof a.querySelectorAll ? a.querySelectorAll(c || "*") : [], void 0 === c || c && qb(a, c) ? k.merge([a], d) : d
		}

		function da(a, c) {
			for (var d = 0, e = a.length; d < e; d++) lb.set(a[d], "globalEval", !c || lb.get(c[d], "globalEval"))
		}

		function na(a, c, d, e, h) {
			for (var m, q, I, J, ca = c.createDocumentFragment(), T = [], va = 0, Ra = a.length; va < Ra; va++)
				if (m = a[va], m || 0 === m)
			...
			for (va = 0; m = T[va++];)
				if (e &&
					-1 < k.inArray(m, e)) h && h.push(m);
				else if (J = k.contains(m.ownerDocument, m), q = Zb(ca.appendChild(m), "script"), J && da(q), d)
		...
		function Da(a, c, d, e, h, m) {
			...
			if (null == e && null == h ? (h = d, e = d = void 0) : null == h && ("string" == typeof d ? (h = e, e = void 0) : (h = e, e = d, d = void 0)), !1 === h) h = Ma;
			else if (!h) return a;
			return 1 === m && (q = h, h = function (J) {
				return k().off(J), q.apply(this, arguments)
			}, h.guid = q.guid || (q.guid = k.guid++)), a.each(function () {
				k.event.add(this, c, h, e, d)
			})
		}

		function Ha(a, c) {
			return qb(a, "table") && qb(11 !== c.nodeType ? c : c.firstChild, "tr") ? k(">tbody", a)[0] || a : a
		}
		...
		function Vb(a, c) {
			...
			if (1 === c.nodeType) {
				...
				Ob.hasData(a) && (m = Ob.access(a), q = k.extend({}, m), Ob.set(c, q))
			}
		}
		...
		function Cb(a, c, d, e) {
			...
			var h, m, q, I = 0,
				...
				T = c[0],
				va = k.isFunction(T);
			if (va || 1 < J && "string" == typeof T && !Ya.checkClone && Kd.test(T)) return a.each(function (rb) {
				var Ua = a.eq(rb);
				va && (c[0] = T.call(this, rb, Ua.html()));
				Cb(Ua, c, d, e)
			});
			if (J && (h = na(c, a[0].ownerDocument, !1, a, e), m = h.firstChild,
					1 === h.childNodes.length && (h = m), m || e)) {
				m = k.map(Zb(h, "script"), Va);
				for (q = m.length; I < J; I++) {
					var Ra = h;
					I !== ca && (Ra = k.clone(Ra, !0, !0), q && k.merge(m, Zb(Ra, "script")));
					d.call(a[I], Ra, I)
				}
				if (q)
					for (h = m[m.length - 1].ownerDocument, k.map(m, xb), I = 0; I < q; I++) Ra = m[I], gd.test(Ra.type || "") && !lb.access(Ra, "globalEval") && k.contains(h, Ra) && (Ra.src ? k._evalUrl && k._evalUrl(Ra.src) : hb(Ra.textContent.replace(b, ""), h))
			}
			return a
		}

		function Xa(a, c, d) {
			for (var e = c ? k.filter(c, a) : a, h = 0; null != (c = e[h]); h++) d || 1 !== c.nodeType || k.cleanData(Zb(c)),
				c.parentNode && (d && k.contains(c.ownerDocument, c) && da(Zb(c, "script")), c.parentNode.removeChild(c));
			return a
		}

		function Rb(a, c, d) {
			var e, h, m, q, I = a.style;
			return d = d || l(a), d && (q = d.getPropertyValue(c) || d[c], "" !== q || k.contains(a.ownerDocument, a) || (q = k.style(a, c)), !Ya.pixelMarginRight() && n.test(q) && f.test(c) && (e = I.width, h = I.minWidth, m = I.maxWidth, I.minWidth = I.maxWidth = I.width = q, q = d.width, I.width = e, I.minWidth = h, I.maxWidth = m)), void 0 !== q ? q + "" : q
		}
		...
		function Kb(a, c, d) {
			return (a = L.exec(c)) ? Math.max(0, a[2] - (d || 0)) + (a[3] || "px") : c
		}

		function nc(a, c, d, e, h) {
			var m = 0;
			for (c = d === (e ? "border" : "content") ? 4 : "width" === c ? 1 : 0; 4 > c; c += 2) "margin" === d && (m += k.css(a, d + Ib[c], !0, h)), e ? ("content" === d && (m -= k.css(a, "padding" + Ib[c], !0, h)), "margin" !==
				d && (m -= k.css(a, "border" + Ib[c] + "Width", !0, h))) : (m += k.css(a, "padding" + Ib[c], !0, h), "padding" !== d && (m += k.css(a, "border" + Ib[c] + "Width", !0, h)));
			return m
		}
		...
		function tc(a, c, d) {
			...
			return n.test(m) ? m : (e = q && (Ya.boxSizingReliable() || m === a.style[c]), "auto" === m && (m = a["offset" + c[0].toUpperCase() + c.slice(1)]), m = parseFloat(m) || 0, m + nc(a, c, d || (q ? "border" : "content"), e, h) + "px")
		}
		...
		function Ec() {
			C &&
				(!1 === ha.hidden && la.requestAnimationFrame ? la.requestAnimationFrame(Ec) : la.setTimeout(Ec, k.fx.interval), k.fx.tick())
		}
		...
		function Hc(a, c, d) {
			for (var e, h = (oc.tweeners[c] || []).concat(oc.tweeners["*"]), m = 0, q = h.length; m < q; m++)
		...
		function Oc(a, c) {
			...
			for (d in a)
				if (e = k.camelCase(d),
					h = c[e], m = a[d], Array.isArray(m) && (h = m[1], m = a[d] = m[0]), d !== e && (a[e] = m, delete a[d]), q = k.cssHooks[e], q && "expand" in q)
					for (d in m = q.expand(m), delete a[e], m) d in a || (a[d] = m[d], c[d] = h);
				else c[e] = h
		}
		...
		function oc(a, c, d) {
			var e, h = 0,
				...
				I = function () {
					...
					for (var T = 1 - (ca / J.duration || 0), va = 0, Ra = J.tweens.length; va < Ra; va++) J.tweens[va].run(T);
					return q.notifyWith(a, [J, T, ca]), 1 > T && Ra ? ca :
				...
				J = q.promise({
					...
					createTween: function (ca, T) {
						ca = k.Tween(a, J.opts, ca, T, J.opts.specialEasing[ca] || J.opts.easing);
					...
					stop: function (ca) {
						...
						return ca ? (q.notifyWith(a, [J,
							1, 0
						]), q.resolveWith(a, [J, ca])) : q.rejectWith(a, [J, ca]), this
					}
				});
			d = J.props;
			for (Oc(d, J.opts.specialEasing); h < m; h++)
				if (c = oc.prefilters[h].call(J, a, d, J.opts)) return k.isFunction(c.stop) && (k._queueHooks(J.elem, J.opts.queue).stop = k.proxy(c.stop, c)), c;
			return k.map(d, Hc, J), k.isFunction(J.opts.start) && J.opts.start.call(a, J), J.progress(J.opts.progress).done(J.opts.done, J.opts.complete).fail(J.opts.fail).always(J.opts.always), k.fx.timer(k.extend(I, {
				elem: a,
				anim: J,
				queue: J.opts.queue
			})), J
		...
		function Ic(a, c, d, e) {
			var h;
			if (Array.isArray(c)) k.each(c, function (m, q) {
				d || V.test(a) ? e(a, q) : Ic(a + "[" + ("object" == typeof q && null != q ? m : "") + "]", q, d, e)
			});
			else if (d || "object" !== k.type(c)) e(a, c);
			else
				for (h in c) Ic(a + "[" + h + "]", c[h], d, e)
		}
		...
		function Ea(a) {
			return function (c, d) {
				...
				if (k.isFunction(d))
					for (; c = h[e++];) "+" === c[0] ? (c = c.slice(1) || "*", (a[c] = a[c] || []).unshift(d)) :
						(a[c] = a[c] || []).push(d)
			}
		}
		...
		function g(a, c, d, e) {
			function h(I) {
				var J;
				return m[I] = !0, k.each(a[I] || [], function (ca, T) {
					ca = T(c, d, e);
					return "string" != typeof ca || q || m[ca] ? q ? !(J = ca) : void 0 : (c.dataTypes.unshift(ca), h(ca), !1)
				}), J
			}
			var m = {},
				q = a === ba;
		...
		function Ub(a, c) {
			var d, e, h = k.ajaxSettings.flatOptions || {};
		...
		k.fn = k.prototype = {
			...
			get: function (a) {
				return null == a ? pa.call(this) : 0 > a ? this[a + this.length] : this[a]
			},
			...
			map: function (a) {
				return this.pushStack(k.map(this, function (c, d) {
					return a.call(c, d, c)
				}))
			},
			slice: function () {
			...
			for (m === q && (h = this, m--); m < q; m++)
				if (null != (a = arguments[m]))
					for (c in a) {
						var J = h[c];
						var ca = a[c];
						h !== ca && (I && ca && (k.isPlainObject(ca) || (d = Array.isArray(ca))) ? (d ? (d = !1, e = J && Array.isArray(J) ? J : []) : e = J && k.isPlainObject(J) ? J : {}, h[c] = k.extend(I, e, ca)) : void 0 !== ca && (h[c] = ca))
					}
			return h
		};
		k.extend({
			...
			isPlainObject: function (a) {
				var c, d;
				return !(!a || "[object Object]" !== xa.call(a)) && (!(c = Uc(a)) || (d = nb.call(c, "constructor") && c.constructor, "function" == typeof d && Qb.call(d) === pc))
			},
			...
			type: function (a) {
				return null == a ? a + "" : "object" ==
					typeof a || "function" == typeof a ? Pb[xa.call(a)] || "object" : typeof a
			},
			...
			makeArray: function (a, c) {
				c = c || [];
				return null != a && (Sa(Object(a)) ? k.merge(c, "string" == typeof a ? [a] : a) : eb.call(c, a)), c
			},
			inArray: function (a,
				c, d) {
			...
			grep: function (a, c, d) {
				for (var e = [], h = 0, m = a.length, q = !d; h < m; h++) d = !c(a[h], h), d !== q && e.push(a[h]);
				return e
			},
			map: function (a, c, d) {
				var e, h = 0,
				...
				if (Sa(a))
					for (e = a.length; h < e; h++) {
						...
						for (h in a) q = c(a[h], h, d), null != q && m.push(q);
				return Za.apply([], m)
			},
			guid: 1,
			proxy: function (a, c) {
				var d, e, h;
				if ("string" == typeof c && (d = a[c], c = a, a = d), k.isFunction(a)) return e =
					pa.call(arguments, 2), h = function () {
						return a.apply(c || this, e.concat(pa.call(arguments)))
					}, h.guid = a.guid = a.guid || k.guid++, h
			},
			now: Date.now,
			support: Ya
		});
		"function" == typeof Symbol && (k.fn[Symbol.iterator] = ac[Symbol.iterator]);
		k.each("Boolean Number String Function Array Date RegExp Object Error Symbol".split(" "), function (a, c) {
			Pb["[object " + c + "]"] = c.toLowerCase()
		});
		var Jb = function (a) {
			function c(u, N, U, W) {
				var ja, oa, Ja, db, Fa = N && N.ownerDocument,
					kb = N ? N.nodeType : 9;
				if (U = U || [], "string" != typeof u || !u || 1 !== kb && 9 !==
					kb && 11 !== kb) return U;
				if (!W && ((N ? N.ownerDocument || N : Hb) !== zb && hd(N), N = N || zb, ea)) {
					if (11 !== kb && (db = Yd.exec(u)))
						if (ja = db[1])
							if (9 === kb) {
								...
								if (Fa && (oa = Fa.getElementById(ja)) && wb(N, oa) && oa.id === ja) return U.push(oa), U
							}
					else {
						if (db[2]) return cd.apply(U, N.getElementsByTagName(u)), U;
						if ((ja = db[3]) && gc.getElementsByClassName && N.getElementsByClassName) return cd.apply(U, N.getElementsByClassName(ja)), U
					}
					if (!(!gc.qsa || Pc[u + " "] || ta && ta.test(u))) {
						if (1 !==
							...
							(Ja = N.getAttribute("id")) ? Ja = Ja.replace(Rd, Sd): N.setAttribute("id", Ja = jb);
							oa = Bd(u);
			...
			function d() {
				function u(U, W) {
					return N.push(U + " ") > Lb.cacheLength && delete u[N.shift()], u[U + " "] = W
				}
				var N = [];
				return u
			}
			...
			function q(u, N) {
				var U = N && u,
					W = U && 1 === u.nodeType && 1 === N.nodeType && u.sourceIndex - N.sourceIndex;
				if (W) return W;
				if (U)
					for (; U = U.nextSibling;)
						if (U === N) return -1;
			...
			function ca(u) {
				return function (N) {
					return "form" in N ? N.parentNode && !1 === N.disabled ? "label" in N ? "label" in N.parentNode ? N.parentNode.disabled === u : N.disabled === u : N.isDisabled === u || N.isDisabled !== !u && Zd(N) === u : N.disabled === u : "label" in N && N.disabled === u
				}
			}

			function T(u) {
				return e(function (N) {
					return N = +N, e(function (U, W) {
						for (var ja, oa = u([], U.length, N), Ja = oa.length; Ja--;) U[ja = oa[Ja]] && (U[ja] = !(W[ja] = U[ja]))
					})
				})
			}
			...
			function Ua(u, N, U) {
				var W = N.dir,
					...
					Ja = U && "parentNode" === oa,
					db = ad++;
				return N.first ? function (Fa, kb, mb) {
					for (; Fa = Fa[W];)
						if (1 === Fa.nodeType || Ja) return u(Fa, kb, mb);
					return !1
				} : function (Fa, kb, mb) {
					var gb, Wb, jc, hc = [Ab, db];
					if (mb)
						for (; Fa = Fa[W];) {
							...
							for (; Fa = Fa[W];)
								if (1 === Fa.nodeType || Ja)
									if (jc = Fa[jb] || (Fa[jb] = {}), Wb = jc[Fa.uniqueID] ||
										(jc[Fa.uniqueID] = {}), ja && ja === Fa.nodeName.toLowerCase()) Fa = Fa[W] || Fa;
									else {
										if ((gb = Wb[oa]) && gb[0] === Ab && gb[1] === db) return hc[2] = gb[2];
			...
			function ub(u) {
				return 1 < u.length ? function (N, U, W) {
					for (var ja = u.length; ja--;)
						if (!u[ja](N, U, W)) return !1;
					return !0
				} : u[0]
			}

			function Pa(u, N, U, W, ja) {
				for (var oa, Ja = [], db = 0, Fa = u.length, kb = null != N; db < Fa; db++)(oa = u[db]) && (U && !U(oa, W, ja) || (Ja.push(oa), kb && N.push(db)));
				return Ja
			}

			function wc(u, N, U, W, ja, oa) {
				return W && !W[jb] && (W = wc(W)),
					ja && !ja[jb] && (ja = wc(ja, oa)), e(function (Ja, db, Fa, kb) {
						var mb, gb = [],
							Wb = [],
							jc = db.length,
							hc;
						if (!(hc = Ja)) {
							hc = N || "*";
							for (var Bb = Fa.nodeType ? [Fa] : Fa, Sc = [], Bc = 0, Qc = Bb.length; Bc < Qc; Bc++) c(hc, Bb[Bc], Sc);
							hc = Sc
						}
						...
						if (U && U(hc, Bb, Fa, kb), W) {
							var uc = Pa(Bb, Wb);
							W(uc, [], Fa, kb);
							for (Fa = uc.length; Fa--;)(mb = uc[Fa]) && (Bb[Wb[Fa]] = !(hc[Wb[Fa]] = mb))
						}
						if (Ja) {
							if (ja || u) {
								if (ja) {
									uc = [];
									for (Fa = Bb.length; Fa--;)(mb = Bb[Fa]) && uc.push(hc[Fa] = mb);
									ja(null, Bb = [], uc, kb)
								}
								for (Fa = Bb.length; Fa--;)(mb =
									Bb[Fa]) && -1 < (uc = ja ? id(Ja, mb) : gb[Fa]) && (Ja[uc] = !(db[uc] = mb))
							}
			...
			function ra(u) {
				...
				for (var Ja = ja ? 1 : 0, db = Ua(function (mb) {
						return mb === N
					}, oa, !0), Fa = Ua(function (mb) {
						return -1 < id(N, mb)
					}, oa, !0), kb = [function (mb, gb, Wb) {
						mb = !ja && (Wb || gb !== Yb) || ((N = gb).nodeType ? db(mb, gb, Wb) : Fa(mb, gb, Wb));
						return N = null, mb
					}]; Ja < W; Ja++)
					if (oa = Lb.relative[u[Ja].type]) kb = [Ua(ub(kb),
						oa)];
					else {
						if (oa = Lb.filter[u[Ja].type].apply(null, u[Ja].matches), oa[jb]) {
							for (U = ++Ja; U < W && !Lb.relative[u[U].type]; U++);
							return wc(1 < Ja && ub(kb), 1 < Ja && rb(u.slice(0, Ja - 1).concat({
								value: " " === u[Ja - 2].type ? "*" : ""
							})).replace(Cd, "$1"), oa, Ja < U && ra(u.slice(Ja, U)), U < W && ra(u = u.slice(U)), U < W && rb(u))
						}
						kb.push(oa)
					}
				return ub(kb)
				...
				var U = 0 < N.length,
					...
					ja = function (oa, Ja, db, Fa, kb) {
						var mb, gb, Wb = 0,
							...
							Qc = Ab += null == Sc ? 1 : Math.random() || .1,
							uc = Bc.length;
						for (kb && (Yb = Ja === zb || Ja || kb); jc !== uc && null != (mb = Bc[jc]); jc++) {
							if (W && mb) {
								var Md = 0;
								for (Ja || mb.ownerDocument === zb || (hd(mb), db = !ea); gb = u[Md++];)
									if (gb(mb, Ja || zb, db)) {
										Fa.push(mb);
										break
									}
						...
						if (Wb += jc, U && jc !== Wb) {
							...
							cd.apply(Fa, Bb);
							kb && !oa && 0 < Bb.length && 1 < Wb + N.length && c.uniqueSort(Fa)
						}
						return kb && (Ab = Qc, Yb = Sc), hc
					};
				return U ? e(ja) : ja
			}
			var vb, $a, Na, Yb, sb, lc,
				zb, ab, ea, ta, Ga, cb, wb, jb = "sizzle" + 1 * new Date,
				Hb = a.document,
				Ab = 0,
				ad = 0,
				Dc = d(),
				...
				Xc = function (u, N, U) {
					u = "0x" + N - 65536;
					return u !== u || U ? N : 0 > u ? String.fromCharCode(u + 65536) : String.fromCharCode(u >> 10 | 55296, 1023 & u | 56320)
				},
				Rd = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g,
				Sd = function (u, N) {
					return N ? "\x00" === u ? "\ufffd" : u.slice(0, -1) + "\\" + u.charCodeAt(u.length - 1).toString(16) + " " : "\\" + u
				},
				Ud = function () {
					hd()
				},
			...
			try {
				cd.apply(Vc = Td.call(Hb.childNodes), Hb.childNodes), Vc[Hb.childNodes.length].nodeType
			} catch (u) {
				cd = {
					apply: Vc.length ? function (N, U) {
			...
			var hd = c.setDocument = function (u) {
				...
				return u !== zb && 9 === u.nodeType && u.documentElement ? (zb = u, ab = zb.documentElement, ea = !je(zb), Hb !== zb && (U = zb.defaultView) && U.top !== U && (U.addEventListener ? U.addEventListener("unload", Ud, !1) : U.attachEvent && U.attachEvent("onunload", Ud)), gc.attributes = h(function (W) {
						return W.className = "i", !W.getAttribute("className")
					}), gc.getElementsByTagName = h(function (W) {
						return W.appendChild(zb.createComment("")), !W.getElementsByTagName("*").length
					}), gc.getElementsByClassName = td.test(zb.getElementsByClassName), gc.getById = h(function (W) {
						return ab.appendChild(W).id = jb, !zb.getElementsByName || !zb.getElementsByName(jb).length
					}), gc.getById ? (Lb.filter.ID = function (W) {
						var ja = W.replace(Wc, Xc);
						return function (oa) {
							return oa.getAttribute("id") === ja
						}
					}, Lb.find.ID = function (W, ja) {
						if ("undefined" != typeof ja.getElementById && ea) return (W = ja.getElementById(W)) ? [W] : []
					}) : (Lb.filter.ID = function (W) {
						var ja = W.replace(Wc, Xc);
						return function (oa) {
							return (oa =
								"undefined" != typeof oa.getAttributeNode && oa.getAttributeNode("id")) && oa.value === ja
						}
					}, Lb.find.ID = function (W, ja) {
						if ("undefined" != typeof ja.getElementById && ea) {
							var oa, Ja = ja.getElementById(W);
							if (Ja) {
								if (oa = Ja.getAttributeNode("id"), oa && oa.value === W) return [Ja];
					...
					}), Lb.find.TAG = gc.getElementsByTagName ? function (W, ja) {
						return "undefined" != typeof ja.getElementsByTagName ? ja.getElementsByTagName(W) :
							gc.qsa ? ja.querySelectorAll(W) : void 0
					} : function (W, ja) {
						var oa = [],
							Ja = 0;
						...
						return ja
					}, Lb.find.CLASS = gc.getElementsByClassName && function (W, ja) {
						if ("undefined" != typeof ja.getElementsByClassName && ea) return ja.getElementsByClassName(W)
					}, Ga = [], ta = [], (gc.qsa = td.test(zb.querySelectorAll)) && (h(function (W) {
						ab.appendChild(W).innerHTML = "<a id='" + jb + "'></a><select id='" + jb + "-\r\\' msallowcapture=''><option selected=''></option></select>";
						W.querySelectorAll("[msallowcapture^='']").length && ta.push("[*^$]=[\\x20\\t\\r\\n\\f]*(?:''|\"\")");
						W.querySelectorAll("[selected]").length || ta.push("\\[[\\x20\\t\\r\\n\\f]*(?:value|checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped)");
						W.querySelectorAll("[id~=" + jb + "-]").length || ta.push("~=");
						W.querySelectorAll(":checked").length || ta.push(":checked");
						W.querySelectorAll("a#" + jb + "+*").length || ta.push(".#.+[+~]")
					}), h(function (W) {
						W.innerHTML =
						...
						W.querySelectorAll("[name=d]").length && ta.push("name[\\x20\\t\\r\\n\\f]*[*^$|!~]?=");
						2 !== W.querySelectorAll(":enabled").length && ta.push(":enabled", ":disabled");
						ab.appendChild(W).disabled = !0;
						2 !== W.querySelectorAll(":disabled").length && ta.push(":enabled", ":disabled");
						W.querySelectorAll("*,:x");
						ta.push(",.*:")
					})),
					(gc.matchesSelector = td.test(cb = ab.matches || ab.webkitMatchesSelector || ab.mozMatchesSelector || ab.oMatchesSelector || ab.msMatchesSelector)) && h(function (W) {
						gc.disconnectedMatch = cb.call(W, "*");
						cb.call(W, "[s!='']:x");
						Ga.push("!=", ":((?:\\\\.|[\\w-]|[^\x00-\\xa0])+)(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|\\[[\\x20\\t\\r\\n\\f]*((?:\\\\.|[\\w-]|[^\x00-\\xa0])+)(?:[\\x20\\t\\r\\n\\f]*([*^$|!~]?=)[\\x20\\t\\r\\n\\f]*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|((?:\\\\.|[\\w-]|[^\x00-\\xa0])+))|)[\\x20\\t\\r\\n\\f]*\\])*)|.*)\\)|)")
					}),
					ta = ta.length && new RegExp(ta.join("|")), Ga = Ga.length && new RegExp(Ga.join("|")), N = td.test(ab.compareDocumentPosition), wb = N || td.test(ab.contains) ? function (W, ja) {
						var oa = 9 === W.nodeType ? W.documentElement : W;
						ja = ja && ja.parentNode;
						return W === ja || !(!ja || 1 !== ja.nodeType || !(oa.contains ? oa.contains(ja) : W.compareDocumentPosition && 16 & W.compareDocumentPosition(ja)))
					} : function (W, ja) {
						if (ja)
							for (; ja = ja.parentNode;)
								if (ja === W) return !0;
						return !1
					}, Nc = N ? function (W, ja) {
						if (W === ja) return lc = !0, 0;
						var oa = !W.compareDocumentPosition -
							!ja.compareDocumentPosition;
						return oa ? oa : (oa = (W.ownerDocument || W) === (ja.ownerDocument || ja) ? W.compareDocumentPosition(ja) : 1, 1 & oa || !gc.sortDetached && ja.compareDocumentPosition(W) === oa ? W === zb || W.ownerDocument === Hb && wb(Hb, W) ? -1 : ja === zb || ja.ownerDocument === Hb && wb(Hb, ja) ? 1 : sb ? id(sb, W) - id(sb, ja) : 0 : 4 & oa ? -1 : 1)
					} : function (W, ja) {
						if (W === ja) return lc = !0, 0;
						var oa = 0,
							Ja = W.parentNode,
							...
							Fa = [W],
							kb = [ja];
						if (!Ja || !db) return W === zb ? -1 : ja === zb ? 1 : Ja ? -1 : db ? 1 : sb ? id(sb, W) - id(sb, ja) : 0;
						if (Ja === db) return q(W, ja);
						for (; W = W.parentNode;) Fa.unshift(W);
						for (W = ja; W = W.parentNode;) kb.unshift(W);
						for (; Fa[oa] === kb[oa];) oa++;
						return oa ? q(Fa[oa], kb[oa]) : Fa[oa] === Hb ? -1 : kb[oa] === Hb ? 1 : 0
					}, zb) : zb
			};
			...
			c.matchesSelector = function (u, N) {
				if ((u.ownerDocument || u) !== zb && hd(u), N = N.replace(ee, "='$1']"), !(!gc.matchesSelector || !ea || Pc[N + " "] || Ga && Ga.test(N) || ta && ta.test(N))) try {
					var U = cb.call(u, N);
					if (U || gc.disconnectedMatch || u.document && 11 !== u.document.nodeType) return U
				} catch (W) {}
				return 0 < c(N,
					zb, null, [u]).length
			};
			...
			c.attr = function (u, N) {
				...
				U = U && dd.call(Lb.attrHandle, N.toLowerCase()) ? U(u, N, !ea) : void 0;
				return void 0 !== U ? U : gc.attributes || !ea ? u.getAttribute(N) : (U = u.getAttributeNode(N)) && U.specified ? U.value : null
			};
			c.escape = function (u) {
			...
			c.uniqueSort = function (u) {
				var N,
					...
					W = 0,
					ja = 0;
				if (lc = !gc.detectDuplicates, sb = !gc.sortStable && u.slice(0), u.sort(Nc), lc) {
			...
			var Lb = c.selectors = {
				...
				preFilter: {
					ATTR: function (u) {
						return u[1] = u[1].replace(Wc, Xc), u[3] = (u[3] || u[4] || u[5] || "").replace(Wc, Xc), "~=" === u[2] && (u[3] = " " + u[3] + " "), u.slice(0, 4)
					},
					CHILD: function (u) {
						return u[1] = u[1].toLowerCase(), "nth" === u[1].slice(0, 3) ? (u[3] || c.error(u[0]), u[4] = +(u[4] ? u[5] + (u[6] || 1) : 2 * ("even" === u[3] || "odd" === u[3])), u[5] = +(u[7] + u[8] || "odd" === u[3])) : u[3] && c.error(u[0]), u
					},
					PSEUDO: function (u) {
						var N,
							U = !u[6] && u[2];
						return Dd.CHILD.test(u[0]) ? null : (u[3] ? u[2] = u[4] || u[5] || "" : U && fe.test(U) && (N = Bd(U, !0)) && (N = U.indexOf(")", U.length - N) - U.length) && (u[0] = u[0].slice(0, N), u[2] = U.slice(0, N)), u.slice(0, 3))
					}
				},
				filter: {
					TAG: function (u) {
					...
					CLASS: function (u) {
						...
						return N || (N = new RegExp("(^|[\\x20\\t\\r\\n\\f])" + u + "([\\x20\\t\\r\\n\\f]|$)"), Dc(u, function (U) {
							return N.test("string" ==
								typeof U.className && U.className || "undefined" != typeof U.getAttribute && U.getAttribute("class") || "")
						}))
					},
					ATTR: function (u, N, U) {
						return function (W) {
							W = c.attr(W, u);
							return null == W ? "!=" === N : !N || (W += "", "=" === N ? W === U : "!=" === N ? W !== U : "^=" === N ? U && 0 === W.indexOf(U) : "*=" === N ? U && -1 < W.indexOf(U) : "$=" === N ? U && W.slice(-U.length) === U : "~=" === N ? -1 < (" " + W.replace(be, " ") + " ").indexOf(U) : "|=" === N && (W === U || W.slice(0, U.length + 1) === U + "-"))
						}
					},
						...
						return 1 === W && 0 === ja ? function (Fa) {
							...
							if (jc) {
								if (oa) {
									for (; kb;) {
										for (gb = Fa; gb = gb[kb];)
											if (db ? gb.nodeName.toLowerCase() === hc : 1 === gb.nodeType) return !1;
										var Sc = kb = "only" === u && !Sc && "nextSibling"
									}
									return !0
								}
								if (Sc = [Ja ? jc.firstChild : jc.lastChild], Ja && mb) {
									gb = jc;
									var Bc = gb[jb] || (gb[jb] = {});
									var Qc = Bc[gb.uniqueID] || (Bc[gb.uniqueID] = {});
									var uc = Qc[u] || [];
									Bb = (Wb = uc[0] === Ab && uc[1]) && uc[2];
									for (gb = Wb && jc.childNodes[Wb]; gb = ++Wb && gb && gb[kb] || (Bb = Wb = 0) || Sc.pop();)
										if (1 === gb.nodeType && ++Bb && gb === Fa) {
											Qc[u] = [Ab, Wb, Bb];
											break
										}
								} else if (mb && (gb = Fa, Bc = gb[jb] || (gb[jb] = {}), Qc = Bc[gb.uniqueID] || (Bc[gb.uniqueID] = {}), uc = Qc[u] || [], Wb = uc[0] === Ab && uc[1], Bb = Wb), !1 === Bb)
									for (;
										(gb = ++Wb && gb && gb[kb] || (Bb = Wb = 0) || Sc.pop()) && ((db ? gb.nodeName.toLowerCase() !== hc : 1 !== gb.nodeType) || !++Bb || (mb && (Bc = gb[jb] || (gb[jb] = {}), Qc = Bc[gb.uniqueID] || (Bc[gb.uniqueID] = {}), Qc[u] = [Ab, Bb]), gb !== Fa)););
								return Bb -= ja, Bb === W || 0 === Bb % W && 0 <= Bb / W
							}
						}
					},
					PSEUDO: function (u, N) {
						var U, W = Lb.pseudos[u] || Lb.setFilters[u.toLowerCase()] || c.error("unsupported pseudo: " + u);
						return W[jb] ? W(N) : 1 < W.length ? (U = [u, u, "", N], Lb.setFilters.hasOwnProperty(u.toLowerCase()) ? e(function (ja, oa) {
							for (var Ja, db = W(ja, N), Fa = db.length; Fa--;) Ja = id(ja, db[Fa]), ja[Ja] = !(oa[Ja] = db[Fa])
						}) : function (ja) {
							return W(ja, 0, U)
						}) : W
					}
				...
				pseudos: {
					not: e(function (u) {
						var N = [],
							U = [],
							W = $a(u.replace(Cd, "$1"));
						return W[jb] ? e(function (ja, oa, Ja, db) {
							var Fa;
							Ja = W(ja, null,
								db, []);
							for (db = ja.length; db--;)(Fa = Ja[db]) && (ja[db] = !(oa[db] = Fa))
						}) : function (ja, oa, Ja) {
							return N[0] = ja, W(N, null, Ja, U), N[0] = null, !U.pop()
						}
					}),
					has: e(function (u) {
						return function (N) {
					...
					contains: e(function (u) {
						return u = u.replace(Wc, Xc),
							function (N) {
								return -1 < (N.textContent || N.innerText || Nd(N)).indexOf(u)
							}
					}),
					lang: e(function (u) {
						return ge.test(u || "") || c.error("unsupported lang: " + u), u = u.replace(Wc, Xc).toLowerCase(),
							function (N) {
								var U;
								do
									if (U = ea ? N.lang : N.getAttribute("xml:lang") || N.getAttribute("lang")) return U =
										U.toLowerCase(), U === u || 0 === U.indexOf(u + "-"); while ((N = N.parentNode) && 1 === N.nodeType);
								return !1
							}
					}),
					target: function (u) {
					...
					focus: function (u) {
						return u === zb.activeElement && (!zb.hasFocus || zb.hasFocus()) && !!(u.type || u.href || ~u.tabIndex)
					},
					enabled: ca(!1),
					disabled: ca(!0),
					checked: function (u) {
						var N = u.nodeName.toLowerCase();
						return "input" === N && !!u.checked || "option" === N && !!u.selected
					},
					selected: function (u) {
						return u.parentNode &&
							u.parentNode.selectedIndex, !0 === u.selected
					},
					empty: function (u) {
					...
					text: function (u) {
						var N;
						return "input" === u.nodeName.toLowerCase() && "text" === u.type && (null == (N = u.getAttribute("type")) || "text" ===
							N.toLowerCase())
					},
					first: T(function () {
						return [0]
			...
			var Bd = c.tokenize = function (u, N) {
				...
				for (Ja = Lb.preFilter; oa;) {
					Fa && !(U = ce.exec(oa)) || (U && (oa = oa.slice(U[0].length) || oa), db.push(W = []));
					var Fa = !1;
					(U = de.exec(oa)) && (Fa = U.shift(), W.push({
						value: Fa,
						type: U[0].replace(Cd, " ")
					}), oa = oa.slice(Fa.length));
					for (ja in Lb.filter) !(U = Dd[ja].exec(oa)) || Ja[ja] && !(U = Ja[ja](U)) || (Fa = U.shift(), W.push({
						value: Fa,
						type: ja,
						matches: U
					}), oa = oa.slice(Fa.length));
			...
			return $a = c.compile = function (u, N) {
					var U, W = [],
						ja = [],
						oa = Pc[u + " "];
					if (!oa) {
						N || (N = Bd(u));
						for (U = N.length; U--;) oa = ra(N[U]), oa[jb] ? W.push(oa) : ja.push(oa);
						oa = Pc(u, Ba(ja, W));
						oa.selector = u
					}
					return oa
				}, Na = c.select = function (u, N, U, W) {
					var ja, oa, Ja, db, Fa, kb = "function" == typeof u && u,
						mb = !W && Bd(u = kb.selector || u);
					if (U = U || [], 1 === mb.length) {
						if (oa = mb[0] = mb[0].slice(0), 2 < oa.length && "ID" === (Ja = oa[0]).type && 9 === N.nodeType &&
							ea && Lb.relative[oa[1].type]) {
							if (N = (Lb.find.ID(Ja.matches[0].replace(Wc, Xc), N) || [])[0], !N) return U;
							kb && (N = N.parentNode);
							u = u.slice(oa.shift().value.length)
						}
						for (ja = Dd.needsContext.test(u) ? 0 : oa.length; ja-- && (Ja = oa[ja], !Lb.relative[db = Ja.type]);)
							if ((Fa = Lb.find[db]) && (W = Fa(Ja.matches[0].replace(Wc, Xc), Ld.test(oa[0].type) && va(N.parentNode) || N))) {
								if (oa.splice(ja, 1), u = W.length && rb(oa), !u) return cd.apply(U, W), U;
								break
							}
					}
					return (kb || $a(u, mb))(W, N, !ea, U, !N || Ld.test(u) && va(N.parentNode) || N), U
				}, gc.sortStable = jb.split("").sort(Nc).join("") ===
				jb, gc.detectDuplicates = !!lc, hd(), gc.sortDetached = h(function (u) {
					...
					if (!U) return u.getAttribute(N, "type" === N.toLowerCase() ? 1 : 2)
				}), gc.attributes && h(function (u) {
					return u.innerHTML = "<input/>", u.firstChild.setAttribute("value", ""), "" === u.firstChild.getAttribute("value")
				}) || m("value", function (u, N, U) {
					if (!U &&
						"input" === u.nodeName.toLowerCase()) return u.defaultValue
				}), h(function (u) {
					return null == u.getAttribute("disabled")
				}) || m("checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", function (u, N, U) {
					var W;
					if (!U) return !0 === u[N] ? N.toLowerCase() : (W = u.getAttributeNode(N)) && W.specified ? W.value : null
				}), c
		}(la);
		k.find = Jb;
		k.expr = Jb.selectors;
		...
		k.filter = function (a, c, d) {
			var e = c[0];
			return d && (a = ":not(" + a + ")"), 1 === c.length && 1 === e.nodeType ? k.find.matchesSelector(e,
				a) ? [e] : [] : k.find.matches(a, k.grep(c, function (h) {
				return 1 === h.nodeType
			}))
		};
		k.fn.extend({
			find: function (a) {
				...
				if ("string" != typeof a) return this.pushStack(k(a).filter(function () {
					for (c = 0; c < d; c++)
						if (k.contains(e[c], this)) return !0
				}));
			...
			is: function (a) {
				return !!ib(this, "string" == typeof a &&
					mc.test(a) ? k(a) : a || [], !1).length
			}
		});
		var rd = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
		(k.fn.init = function (a, c, d) {
			...
			if (d = d || od, "string" == typeof a) {
				if (e = "<" === a[0] && ">" === a[a.length - 1] && 3 <= a.length ? [null, a, null] : rd.exec(a), !e || !e[1] && c) return !c || c.jquery ? (c || d).find(a) : this.constructor(c).find(a);
				if (e[1]) {
					if (c = c instanceof k ? c[0] : c, k.merge(this, k.parseHTML(e[1], c && c.nodeType ? c.ownerDocument || c : ha, !0)), $c.test(e[1]) && k.isPlainObject(c))
						for (e in c) k.isFunction(this[e]) ? this[e](c[e]) :
							this.attr(e, c[e]);
					return this
				}
				return h = ha.getElementById(e[2]), h && (this[0] = h, this.length = 1), this
			}
			return a.nodeType ? (this[0] = a, this.length = 1, this) : k.isFunction(a) ? void 0 !== d.ready ? d.ready(a) : a(k) : k.makeArray(a, this)
		}).prototype = k.fn;
		var od = k(ha);
		...
		k.fn.extend({
			has: function (a) {
				...
				return this.filter(function () {
					for (var e = 0; e < d; e++)
						if (k.contains(this, c[e])) return !0
				})
			},
				...
				if (!mc.test(a))
					for (; e < h; e++)
						for (d = this[e]; d && d !== c; d = d.parentNode)
							if (11 > d.nodeType && (q ? -1 < q.index(d) : 1 === d.nodeType && k.find.matchesSelector(d, a))) {
								m.push(d);
								break
							}
			...
			index: function (a) {
				return a ? "string" == typeof a ? ic.call(k(a), this[0]) : ic.call(this, a.jquery ? a[0] : a) : this[0] && this[0].parentNode ? this.first().prevAll().length : -1
			},
			add: function (a, c) {
		...
		k.each({
			...
			contents: function (a) {
				return qb(a, "iframe") ? a.contentDocument : (qb(a, "template") && (a = a.content || a), k.merge([], a.childNodes))
			}
		}, function (a, c) {
			k.fn[a] = function (d, e) {
				var h = k.map(this, c, d);
				return "Until" !== a.slice(-5) && (e = d), e && "string" == typeof e && (h = k.filter(e, h)), 1 < this.length && (xd[a] || k.uniqueSort(h), wd.test(a) && h.reverse()),
					this.pushStack(h)
			}
		});
		var Nb = /[^\x20\t\r\n\f]+/g;
			...
			var c, d, e, h, m = [],
				...
				J = function () {
					...
					for (e = c = !0; q.length; I = -1)
						for (d = q.shift(); ++I < m.length;) !1 === m[I].apply(d[0], d[1]) && a.stopOnFalse && (I = m.length, d = !1);
					a.memory || (d = !1);
					c = !1;
					h && (m = d ? [] : "")
				},
				ca = {
					add: function () {
						return m && (d && !c && (I = m.length - 1, q.push(d)), function Ra(va) {
							k.each(va, function (rb, Ua) {
								k.isFunction(Ua) ? a.unique && ca.has(Ua) || m.push(Ua) : Ua && Ua.length && "string" !== k.type(Ua) &&
									Ra(Ua)
							})
						}(arguments), d && !c && J()), this
					},
					remove: function () {
						return k.each(arguments, function (T, va) {
							for (var Ra; - 1 < (Ra = k.inArray(va, m, Ra));) m.splice(Ra, 1), Ra <= I && I--
						}), this
					},
					has: function (T) {
					...
					fireWith: function (T, va) {
						return h || (va = va || [], va = [T, va.slice ? va.slice() : va], q.push(va),
							c || J()), this
					},
					fire: function () {
		...
		k.extend({
			Deferred: function (a) {
				var c = [
					...
					e = {
						...
						pipe: function () {
							var m = arguments;
							return k.Deferred(function (q) {
								k.each(c, function (I, J) {
									var ca = k.isFunction(m[J[4]]) && m[J[4]];
									h[J[1]](function () {
										var T = ca && ca.apply(this, arguments);
										T && k.isFunction(T.promise) ? T.promise().progress(q.notify).done(q.resolve).fail(q.reject) : q[J[0] + "With"](this, ca ? [T] : arguments)
									})
								});
								m = null
							}).promise()
								...
								return function () {
									var Ua = this,
										...
										Pa = function () {
											var ra;
											if (!(T < ca)) {
												if (ra = Ra.apply(Ua, ub), ra === va.promise()) throw new TypeError("Thenable self-resolution");
												var Ba = ra && ("object" == typeof ra || "function" == typeof ra) && ra.then;
												k.isFunction(Ba) ? rb ? Ba.call(ra, J(ca, va, tb, rb), J(ca, va, yb, rb)) : (ca++, Ba.call(ra, J(ca, va, tb, rb), J(ca, va, yb, rb), J(ca, va, tb, va.notifyWith))) : (Ra !== tb && (Ua = void 0, ub = [ra]), (rb || va.resolveWith)(Ua, ub))
											}
										},
										wc = rb ? Pa : function () {
											try {
												...
												k.Deferred.exceptionHook && k.Deferred.exceptionHook(ra, wc.stackTrace), T + 1 >= ca && (Ra !== yb && (Ua = void 0, ub = [ra]), va.rejectWith(Ua, ub))
											}
										};
									T ? wc() : (k.Deferred.getStackHook && (wc.stackTrace = k.Deferred.getStackHook()),
										la.setTimeout(wc))
								}
							}
							var ca = 0;
					...
					h = {};
				return k.each(c, function (m, q) {
						var I = q[2],
							J = q[5];
						e[q[1]] = I.add;
						J && I.add(function () {
							d = J
						}, c[3 - m][2].disable, c[0][2].lock);
						I.add(q[3].fire);
						h[q[0]] = function () {
							return h[q[0] + "With"](this === h ? void 0 : this, arguments), this
						};
			...
			when: function (a) {
				...
				if (1 >= c && (ob(a, m.done(q(d)).resolve, m.reject, !c), "pending" === m.state() || k.isFunction(h[d] && h[d].then))) return m.then();
				for (; d--;) ob(h[d], q(d), m.reject);
				return m.promise()
			}
		});
		var Zc = /^(Eval|Internal|Range|Reference|Syntax|Type|URI)Error$/;
		k.Deferred.exceptionHook = function (a,
			c) {
			la.console && la.console.warn && a && Zc.test(a.name) && la.console.warn("jQuery.Deferred exception: " + a.message, a.stack, c)
		};
		...
		k.fn.ready = function (a) {
			return Tc.then(a)["catch"](function (c) {
				k.readyException(c)
			}), this
		};
		k.extend({
			...
			readyWait: 1,
			ready: function (a) {
				(!0 === a ? --k.readyWait : k.isReady) || (k.isReady = !0, !0 !== a && 0 < --k.readyWait || Tc.resolveWith(ha, [k]))
			}
		});
		k.ready.then = Tc.then;
		"complete" === ha.readyState || "loading" !==
			ha.readyState && !ha.documentElement.doScroll ? la.setTimeout(k.ready) : (ha.addEventListener("DOMContentLoaded", dc), la.addEventListener("load", dc));
		var Jc = function (a, c, d, e, h, m, q) {
				...
				else if (void 0 !== e && (h = !0, k.isFunction(e) || (q = !0), ca && (q ? (c.call(a, e), c = null) : (ca = c, c = function (T, va, Ra) {
		...
		xc.prototype = {
			cache: function (a) {
				...
				return c || (c = {}, bd(a) && (a.nodeType ? a[this.expando] = c : Object.defineProperty(a, this.expando, {
					value: c,
					configurable: !0
				}))), c
			},
			set: function (a, c, d) {
				...
				if ("string" == typeof c) a[k.camelCase(c)] = d;
					...
					for (e in c) a[k.camelCase(e)] = c[e];
				return a
			},
			get: function (a, c) {
				return void 0 === c ? this.cache(a) : a[this.expando] && a[this.expando][k.camelCase(c)]
			},
			access: function (a, c, d) {
				return void 0 === c ||
					c && "string" == typeof c && void 0 === d ? this.get(a, c) : (this.set(a, c, d), void 0 !== d ? d : c)
			},
			remove: function (a, c) {
				var d, e = a[this.expando];
				if (void 0 !== e) {
					if (void 0 !== c)
						for (Array.isArray(c) ? c = c.map(k.camelCase) : (c = k.camelCase(c), c = c in e ? [c] : c.match(Nb) || []), d = c.length; d--;) delete e[c[d]];
					(void 0 === c || k.isEmptyObject(e)) && (a.nodeType ? a[this.expando] = void 0 : delete a[this.expando])
				}
			},
			hasData: function (a) {
				a = a[this.expando];
		...
		k.fn.extend({
			data: function (a, c) {
				var d, e, h, m = this[0],
					q = m && m.attributes;
				if (void 0 === a) {
					if (this.length && (h = Ob.get(m), 1 === m.nodeType && !lb.get(m, "hasDataAttrs"))) {
						for (d = q.length; d--;) q[d] && (e = q[d].name, 0 === e.indexOf("data-") && (e = k.camelCase(e.slice(5)),
							Cc(m, e, h[e])));
				...
				return "object" == typeof a ? this.each(function () {
					...
					var J;
					if (m && void 0 === I) {
						if ((J = Ob.get(m, a), void 0 !== J) || (J = Cc(m, a), void 0 !== J)) return J
		...
		k.extend({
			queue: function (a, c, d) {
				var e;
				if (a) return c = (c || "fx") + "queue", e = lb.get(a, c), d && (!e || Array.isArray(d) ? e = lb.access(a,
					c, k.makeArray(d)) : e.push(d)), e || []
			},
			dequeue: function (a, c) {
				...
				h && ("fx" === c && d.unshift("inprogress"), delete m.stop, h.call(a, q, m));
				!e && m && m.empty.fire()
			},
			_queueHooks: function (a, c) {
				var d = c + "queueHooks";
				return lb.get(a, d) || lb.access(a, d, {
		...
		k.fn.extend({
			queue: function (a, c) {
				var d = 2;
				return "string" !=
					typeof a && (c = a, a = "fx", d--), arguments.length < d ? k.queue(this[0], a) : void 0 === c ? this : this.each(function () {
			...
			promise: function (a, c) {
				...
				for (a = a || "fx"; q--;)(d = lb.get(m[q], a +
					"queueHooks")) && d.empty && (e++, d.empty.add(I));
		...
		var Ad = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
			...
			Wa = function (a, c) {
				return a = c || a, "none" === a.style.display || "" === a.style.display && k.contains(a.ownerDocument, a) && "none" === k.css(a, "display")
			},
			fb = function (a, c, d, e) {
				var h, m = {};
		...
		k.event = {
			...
			add: function (a, c, d, e, h) {
				...
				if (J = lb.get(a))
					for (d.handler && (m = d, d = m.handler, h = m.selector), h && k.find.matchesSelector(Kc, h), d.guid || (d.guid = k.guid++), (I = J.events) || (I = J.events = {}), (q = J.handle) || (q = J.handle = function (ub) {
							return "undefined" != typeof k && k.event.triggered !== ub.type ? k.event.dispatch.apply(a, arguments) : void 0
						}), c = (c || "").match(Nb) || [""], J = c.length; J--;) {
						var rb =
							md.exec(c[J]) || [];
						var Ua = Ra = rb[1];
						rb = (rb[2] || "").split(".").sort();
						Ua && (T = k.event.special[Ua] || {}, Ua = (h ? T.delegateType : T.bindType) || Ua, T = k.event.special[Ua] || {}, ca = k.extend({
								type: Ua,
								origType: Ra,
								data: e,
								handler: d,
								...
								namespace: rb.join(".")
							}, m), (va = I[Ua]) || (va = I[Ua] = [], va.delegateCount = 0, T.setup && !1 !== T.setup.call(a, e, rb, q) || a.addEventListener && a.addEventListener(Ua, q)), T.add && (T.add.call(a, ca), ca.handler.guid || (ca.handler.guid = d.guid)),
							h ? va.splice(va.delegateCount++, 0, ca) : va.push(ca), k.event.global[Ua] = !0)
					}
			},
			remove: function (a, c, d, e, h) {
				var m, q, I, J, ca, T, va, Ra, rb = lb.hasData(a) && lb.get(a);
				if (rb && (J = rb.events)) {
					c = (c || "").match(Nb) || [""];
					for (ca = c.length; ca--;)
						if (I = md.exec(c[ca]) || [], T = Ra = I[1], va = (I[2] || "").split(".").sort(), T) {
							var Ua = k.event.special[T] || {};
							T = (e ? Ua.delegateType : Ua.bindType) || T;
							var ub = J[T] || [];
							I = I[2] && new RegExp("(^|\\.)" + va.join("\\.(?:.*\\.|)") + "(\\.|$)");
							for (q = m = ub.length; m--;) {
								var Pa = ub[m];
								!h && Ra !== Pa.origType || d &&
									d.guid !== Pa.guid || I && !I.test(Pa.namespace) || e && e !== Pa.selector && ("**" !== e || !Pa.selector) || (ub.splice(m, 1), Pa.selector && ub.delegateCount--, Ua.remove && Ua.remove.call(a, Pa))
							}
							q && !ub.length && (Ua.teardown && !1 !== Ua.teardown.call(a, va, rb.handle) || k.removeEvent(a, T, rb.handle), delete J[T])
						} else
							for (T in J) k.event.remove(a, T + c[ca], d, e, !0);
					k.isEmptyObject(J) && lb.remove(a, "handle events")
				}
			},
			dispatch: function (a) {
				var c = k.event.fix(a),
					d, e, h, m, q = Array(arguments.length);
				var I = (lb.get(this, "events") || {})[c.type] || [];
				var J = k.event.special[c.type] || {};
				q[0] = c;
				for (d = 1; d < arguments.length; d++) q[d] = arguments[d];
				if (c.delegateTarget = this, !J.preDispatch || !1 !== J.preDispatch.call(this, c)) {
					var ca = k.event.handlers.call(this, c, I);
					for (d = 0;
						(h = ca[d++]) && !c.isPropagationStopped();)
						for (c.currentTarget = h.elem, I = 0;
							(m = h.handlers[I++]) && !c.isImmediatePropagationStopped();) c.rnamespace && !c.rnamespace.test(m.namespace) || (c.handleObj = m, c.data = m.data, e = ((k.event.special[m.origType] || {}).handle || m.handler).apply(h.elem, q), void 0 !== e && !1 ===
			...
			handlers: function (a, c) {
					...
					for (; m !== this; m = m.parentNode || this)
						if (1 === m.nodeType && ("click" !== a.type || !0 !== m.disabled)) {
							...
							for (d = 0; d < h; d++) {
								var J = c[d];
								var ca = J.selector + " ";
								void 0 === I[ca] && (I[ca] = J.needsContext ? -1 < k(ca, this).index(m) : k.find(ca, this, null, [m]).length);
								I[ca] && q.push(J)
							}
							q.length &&
								e.push({
				...
				return m = this, h < c.length && e.push({
					elem: m,
					handlers: c.slice(h)
				}), e
			},
			...
			special: {
				...
				click: {
					trigger: function () {
						if ("checkbox" === this.type && this.click && qb(this, "input")) return this.click(), !1
					},
					_default: function (a) {
		...
		k.Event = function (a, c) {
			return this instanceof k.Event ? (a && a.type ? (this.originalEvent = a, this.type = a.type, this.isDefaultPrevented = a.defaultPrevented || void 0 === a.defaultPrevented && !1 === a.returnValue ? ua : Ma, this.target = a.target && 3 === a.target.nodeType ? a.target.parentNode : a.target, this.currentTarget = a.currentTarget, this.relatedTarget = a.relatedTarget) : this.type = a, c && k.extend(this, c), this.timeStamp = a && a.timeStamp || k.now(), void(this[k.expando] = !0)) : new k.Event(a, c)
		};
		k.Event.prototype = {
			constructor: k.Event,
		...
		k.each({
			...
			which: function (a) {
				var c = a.button;
				return null == a.which && qd.test(a.type) ? null != a.charCode ? a.charCode : a.keyCode : !a.which && void 0 !== c && ld.test(a.type) ?
					1 & c ? 1 : 2 & c ? 3 : 4 & c ? 2 : 0 : a.which
			}
		}, k.event.addProp);
		k.each({
			...
			k.event.special[a] = {
				...
				bindType: c,
				handle: function (d) {
					var e, h = d.relatedTarget,
						m = d.handleObj;
					return h && (h === this || k.contains(this, h)) || (d.type = m.origType, e = m.handler.apply(this, arguments), d.type = c), e
				}
			}
		});
		k.fn.extend({
			...
			off: function (a,
				...
				return !1 !== c && "function" != typeof c || (d = c, c = void 0), !1 === d && (d = Ma), this.each(function () {
		...
		k.extend({
			...
			clone: function (a, c, d) {
				var e, h = a.cloneNode(!0),
					m = k.contains(a.ownerDocument, a);
				if (!(Ya.noCloneChecked || 1 !== a.nodeType && 11 !== a.nodeType || k.isXMLDoc(a))) {
					var q = Zb(h);
					var I = Zb(a);
					var J = 0;
					for (e = I.length; J < e; J++) {
						...
						"input" === va && yc.test(ca.type) ? T.checked = ca.checked : "input" !== va && "textarea" !== va || (T.defaultValue = ca.defaultValue)
					}
				}
				if (c)
					if (d)
						for (I =
							I || Zb(a), q = q || Zb(h), J = 0, e = I.length; J < e; J++) Vb(I[J], q[J]);
					else Vb(a, h);
				return q = Zb(h, "script"), 0 < q.length && da(q, !m && Zb(a, "script")), h
			},
			cleanData: function (a) {
				for (var c, d, e, h = k.event.special, m = 0; void 0 !== (d = a[m]); m++)
					if (bd(d)) {
						if (c = d[lb.expando]) {
							if (c.events)
								for (e in c.events) h[e] ? k.event.remove(d, e) : k.removeEvent(d, e, c.handle);
							d[lb.expando] = void 0
						}
		...
		k.fn.extend({
			...
			text: function (a) {
				return Jc(this,
					function (c) {
						return void 0 === c ? k.text(this) : this.empty().each(function () {
			...
			append: function () {
				return Cb(this, arguments, function (a) {
					1 !== this.nodeType && 11 !== this.nodeType && 9 !== this.nodeType || Ha(this, a).appendChild(a)
				})
			},
			prepend: function () {
				return Cb(this, arguments, function (a) {
			...
			empty: function () {
				for (var a, c = 0; null != (a = this[c]); c++) 1 === a.nodeType && (k.cleanData(Zb(a, !1)), a.textContent = "");
				return this
			},
			clone: function (a, c) {
				return a = null != a && a, c = null == c ? a : c, this.map(function () {
			...
			html: function (a) {
				return Jc(this, function (c) {
					...
					if ("string" == typeof c && !Mc.test(c) && !sc[(Lc.exec(c) || ["", ""])[1].toLowerCase()]) {
						c = k.htmlPrefilter(c);
						try {
							for (; e < h; e++) d = this[e] || {}, 1 === d.nodeType && (k.cleanData(Zb(d, !1)), d.innerHTML = c);
							d = 0
						} catch (m) {}
					}
			...
			replaceWith: function () {
				var a = [];
				return Cb(this, arguments, function (c) {
					var d = this.parentNode;
					0 > k.inArray(this, a) && (k.cleanData(Zb(this)), d && d.replaceChild(c, this))
				}, a)
			}
		});
		k.each({
			...
			k.fn[a] = function (d) {
				for (var e = [], h = k(d), m = h.length - 1, q = 0; q <= m; q++) d = q === m ? this : this.clone(!0), k(h[q])[c](d), eb.apply(e, d.get());
		...
		! function () {
			function a() {
				if (q) {
					q.style.cssText = "box-sizing:border-box;position:relative;display:block;margin:auto;border:1px;padding:1px;top:1%;width:50%";
					q.innerHTML = "";
					Kc.appendChild(m);
			...
			var c, d, e, h, m = ha.createElement("div"),
				q = ha.createElement("div");
			q.style && (q.style.backgroundClip = "content-box", q.cloneNode(!0).style.backgroundClip = "", Ya.clearCloneStyle = "content-box" === q.style.backgroundClip, m.style.cssText = "border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute",
				m.appendChild(q), k.extend(Ya, {
		...
		k.extend({
			...
			style: function (a, c, d, e) {
				if (a && 3 !== a.nodeType && 8 !== a.nodeType && a.style) {
					var h, m, q, I = k.camelCase(c),
						J = w.test(c),
						ca = a.style;
					return J || (c = qc(I)), q = k.cssHooks[c] || k.cssHooks[I], void 0 === d ? q && "get" in q && void 0 !== (h = q.get(a, !1, e)) ? h : ca[c] : (m = typeof d, "string" === m && (h = L.exec(d)) && h[1] && (d = zc(a, c, h), m = "number"), null != d && d === d && ("number" ===
						m && (d += h && h[3] || (k.cssNumber[I] ? "" : "px")), Ya.clearCloneStyle || "" !== d || 0 !== c.indexOf("background") || (ca[c] = "inherit"), q && "set" in q && void 0 === (d = q.set(a, d, e)) || (J ? ca.setProperty(c, d) : ca[c] = d)), void 0)
				}
			},
			css: function (a, c, d, e) {
				var h, m, q, I = k.camelCase(c);
				return w.test(c) || (c = qc(I)), q = k.cssHooks[c] || k.cssHooks[I], q && "get" in q && (h = q.get(a, !0, d)), void 0 === h && (h = Rb(a, c, e)), "normal" === h && c in B && (h = B[c]), "" === d || d ? (m = parseFloat(h), !0 === d || isFinite(m) ? m || 0 : h) : h
			}
		});
		k.each(["height", "width"], function (a, c) {
			k.cssHooks[c] = {
				get: function (d, e, h) {
					if (e) return !t.test(k.css(d, "display")) || d.getClientRects().length && d.getBoundingClientRect().width ? tc(d, c, h) : fb(d, G, function () {
						return tc(d, c, h)
					})
				},
				set: function (d, e, h) {
					var m, q = h && l(d);
					h = h && nc(d, c, h, "border-box" === k.css(d, "boxSizing", !1, q), q);
					return h && (m = L.exec(e)) && "px" !== (m[3] || "px") && (d.style[c] = e, e = k.css(d, c)), Kb(d, e, h)
				}
			}
		});
		k.cssHooks.marginLeft = bc(Ya.reliableMarginLeft, function (a, c) {
			if (c) return (parseFloat(Rb(a, "marginLeft")) || a.getBoundingClientRect().left - fb(a, {
					marginLeft: 0
				},
				function () {
		...
		k.each({
			...
			k.cssHooks[a + c] = {
				expand: function (d) {
					var e = 0,
						h = {};
					for (d = "string" == typeof d ? d.split(" ") : [d]; 4 > e; e++) h[a + Ib[e] + c] = d[e] || d[e - 2] || d[0];
					return h
				}
			};
		...
		k.fn.extend({
			css: function (a, c) {
				return Jc(this, function (d, e, h) {
					...
					return void 0 !== h ? k.style(d, e, h) : k.css(d,
						e)
		...
		cc.prototype = {
			...
			run: function (a) {
				var c, d = cc.propHooks[this.prop];
				return this.options.duration ? this.pos = c = k.easing[this.easing](a, this.options.duration * a, 0, 1, this.options.duration) :
					this.pos = c = a, this.now = (this.end - this.start) * c + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), d && d.set ? d.set(this) : cc.propHooks._default.set(this), this
			}
		};
		...
		cc.propHooks = {
			_default: {
				get: function (a) {
					var c;
					return 1 !== a.elem.nodeType || null != a.elem[a.prop] && null == a.elem.style[a.prop] ? a.elem[a.prop] : (c = k.css(a.elem, a.prop, ""), c && "auto" !== c ? c : 0)
				},
				set: function (a) {
					k.fx.step[a.prop] ? k.fx.step[a.prop](a) : 1 !== a.elem.nodeType || null == a.elem.style[k.cssProps[a.prop]] &&
						!k.cssHooks[a.prop] ? a.elem[a.prop] = a.now : k.style(a.elem, a.prop, a.now + a.unit)
				}
			}
		};
		...
		k.fx.step = {};
		var O, C, P = /^(?:toggle|show|hide)$/,
			z = /queueHooks$/;
		k.Animation = k.extend(oc, {
			tweeners: {
				"*": [function (a, c) {
					var d = this.createTween(a, c);
					return zc(d.elem, a, L.exec(c),
						d), d
				}]
			},
			tweener: function (a, c) {
				k.isFunction(a) ? (c = a, a = ["*"]) : a = a.match(Nb);
				for (var d, e = 0, h = a.length; e < h; e++) d = a[e], oc.tweeners[d] = oc.tweeners[d] || [], oc.tweeners[d].unshift(c)
			},
			prefilters: [function (a, c, d) {
				var e, h, m, q, I, J, ca, T, va = "width" in c || "height" in c,
					Ra = this,
					rb = {},
					Ua = a.style,
					ub = a.nodeType && Wa(a),
					Pa = lb.get(a, "fxshow");
				d.queue || (q = k._queueHooks(a, "fx"), null == q.unqueued && (q.unqueued = 0, I = q.empty.fire, q.empty.fire = function () {
					q.unqueued || I()
				}), q.unqueued++, Ra.always(function () {
					Ra.always(function () {
						q.unqueued--;
				...
				for (e in c)
					if (h = c[e], P.test(h)) {
						if (delete c[e], m = m || "toggle" === h, h === (ub ? "hide" : "show")) {
				...
				if (J = !k.isEmptyObject(c), J || !k.isEmptyObject(rb))
					for (e in va && 1 === a.nodeType && (d.overflow = [Ua.overflow, Ua.overflowX, Ua.overflowY], ca = Pa && Pa.display, null == ca && (ca = lb.get(a, "display")), T = k.css(a, "display"), "none" === T && (ca ? T = ca : (ec([a], !0), ca = a.style.display || ca, T = k.css(a, "display"), ec([a]))),
							("inline" === T || "inline-block" === T && null != ca) && "none" === k.css(a, "float") && (J || (Ra.done(function () {
								Ua.display = ca
							}), null == ca && (T = Ua.display, ca = "none" === T ? "" : T)), Ua.display = "inline-block")), d.overflow && (Ua.overflow = "hidden", Ra.always(function () {
							Ua.overflow = d.overflow[0];
							Ua.overflowX = d.overflow[1];
							Ua.overflowY = d.overflow[2]
						})), J = !1, rb) J || (Pa ? "hidden" in Pa && (ub = Pa.hidden) : Pa = lb.access(a, "fxshow", {
						display: ca
					}), m && (Pa.hidden = !ub), ub && ec([a], !0), Ra.done(function () {
						ub || ec([a]);
						lb.remove(a, "fxshow");
						for (e in rb) k.style(a,
							e, rb[e])
					})), J = Hc(ub ? Pa[e] : 0, e, Ra), e in Pa || (Pa[e] = J.start, ub && (J.end = J.start, J.start = 0))
			}],
		...
		k.speed = function (a, c, d) {
			...
			return k.fx.off ? e.duration = 0 : "number" != typeof e.duration && (e.duration in k.fx.speeds ? e.duration = k.fx.speeds[e.duration] : e.duration = k.fx.speeds._default), null != e.queue && !0 !== e.queue ||
		...
		k.fn.extend({
			...
			animate: function (a, c, d, e) {
				...
				return c.finish = c, h || !1 === m.queue ? this.each(c) : this.queue(m.queue, c)
			},
			stop: function (a, c, d) {
				var e = function (h) {
					var m =
				...
				return "string" != typeof a && (d = c, c = a, a = void 0), c && !1 !== a && this.queue(a || "fx", []), this.each(function () {
					...
					if (m) I[m] && I[m].stop && e(I[m]);
						...
						for (m in I) I[m] && I[m].stop && z.test(m) && e(I[m]);
					for (m = q.length; m--;) q[m].elem !== this || null != a && q[m].queue !== a || (q[m].anim.stop(d), h = !1, q.splice(m, 1));
			...
			finish: function (a) {
				return !1 !== a && (a = a || "fx"), this.each(function () {
					...
					for (e = h.length; e--;) h[e].elem === this && h[e].queue === a && (h[e].anim.stop(!0), h.splice(e, 1));
					for (e = 0; e < m; e++) d[e] && d[e].finish && d[e].finish.call(this);
					delete c.finish
				})
			}
		});
		k.each(["toggle", "show", "hide"], function (a, c) {
			...
			k.fn[c] = function (e, h, m) {
				return null == e || "boolean" == typeof e ? d.apply(this, arguments) : this.animate(fc(c, !0), e, h, m)
			}
		});
		k.each({
			slideDown: fc("show"),
		...
		k.fn.delay = function (a, c) {
			return a = k.fx ? k.fx.speeds[a] || a : a, c = c || "fx", this.queue(c, function (d, e) {
		...
		k.extend({
			attr: function (a, c, d) {
				var e, h, m = a.nodeType;
				if (3 !== m && 8 !== m && 2 !== m) return "undefined" == typeof a.getAttribute ? k.prop(a, c, d) : (1 === m && k.isXMLDoc(a) || (h = k.attrHooks[c.toLowerCase()] || (k.expr.match.bool.test(c) ? H : void 0)), void 0 !== d ? null === d ? void k.removeAttr(a, c) : h && "set" in h && void 0 !== (e = h.set(a, d, c)) ? e : (a.setAttribute(c, d + ""), d) : h && "get" in h && null !== (e = h.get(a, c)) ? e : (e = k.find.attr(a, c),
					null == e ? void 0 : e))
			},
			attrHooks: {
				type: {
		...
		k.each(k.expr.match.bool.source.match(/\w+/g), function (a, c) {
			...
			F[c] = function (e, h, m) {
				var q, I, J = h.toLowerCase();
				return m ||
					(I = F[J], F[J] = q, q = null != d(e, h, m) ? J : null, F[J] = I), q
			}
		});
		...
		k.extend({
			prop: function (a, c, d) {
				var e, h, m = a.nodeType;
				if (3 !== m && 8 !== m && 2 !== m) return 1 === m && k.isXMLDoc(a) || (c = k.propFix[c] || c, h = k.propHooks[c]), void 0 !== d ? h && "set" in h && void 0 !== (e = h.set(a, d, c)) ? e : a[c] = d : h && "get" in h && null !== (e =
					h.get(a, c)) ? e : a[c]
			},
			propHooks: {
				tabIndex: {
					get: function (a) {
						...
						return c ? parseInt(c, 10) : r.test(a.nodeName) || X.test(a.nodeName) && a.href ? 0 : -1
					}
				}
			},
			propFix: {
		...
		Ya.optSelected || (k.propHooks.selected = {
			get: function (a) {
				a = a.parentNode;
		...
		k.fn.extend({
			...
			removeClass: function (a) {
				var c, d, e, h, m, q, I = 0;
				if (k.isFunction(a)) return this.each(function (J) {
					k(this).removeClass(a.call(this,
						J, fa(this)))
				});
				...
				if ("string" == typeof a && a)
					for (c = a.match(Nb) || []; d = this[I++];)
						if (h = fa(d), e = 1 === d.nodeType && " " + Ac(h) + " ") {
							for (q = 0; m = c[q++];)
								for (; - 1 < e.indexOf(" " + m + " ");) e = e.replace(" " + m + " ", " ");
							e = Ac(e);
							h !== e && d.setAttribute("class", e)
						}
				return this
			...
			toggleClass: function (a, c) {
				var d = typeof a;
				return "boolean" == typeof c && "string" === d ? c ? this.addClass(a) : this.removeClass(a) : k.isFunction(a) ? this.each(function (e) {
					k(this).toggleClass(a.call(this, e, fa(this), c),
						c)
				}) : this.each(function () {
					var e, h;
					if ("string" === d) {
						var m = 0;
						var q = k(this);
						for (h = a.match(Nb) || []; e = h[m++];) q.hasClass(e) ? q.removeClass(e) : q.addClass(e)
			...
			hasClass: function (a) {
				var c, d = 0;
				for (a = " " + a + " "; c = this[d++];)
					if (1 === c.nodeType && -1 < (" " + Ac(fa(c)) + " ").indexOf(a)) return !0;
				return !1
			}
		});
		var D = /\r/g;
		k.fn.extend({
			val: function (a) {
				var c,
					d, e, h = this[0];
				if (arguments.length) return e = k.isFunction(a), this.each(function (m) {
					var q;
					1 === this.nodeType && (q = e ? a.call(this, m, k(this).val()) : a, null == q ? q = "" : "number" == typeof q ? q += "" : Array.isArray(q) && (q = k.map(q, function (I) {
						return null == I ? "" : I + ""
					})), c = k.valHooks[this.type] || k.valHooks[this.nodeName.toLowerCase()], c && "set" in c && void 0 !== c.set(this, q, "value") || (this.value = q))
				});
				if (h) return c = k.valHooks[h.type] || k.valHooks[h.nodeName.toLowerCase()], c && "get" in c && void 0 !== (d = c.get(h, "value")) ? d : (d = h.value,
				...
				select: {
					get: function (a) {
						...
						for (d = 0 > h ? I : m ? h : 0; d < I; d++)
							if (c = e[d], !(!c.selected && d !== h || c.disabled || c.parentNode.disabled && qb(c.parentNode, "optgroup"))) {
					...
					set: function (a, c) {
						for (var d, e = a.options, h = k.makeArray(c), m =
								e.length; m--;) c = e[m], (c.selected = -1 < k.inArray(k.valHooks.option.get(c), h)) && (d = !0);
		...
		k.each(["radio", "checkbox"], function () {
			k.valHooks[this] = {
				set: function (a, c) {
					if (Array.isArray(c)) return a.checked = -1 < k.inArray(k(a).val(), c)
				}
			};
			Ya.checkOn || (k.valHooks[this].get = function (a) {
		...
		k.extend(k.event, {
			trigger: function (a, c, d, e) {
				var h, m, q, I, J, ca = [d || ha],
					T = nb.call(a, "type") ? a.type : a;
				var va = nb.call(a, "namespace") ? a.namespace.split(".") : [];
				if (h = m = d = d || ha, 3 !== d.nodeType && 8 !== d.nodeType && !p.test(T + k.event.triggered) && (-1 < T.indexOf(".") && (va = T.split("."), T = va.shift(), va.sort()), q = 0 > T.indexOf(":") && "on" + T, a = a[k.expando] ? a : new k.Event(T, "object" == typeof a && a), a.isTrigger = e ? 2 : 3, a.namespace = va.join("."), a.rnamespace = a.namespace ? new RegExp("(^|\\.)" + va.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, a.result = void 0, a.target || (a.target = d), c = null == c ? [a] : k.makeArray(c, [a]), J = k.event.special[T] || {},
						e || !J.trigger || !1 !== J.trigger.apply(d, c))) {
					if (!e && !J.noBubble && !k.isWindow(d)) {
						var Ra = J.delegateType || T;
						for (p.test(Ra + T) || (h = h.parentNode); h; h = h.parentNode) ca.push(h), m = h;
						m === (d.ownerDocument || ha) && ca.push(m.defaultView || m.parentWindow || la)
					}
					for (va = 0;
						(h = ca[va++]) && !a.isPropagationStopped();) a.type = 1 < va ? Ra : J.bindType || T, (I = (lb.get(h, "events") || {})[a.type] && lb.get(h, "handle")) && I.apply(h, c), (I = q && h[q]) && I.apply && bd(h) && (a.result = I.apply(h, c), !1 === a.result && a.preventDefault());
					return a.type = T, e || a.isDefaultPrevented() ||
						J._default && !1 !== J._default.apply(ca.pop(), c) || !bd(d) || q && k.isFunction(d[T]) && !k.isWindow(d) && (m = d[q], m && (d[q] = null), k.event.triggered = T, d[T](), k.event.triggered = void 0, m && (d[q] = m)), a.result
				}
			},
		...
		k.each("blur focus focusin focusout resize scroll click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup contextmenu".split(" "),
			function (a, c) {
				k.fn[c] = function (d, e) {
					return 0 < arguments.length ? this.on(c, null, d, e) : this.trigger(c)
				}
			});
		k.fn.extend({
			hover: function (a, c) {
			...
			k.event.special[c] = {
				...
				teardown: function () {
					var e =
						...
						h = lb.access(e, c) - 1;
					h ? lb.access(e, c, h) : (e.removeEventListener(a, d, !0), lb.remove(e, c))
				}
			}
		});
		var v = la.location,
		...
		k.parseXML = function (a) {
			...
			return c && !c.getElementsByTagName("parsererror").length || k.error("Invalid XML: " + a), c
		};
		var V = /\[\]$/,
			Y = /\r?\n/g,
		...
		k.param = function (a, c) {
			var d,
				...
				h = function (m, q) {
					...
					e[e.length] = encodeURIComponent(m) + "=" + encodeURIComponent(null == q ? "" : q)
				};
			if (Array.isArray(a) || a.jquery && !k.isPlainObject(a)) k.each(a, function () {
				h(this.name, this.value)
			});
			else
				for (d in a) Ic(d, a[d], c, h);
			return e.join("&")
		};
		k.fn.extend({
			serialize: function () {
			...
			serializeArray: function () {
				return this.map(function () {
					...
					var a = this.type;
					return this.name &&
						!k(this).is(":disabled") && S.test(this.nodeName) && !ia.test(a) && (this.checked || !yc.test(a))
				}).map(function (a, c) {
					a = k(this).val();
					return null == a ? null : Array.isArray(a) ? k.map(a, function (d) {
						return {
							name: c.name,
							value: d.replace(Y, "\r\n")
						}
		...
		k.extend({
			...
			ajaxSettings: {
				url: v.href,
				type: "GET",
				isLocal: /^(?:about|app|app-storage|.+-extension|file|res|widget):$/.test(v.protocol),
				global: !0,
				processData: !0,
				async: !0,
			...
			ajax: function (a, c) {
				function d(Na, Yb, sb, lc) {
					...
					if (!$a) {
						...
						if (sb) {
							var Ga = T;
							for (var cb = Ba, wb, jb, Hb, Ab, ad = Ga.contents, Dc = Ga.dataTypes;
								"*" === Dc[0];) Dc.shift(), void 0 === wb && (wb = Ga.mimeType || cb.getResponseHeader("Content-Type"));
							if (wb)
								for (jb in ad)
						...
						a: {
							sb = T;wb = Ga;jb = Ba;Hb = lc;
							var rc, Pc, Nc;Ga = {};cb = sb.dataTypes.slice();
							if (cb[1])
								for (rc in sb.converters) Ga[rc.toLowerCase()] = sb.converters[rc];
							for (Ab = cb.shift(); Ab;)
								if (sb.responseFields[Ab] && (jb[sb.responseFields[Ab]] = wb), !Nc && Hb && sb.dataFilter && (wb = sb.dataFilter(wb,
										sb.dataType)), Nc = Ab, Ab = cb.shift())
									if ("*" === Ab) Ab = Nc;
									else if ("*" !== Nc && Nc !== Ab) {
								if (rc = Ga[Nc + " " + Ab] || Ga["* " + Ab], !rc)
									for (dd in Ga)
										if (Pc = dd.split(" "), Pc[1] === Ab && (rc = Ga[Nc + " " + Pc[0]] || Ga["* " + Pc[0]])) {
											!0 === rc ? rc = Ga[dd] : !0 !== Ga[dd] && (Ab = Pc[0], cb.unshift(Pc[1]));
											break
										}
								if (!0 !== rc)
									if (rc && sb["throws"]) wb = rc(wb);
										...
										var dd = {
											state: "parsererror",
											error: rc ? Vc : "No conversion from " + Nc + " to " + Ab
										};
										break a
									}
							}
						...
						Ga = dd;
						lc ? (T.ifModified && (ea = Ba.getResponseHeader("Last-Modified"),
							ea && (k.lastModified[vb] = ea), ea = Ba.getResponseHeader("etag"), ea && (k.etag[vb] = ea)), 204 === Na || "HEAD" === T.type ? ta = "nocontent" : 304 === Na ? ta = "notmodified" : (ta = Ga.state, zb = Ga.data, ab = Ga.error, lc = !ab)) : (ab = ta, !Na && ta || (ta = "error", 0 > Na && (Na = 0)));
						Ba.status = Na;
						Ba.statusText = (Yb || ta) + "";
						lc ? rb.resolveWith(va, [zb, ta, Ba]) : rb.rejectWith(va, [Ba, ta, ab]);
						Ba.statusCode(ub);
						ub = void 0;
						I && Ra.trigger(lc ? "ajaxSuccess" : "ajaxError", [Ba, T, lc ? zb : ab]);
						Ua.fireWith(va, [Ba, ta]);
						I && (Ra.trigger("ajaxComplete", [Ba, T]), --k.active || k.event.trigger("ajaxStop"))
					}
				}
				"object" == typeof a && (c = a, a = void 0);
				c = c || {};
				var e, h, m, q, I, J, ca, T = k.ajaxSetup({}, c),
					va = T.context || T,
					...
					Ba = {
						...
						getResponseHeader: function (Na) {
							...
							if ($a) {
								if (!m)
									for (m = {}; Yb = qa.exec(h);) m[Yb[1].toLowerCase()] = Yb[2];
								Yb = m[Na.toLowerCase()]
							}
						...
						setRequestHeader: function (Na, Yb) {
							return null ==
								$a && (Na = wc[Na.toLowerCase()] = wc[Na.toLowerCase()] || Na, Pa[Na] = Yb), this
						},
						...
						statusCode: function (Na) {
							...
							if (Na)
								if ($a) Ba.always(Na[Ba.status]);
									...
									for (Yb in Na) ub[Yb] = [ub[Yb], Na[Yb]];
							return this
						},
						abort: function (Na) {
							Na = Na || ra;
				...
				if (rb.promise(Ba), T.url = ((a || T.url || v.href) + "").replace(Ka, v.protocol + "//"), T.type = c.method || c.type || T.method || T.type, T.dataTypes = (T.dataType || "*").toLowerCase().match(Nb) || [""], null == T.crossDomain) {
					a = ha.createElement("a");
					try {
						a.href = T.url, a.href = a.href, T.crossDomain = ka.protocol + "//" + ka.host != a.protocol + "//" + a.host
					} catch (Na) {
						T.crossDomain = !0
					}
				}
				if (T.data && T.processData && "string" != typeof T.data && (T.data = k.param(T.data, T.traditional)), g(Aa, T, c, Ba), $a) return Ba;
				(I = k.event && T.global) && 0 === k.active++ && k.event.trigger("ajaxStart");
				T.type = T.type.toUpperCase();
				T.hasContent = !ya.test(T.type);
				var vb = T.url.replace(aa, "");
				T.hasContent ? T.data && T.processData && 0 === (T.contentType || "").indexOf("application/x-www-form-urlencoded") &&
					(T.data = T.data.replace(Z, "+")) : (ca = T.url.slice(vb.length), T.data && (vb += (M.test(vb) ? "&" : "?") + T.data, delete T.data), !1 === T.cache && (vb = vb.replace(R, "$1"), ca = (M.test(vb) ? "&" : "?") + "_=" + y++ + ca), T.url = vb + ca);
				T.ifModified && (k.lastModified[vb] && Ba.setRequestHeader("If-Modified-Since", k.lastModified[vb]), k.etag[vb] && Ba.setRequestHeader("If-None-Match", k.etag[vb]));
				(T.data && T.hasContent && !1 !== T.contentType || c.contentType) && Ba.setRequestHeader("Content-Type", T.contentType);
				Ba.setRequestHeader("Accept", T.dataTypes[0] &&
					T.accepts[T.dataTypes[0]] ? T.accepts[T.dataTypes[0]] + ("*" !== T.dataTypes[0] ? ", " + A + "; q=0.01" : "") : T.accepts["*"]);
				for (J in T.headers) Ba.setRequestHeader(J, T.headers[J]);
				if (T.beforeSend && (!1 === T.beforeSend.call(va, Ba, T) || $a)) return Ba.abort();
				if (ra = "abort", Ua.add(T.complete), Ba.done(T.success), Ba.fail(T.error), e = g(ba, T, c, Ba)) {
					if (Ba.readyState = 1, I && Ra.trigger("ajaxSend", [Ba, T]), $a) return Ba;
					T.async && 0 < T.timeout && (q = la.setTimeout(function () {
						Ba.abort("timeout")
					}, T.timeout));
					try {
						var $a = !1;
		...
		k.each(["get", "post"], function (a, c) {
			k[c] = function (d, e, h, m) {
				return k.isFunction(e) && (m = m || h, h = e, e = void 0), k.ajax(k.extend({
					url: d,
					type: c,
					dataType: m,
					data: e,
		...
		k.fn.extend({
			wrapAll: function (a) {
				var c;
				return this[0] && (k.isFunction(a) && (a = a.call(this[0])), c = k(a, this[0].ownerDocument).eq(0).clone(!0), this[0].parentNode && c.insertBefore(this[0]), c.map(function () {
		...
		k.ajaxTransport(function (a) {
			var c,
				d;
			if (Ya.cors || sa && !a.crossDomain) return {
				send: function (e, h) {
					var m, q = a.xhr();
					if (q.open(a.type, a.url, a.async, a.username, a.password), a.xhrFields)
					...
					c = function (I) {
						return function () {
							c && (c = d = q.onload = q.onerror = q.onabort = q.onreadystatechange = null, "abort" === I ? q.abort() : "error" === I ? "number" !=
								typeof q.status ? h(0, "error") : h(q.status, q.statusText) : h(Q[q.status] || q.status, q.statusText, "text" !== (q.responseType || "text") || "string" != typeof q.responseText ? {
									binary: q.response
								} : {
									text: q.responseText
					...
					q.onload = c();
					d = q.onerror = c("error");
					void 0 !== q.onabort ? q.onabort = d : q.onreadystatechange = function () {
						4 === q.readyState && la.setTimeout(function () {
							c && d()
						})
					};
					c = c("abort");
		...
		k.ajaxPrefilter("json jsonp", function (a, c, d) {
			var e, h, m, q = !1 !== a.jsonp && (za.test(a.url) ? "url" : "string" == typeof a.data && 0 === (a.contentType || "").indexOf("application/x-www-form-urlencoded") && za.test(a.data) && "data");
			if (q || "jsonp" ===
				a.dataTypes[0]) return e = a.jsonpCallback = k.isFunction(a.jsonpCallback) ? a.jsonpCallback() : a.jsonpCallback, q ? a[q] = a[q].replace(za, "$1" + e) : !1 !== a.jsonp && (a.url += (M.test(a.url) ? "&" : "?") + a.jsonp + "=" + e), a.converters["script json"] = function () {
				return m || k.error(e + " was not called"), m[0]
			}, a.dataTypes[0] = "json", h = la[e], la[e] = function () {
				m = arguments
			}, d.always(function () {
		...
		k.parseHTML = function (a, c, d) {
			...
			var e, h, m;
			return c || (Ya.createHTMLDocument ? (c = ha.implementation.createHTMLDocument(""), e = c.createElement("base"), e.href = ha.location.href, c.head.appendChild(e)) : c = ha), h = $c.exec(a), m = !d && [], h ? [c.createElement(h[1])] : (h = na([a], c, m), m && m.length && k(m).remove(),
				k.merge([], h.childNodes))
		};
		k.fn.load = function (a, c, d) {
			var e, h, m, q = this,
				I = a.indexOf(" ");
			return -1 < I && (e = Ac(a.slice(I)), a = a.slice(0, I)), k.isFunction(c) ? (d = c, c = void 0) : c && "object" == typeof c && (h = "POST"), 0 < q.length && k.ajax({
				url: a,
				type: h || "GET",
				dataType: "html",
				data: c
		...
		k.offset = {
			setOffset: function (a, c, d) {
				...
				var T = k.css(a, "top");
				var va = k.css(a, "left");
				("absolute" === q || "fixed" === q) && -1 < (T + va).indexOf("auto") ? (e = I.position(), m = e.top, h = e.left) : (m = parseFloat(T) || 0, h = parseFloat(va) || 0);
				k.isFunction(c) && (c = c.call(a,
					d, k.extend({}, ca)));
		...
		k.fn.extend({
			offset: function (a) {
				...
				var c, d, e, h, m = this[0];
				if (m) return m.getClientRects().length ? (e = m.getBoundingClientRect(), c = m.ownerDocument, d = c.documentElement, h = c.defaultView, {
			...
			position: function () {
				if (this[0]) {
					...
					return "fixed" === k.css(d, "position") ? c = d.getBoundingClientRect() : (a = this.offsetParent(), c = this.offset(), qb(a[0], "html") || (e = a.offset()), e = {
		...
		k.each({
			...
			var d = "pageYOffset" === c;
			k.fn[a] = function (e) {
				return Jc(this, function (h, m, q) {
					var I;
					return k.isWindow(h) ? I = h : 9 === h.nodeType && (I = h.defaultView), void 0 === q ? I ? I[c] : h[m] : void(I ? I.scrollTo(d ? I.pageXOffset : q, d ? q : I.pageYOffset) : h[m] = q)
		...
		k.each({
			...
			k.each({
				...
				k.fn[e] = function (h, m) {
					...
					return Jc(this, function (J, ca, T) {
						var va;
						return k.isWindow(J) ? 0 === e.indexOf("outer") ? J["inner" + a] : J.document.documentElement["client" + a] : 9 === J.nodeType ? (va = J.documentElement, Math.max(J.body["scroll" + a], va["scroll" + a], J.body["offset" + a], va["offset" + a], va["client" + a])) : void 0 === T ? k.css(J, ca, I) : k.style(J,
							ca, T, I)
					}, c, q ? h : void 0, q)
				}
			})
		...
		var Qa = la.jQuery,
			Mb =
			la.$;
		return k.noConflict = function (a) {
			return la.$ === k && (la.$ = Mb), a && la.jQuery === k && (la.jQuery = Qa), k
		}, La || (la.jQuery = la.$ = k), k
	});
	(function (la, La) {
		"function" === typeof define && define.amd ? define(La) : "object" === typeof exports ? module.exports = La() : la.ResizeSensor = La()
	})("undefined" !== typeof window ? window : this, function () {
		function la(Sa, qb) {
			var ib = Object.prototype.toString.call(Sa),
				Gb = 0,
				Ta = Sa.length;
			if ("[object Array]" === ib || "[object NodeList]" === ib || "[object HTMLCollection]" === ib || "[object Object]" === ib ||
				"undefined" !== typeof jQuery && Sa instanceof jQuery || "undefined" !== typeof Elements && Sa instanceof Elements)
				for (; Gb < Ta; Gb++) qb(Sa[Gb]);
			else qb(Sa)
		}
		if ("undefined" === typeof window) return null;
		var La = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || function (Sa) {
				...
				function ib() {
					...
					this.remove =
						function (ob) {
							var dc = [];
							tb = 0;
							for (yb = Ta.length; tb < yb; tb++) Ta[tb] !== ob && dc.push(Ta[tb]);
							Ta = dc
						};
				...
				function Gb(Ta, tb) {
					if (Ta)
						if (Ta.resizedAttached) Ta.resizedAttached.add(tb);
							...
							Ta.resizeSensor.style.cssText = "position: absolute; left: 0; top: 0; right: 0; bottom: 0; overflow: hidden; z-index: -1; visibility: hidden;";
							...
							Ta.resizeSensor.offsetParent !== Ta && (Ta.style.position = "relative");
							var yb = Ta.resizeSensor.childNodes[0],
								ob = yb.childNodes[0],
								dc = Ta.resizeSensor.childNodes[1],
								xc, Cc, zc, ec, Zb = Ta.offsetWidth,
								da = Ta.offsetHeight,
								na = function () {
							...
							var ua = function () {
								Cc = 0;
								xc && (Zb = zc, da = ec, Ta.resizedAttached && Ta.resizedAttached.call())
							};
							tb = function () {
								zc = Ta.offsetWidth;
								ec = Ta.offsetHeight;
							...
							var Ma = function (Oa, Da, Ha) {
								Oa.attachEvent ? Oa.attachEvent("on" + Da, Ha) : Oa.addEventListener(Da, Ha)
							};
							Ma(yb, "scroll", tb);
							Ma(dc, "scroll", tb)
						}
		...
		hb.detach = function (Sa, qb) {
			la(Sa, function (ib) {
				if (ib) {
					if (ib.resizedAttached && "function" == typeof qb && (ib.resizedAttached.remove(qb), ib.resizedAttached.length())) return;
					ib.resizeSensor && (ib.contains(ib.resizeSensor) && ib.removeChild(ib.resizeSensor), delete ib.resizeSensor,
	...
	(function () {
		function la(da, na) {
			na || da.match(/^data:([^;]+);base64,/mi);
			da = da.replace(/^data:([^;]+);base64,/gmi, "");
			da = atob(da);
			na = da.length;
			for (var ua = new ArrayBuffer(na), Ma = new Uint8Array(ua), Oa = 0; Oa < na; Oa++) Ma[Oa] = da.charCodeAt(Oa);
			return ua
		}
		...
		function hb(da, na) {
			function ua(Ha) {
				var Va =
					Sa(Ha);
				da.exifdata = Va || {};
				a: if (Va = new DataView(Ha), 255 != Va.getUint8(0) || 216 != Va.getUint8(1)) Va = !1;
					else {
						for (var xb = 2, Vb = Ha.byteLength; xb < Vb;) {
							var Cb = Va,
								Xa = xb;
							if (56 === Cb.getUint8(Xa) && 66 === Cb.getUint8(Xa + 1) && 73 === Cb.getUint8(Xa + 2) && 77 === Cb.getUint8(Xa + 3) && 4 === Cb.getUint8(Xa + 4) && 4 === Cb.getUint8(Xa + 5)) {
								Cb = Va.getUint8(xb + 7);
								0 !== Cb % 2 && (Cb += 1);
								0 === Cb && (Cb = 4);
								Vb = xb + 8 + Cb;
								...
								for (Xa = Va; Xa < Va + xb;) {
									if (28 === Vb.getUint8(Xa) && 2 === Vb.getUint8(Xa + 1)) {
										var Rb = Vb.getUint8(Xa +
											2);
										if (Rb in Zb) {
											var bc = Vb.getInt16(Xa + 3);
											Rb = Zb[Rb];
											bc = Gb(Vb, Xa + 5, bc);
											Cb.hasOwnProperty(Rb) ? Cb[Rb] instanceof Array ? Cb[Rb].push(bc) : Cb[Rb] = [Cb[Rb], bc] : Cb[Rb] = bc
										}
									}
									Xa++
								}
				...
				if (ob.isXmpEnabled) {
					a: if ("DOMParser" in self)
						if (Va = new DataView(Ha), 255 != Va.getUint8(0) || 216 != Va.getUint8(1)) var qc = !1;
						else {
							xb = 2;
							Vb = Ha.byteLength;
							for (Ha = new DOMParser; xb < Vb - 4;)
								if ("http" == Gb(Va, xb, 4)) {
									...
									Va = Va.substring(Va.indexOf("<x:xmpmeta"),
										xb);
									xb = Va.indexOf("x:xmpmeta") + 10;
									Va = Va.slice(0, xb) + 'xmlns:Iptc4xmpCore="http://iptc.org/std/Iptc4xmpCore/1.0/xmlns/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:tiff="http://ns.adobe.com/tiff/1.0/" xmlns:plus="http://schemas.android.com/apk/lib/com.google.android.gms.plus" xmlns:ext="http://www.gettyimages.com/xsltExtension/1.0" xmlns:exif="http://ns.adobe.com/exif/1.0/" xmlns:stEvt="http://ns.adobe.com/xap/1.0/sType/ResourceEvent#" xmlns:stRef="http://ns.adobe.com/xap/1.0/sType/ResourceRef#" xmlns:crs="http://ns.adobe.com/camera-raw-settings/1.0/" xmlns:xapGImg="http://ns.adobe.com/xap/1.0/g/img/" xmlns:Iptc4xmpExt="http://iptc.org/std/Iptc4xmpExt/2008-02-29/" ' +
										Va.slice(xb);
									b: {
			...
			if (da.src)
				...
				Da.send(null)
			} else self.FileReader &&
				(da instanceof self.Blob || da instanceof self.File) && (Oa = new FileReader, Oa.onload = function (Ha) {
					ua(Ha.target.result)
		...
		function ib(da, na, ua, Ma, Oa) {
			...
			switch (Da) {
				...
				case 5:
					...
					na = [];
					for (Da = 0; Da < Ma; Da++) Ha = da.getUint32(ua + 8 * Da, !Oa), Va = da.getUint32(ua + 4 + 8 * Da, !Oa), na[Da] = new Number(Ha / Va), na[Da].numerator = Ha, na[Da].denominator = Va;
					return na;
				case 9:
					if (1 == Ma) return da.getInt32(na + 8, !Oa);
					na = [];
					for (Da = 0; Da < Ma; Da++) na[Da] = da.getInt32(ua +
						4 * Da, !Oa);
					return na;
				case 10:
					if (1 == Ma) return da.getInt32(ua, !Oa) / da.getInt32(ua + 4, !Oa);
					na = [];
					for (Da = 0; Da < Ma; Da++) na[Da] = da.getInt32(ua + 8 * Da, !Oa) / da.getInt32(ua + 4 + 8 * Da, !Oa);
					return na
			}
		}
		...
		function Gb(da, na, ua) {
			var Ma = "";
			for (ua = na + ua; na < ua; ++na) Ma += String.fromCharCode(da.getUint8(na));
			return Ma
		}
		...
		function Ta(da, na) {
				...
				for (Ha in Da) {
					switch (Ha) {
						...
						case "FlashpixVersion":
							Da[Ha] =
								String.fromCharCode(Da[Ha][0], Da[Ha][1], Da[Ha][2], Da[Ha][3]);
							break;
						case "ComponentsConfiguration":
							Da[Ha] = ec.Components[Da[Ha][0]] + ec.Components[Da[Ha][1]] + ec.Components[Da[Ha][2]] + ec.Components[Da[Ha][3]]
					}
					na[Ha] = Da[Ha]
				}
			}
			if (na.GPSInfoIFDPointer)
				for (Ha in Da = qb(da, ua, ua + na.GPSInfoIFDPointer, Cc, Ma), Da) {
					switch (Ha) {
						case "GPSVersionID":
							Da[Ha] = Da[Ha][0] + "." + Da[Ha][1] + "." + Da[Ha][2] + "." + Da[Ha][3]
					}
					na[Ha] = Da[Ha]
				}
			var Ha = Ma;
			...
			if (Oa = da.getUint32(Oa + 2 + 12 * Ma, !Ha))
				if (Oa > da.byteLength) da = {};
					...
					if (Ha.Compression) switch (Ha.Compression) {
						case 6:
							Ha.JpegIFOffset && Ha.JpegIFByteCount && (Ha.blob = new Blob([new Uint8Array(da.buffer, ua + Ha.JpegIFOffset, Ha.JpegIFByteCount)], {
								type: "image/jpeg"
							}));
							break;
						case 1:
							...
							break;
						default:
							console.log("Unknown thumbnail image format '%s'", Ha.Compression)
					} else 2 == Ha.PhotometricInterpretation && console.log("Thumbnail image format is RGB, which is not implemented.");
					da =
						Ha
				}
			else da = {};
		...
		"undefined" !== typeof exports ? ("undefined" !== typeof module && module.exports && (exports = module.exports = ob), exports.EXIF = ob) : yb.EXIF = ob;
		var dc = ob.Tags = {
				36864: "ExifVersion",
		...
		ob.getData = function (da, na) {
			if ((self.Image && da instanceof self.Image || self.HTMLImageElement && da instanceof self.HTMLImageElement) && !da.complete) return !1;
		...
		ob.pretty = function (da) {
			...
			da = da.exifdata;
			var ua = "";
			for (na in da) da.hasOwnProperty(na) && (ua = "object" == typeof da[na] ? da[na] instanceof Number ? ua + (na + " : " + da[na] + " [" + da[na].numerator + "/" + da[na].denominator + "]\r\n") : ua + (na + " : [" + da[na].length + " values]\r\n") : ua + (na + " : " + da[na] + "\r\n"));
			return ua
		};
			...
			var La = {
				read: function (hb, Sa, qb) {
					if (hb.files && hb.files.length) {
						var ib = hb.files[0];
						hb = ib.name.split(".").pop().toLowerCase(); - 1 === ["jpg", "jpeg", "png"].indexOf(hb) ? qb("WRONGFILEFORMAT") : EXIF.getData(ib, function () {
							console.log("INFO in ImageProcess - read() - EXIF data =", EXIF.pretty(ib));
				...
				process: function (hb, Sa, qb, ib) {
					if ("number" === typeof hb && 2 <= hb && 8 >= hb) {
						console.log("INFO in ImageProcess - process(): image needs to be reoriented. orientation =",
							hb);
						ib = Sa.width;
						var Gb = Sa.height,
							Ta = document.createElement("canvas"); - 1 < [5, 6, 7, 8].indexOf(hb) ? (console.log("INFO in ImageProcess - process(): the image needs to be 90\u00b0 rotated"), Ta.width = Gb, Ta.height = ib) : (Ta.width = ib, Ta.height = Gb);
		...
		kc = {
			start: function (la) {
				...
				if (pb.mode !== vc.notLoaded) kc.resume();
					...
					if (la.settings)
						for (var La in la.settings) Yc[La] = la.settings[La];
					la.NNCPath && Tb.set_NNCPath(la.NNCPath);
					la.faceDetectionCallback && (jd.enabled = !0, jd.callback = la.faceDetectionCallback, jd.interval = "undefined" === typeof la.faceDetectionInterval ? 1E3 : la.faceDetectionInterval);
					Ia.container = document.getElementById("JeeWidget");
					if (!Ia.container) throw Error("Cannot find a <div> element with id=JeeWidget to append the VTO widget.");
					Ia.cv = document.getElementById("JeeWidgetCanvas");
					Ia.cv || (Ia.cv = document.createElement("canvas"), Ia.container.appendChild(Ia.cv));
					...
					if (!$(Ia.container).height()) return Eb("PLACEHOLDER_NULL_HEIGHT"), !1;
					Xb();
					new ResizeSensor($(Ia.container), function (hb) {
						Xb()
					});
					(la.searchImageMask || la.searchImageColor) && Tb.set_loading(la.searchImageMask, la.searchImageColor);
					la.callbackReady && (fd = la.callbackReady);
					pb.mode = vc.init;
					La = "undefined" === typeof la.assetsPath ? Yc.appstaticURL + "jeefit/" : la.assetsPath;
			...
			capture_image: function (la, La, hb) {
				Tb && Tb.ready ? Tb.capture_image(la,
					La, hb, !1) : La(!1)
			},
			...
			load_modelStandalone: function (la, La) {
				if (!pb.isRT) throw Error("Loading standalone models is only available in RT mode");
				pb.mode === vc.paused && kc.resume();
				pb.mode = vc.loadingModel;
				if ("string" === typeof la) $.ajax({
					method: "GET",
					url: la,
					dataType: "json"
				}).then(function (Sa) {
			...
			load_fallback: function (la, La) {
				la && (pb.mode = vc.loadingModel, Tb.load_model(null, null, function () {
					pb.mode = vc.fallback;
					kc.toggle_loading(!1);
					La && La();
					Pd(la)
			...
			load_RT: function (la, La) {
				la === pb.sku ? kc.toggle_loading(!1) : (pb.sku = la, pb.mode = vc.loadingModel, pb.mode === vc.paused && kc.resume(), la ? Ed && Ed[la] ? Qd(la, Ed[la], La) : $.ajax({
					method: "GET",
					...
					Qd(la,
						hb.intrinsic, La)
				}).fail(Fb) : (pb.mode = vc.realtime, kc.toggle_loading(!1), Tb.start_rendering(), La && La()))
			}
		};
	return kc
}();
